...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMLabelInstruction* instr)
{
    printPrefix(pOutFile, instr);
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMVirtualGuardNOPInstruction* instr)
{
    printPrefix(pOutFile, instr);
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMAdminInstruction* instr)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMImmInstruction* instr)
{
    printPrefix(pOutFile, instr);
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMImmSymInstruction* instr)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMTrg1Src2Instruction* instr)
{
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
...
#if (defined(__VFP_FP__) && !defined(__SOFTFP__))
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMTrg2Src1Instruction* instr)
{
    // fmrrd
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMMulInstruction* instr)
{
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMMemSrc1Instruction* instr)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMTrg1Instruction* instr)
{
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMMemInstruction* instr)
{
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
    print(pOutFile, instr->getMemoryReference());
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMTrg1MemInstruction* instr)
{
    if (instr->getBinaryEncoding() && instr->getMemoryReference()->hasDelayedOffset() && !instr->getMemoryReference()->getUnresolvedSnippet()) {
        TR_ARMOpCodes op = instr->getOpCodeValue();
        int32_t offset = instr->getMemoryReference()->getOffset();
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMTrg1MemSrc1Instruction* instr)
{
    // strex
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMControlFlowInstruction* instr)
{
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMMultipleMoveInstruction* instr)
{
    printPrefix(pOutFile, instr);
    trfprintf(pOutFile, "%s\t", fullOpCodeName(instr));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMCallSnippet* snippet)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMUnresolvedCallSnippet* snippet)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMVirtualUnresolvedSnippet* snippet)
{
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMInterfaceCallSnippet* snippet)
{
    TR::SymbolReference* callSymRef = snippet->getNode()->getSymbolReference();
...
#ifdef J9_PROJECT_SPECIFIC
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMHelperCallSnippet* snippet)
{
    uint8_t* bufferPos = snippet->getSnippetLabel()->getCodeLocation();
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMStackCheckFailureSnippet* snippet)
{
    uint8_t* bufferPos = snippet->getSnippetLabel()->getCodeLocation();
    printSnippetLabel(pOutFile, snippet->getSnippetLabel(), bufferPos, getName(snippet));
...
void TR_Debug::print(TR::FILE* pOutFile, TR_ARMRecompilationSnippet* snippet)
{
...
void TR_Debug::printARM(TR::FILE* pOutFile, uint8_t* instrStart, uint8_t* instrEnd)
{
...
void TR_Debug::printARMDelayedOffsetInstructions(TR::FILE* pOutFile, TR_ARMMemInstruction* instr)
{
    bool regSpilled;
    uint8_t* bufferPos = instr->getBinaryEncoding();
    int32_t offset = instr->getMemoryReference()->getOffset();
