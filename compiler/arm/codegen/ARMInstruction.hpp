...
public:
    TR_ARMImmInstruction(TR::Node* node, TR::CodeGenerator* cg)
...
public:
    TR_ARMImmSymInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMImmInstruction(node, cg)
        , _symbolReference(NULL)
        , _snippet(NULL)
    {
    }
...
public:
    TR_ARMTrg1Src2Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    {
    }
...
public:
    TR_ARMSrc2Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMTrg1Src2Instruction(node, cg)
    {
    }
...
public:
    TR_ARMTrg1Src1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMTrg1Src2Instruction(node, cg)
    {
    }
...
public:
    TR_ARMTrg1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    {
    }
...
public:
    TR_ARMTrg2Src1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMTrg1Src2Instruction(node, cg)
        , _target2Register(0)
    {
    }
...
public:
    TR_ARMMulInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    {
    }
...
public:
    TR_ARMMemInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMTrg1Instruction(node, cg)
    {
    }
    ...
    TR_ARMMemInstruction(TR_ARMOpCodes op,
        ...
        bool memRead,
        TR::CodeGenerator* cg)
        : TR_ARMTrg1Instruction(op, node, treg, cg)
        , _memoryReference(mf)
        , _memoryRead(memRead)
    {
    ...
    TR_ARMMemInstruction(TR::Instruction* precedingInstruction,
        ...
        bool memRead,
        TR::CodeGenerator* cg)
        : TR_ARMTrg1Instruction(precedingInstruction, op, node, treg, cg)
        , _memoryReference(mf)
        , _memoryRead(memRead)
    {
        mf->incRegisterTotalUseCounts(cg);
...
public:
    TR_ARMMemSrc1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMMemInstruction(node, cg)
    {
    }
...
public:
    TR_ARMTrg1MemInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMMemInstruction(node, cg)
    {
    }
...
public:
    TR_ARMTrg1MemSrc1Instruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR_ARMMemInstruction(node, cg)
    {
    }
    ...
    TR_ARMTrg1MemSrc1Instruction(TR_ARMOpCodes op,
        ...
        TR::Register* sreg,
        TR::CodeGenerator* cg)
        : TR_ARMMemInstruction(op, node, treg, mf, false, cg)
    ...
    TR_ARMTrg1MemSrc1Instruction(TR::Instruction* precedingInstruction,
        ...
        TR::Register* sreg,
        TR::CodeGenerator* cg)
        : TR_ARMMemInstruction(precedingInstruction, op, node, treg, mf, false, cg)
        , _source1Register(sreg)
    {
    }
...
public:
    TR_ARMControlFlowInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    {
    }
...
public:
    TR_ARMMultipleMoveInstruction(TR::Node* node, TR::CodeGenerator* cg)
        : TR::Instruction(node, cg)
    {
    }
