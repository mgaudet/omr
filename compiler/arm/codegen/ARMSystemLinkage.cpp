...
TR_ARMLinkageProperties TR_ARMSystemLinkage::properties = {
    ...
    {
        // preserved registers
        TR::RealRegister::gr4, TR::RealRegister::gr5, TR::RealRegister::gr6, TR::RealRegister::gr7,
        TR::RealRegister::gr8, TR::RealRegister::gr9, TR::RealRegister::gr10, TR::RealRegister::gr11,
        TR::RealRegister::gr12, TR::RealRegister::gr13, TR::RealRegister::gr14, TR::RealRegister::gr15,
#if defined(__VFP_FP__) && !defined(__SOFTFP__)
        TR::RealRegister::fp8, TR::RealRegister::fp9, TR::RealRegister::fp10, TR::RealRegister::fp11,
        TR::RealRegister::fp12, TR::RealRegister::fp13, TR::RealRegister::fp14, TR::RealRegister::fp15,
#endif
    },
    {
        // argument registers
        TR::RealRegister::gr0, TR::RealRegister::gr1, TR::RealRegister::gr2, TR::RealRegister::gr3,
#if defined(__VFP_FP__) && !defined(__SOFTFP__)
        TR::RealRegister::fp0, TR::RealRegister::fp1, TR::RealRegister::fp2, TR::RealRegister::fp3,
...
uint32_t TR_ARMSystemLinkage::getRightToLeft() { return getProperties().getRightToLeft(); }
...
TR_ARMLinkageProperties& TR_ARMSystemLinkage::getProperties() { return properties; }

void TR_ARMSystemLinkage::createPrologue(TR::Instruction* cursor) { TR_ASSERT(0, "unimplemented"); }

void TR_ARMSystemLinkage::createEpilogue(TR::Instruction* cursor) { TR_ASSERT(0, "unimplemented"); }

TR::MemoryReference* TR_ARMSystemLinkage::getOutgoingArgumentMemRef(
    int32_t totalSize, int32_t offset, TR::Register* argReg, TR_ARMOpCodes opCode, TR_ARMMemoryArgument& memArg)
{
...
int32_t TR_ARMSystemLinkage::buildArgs(
