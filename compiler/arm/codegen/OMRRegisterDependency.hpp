...
public:
    ...
    void setDependencyInfo(uint32_t index, TR::Register* vr, OMR::ARM::RealRegister::RegNum rr, uint8_t flag)
    {
...
namespace ARM {
    ...
    public:
        ...
        void addPreCondition(TR::Register* vr, OMR::ARM::RealRegister::RegNum rr, uint8_t flag = UsesDependentRegister)
        {
        ...
        void addPostCondition(TR::Register* vr, OMR::ARM::RealRegister::RegNum rr, uint8_t flag = UsesDependentRegister)
        {
