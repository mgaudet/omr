        ...
        if (typeAddress == -1) {
            ...
            if (typeAddress == TR_DataAddress) {
                if (doAOTRelocation) {
                    ...
                    cg->addAOTRelocation(new (cg->trHeapMemory()) TR_BeforeBinaryEncodingExternalRelocation(cursor,
                ...
                if (doAOTRelocation) {
                    cg->addAOTRelocation(new (cg->trHeapMemory())
                                             TR_BeforeBinaryEncodingExternalRelocation(cursor, targetAddress,
                ...
                if (doAOTRelocation)
                    cg->addAOTRelocation(new (cg->trHeapMemory())
                                             TR_BeforeBinaryEncodingExternalRelocation(cursor, (uint8_t*)value,
