...
void TR_FrontEnd::outOfMemory(TR::Compilation*, const char*) { notImplemented("outOfMemory"); }
...
bool TR_FrontEnd::isCompiledMethod(TR_OpaqueMethodBlock* method) { return false; }
...
void TR_FrontEnd::setHasFailedCodeCacheAllocation() { notImplemented("setHasFailedCodeCacheAllocation"); }
...
void TR_FrontEnd::reserveNTrampolines(TR::Compilation*, int32_t n, bool inBinaryEncoding)
{
