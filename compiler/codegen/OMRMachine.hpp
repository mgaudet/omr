...
public:
        ...
        , _overallLastGlobalRegisterNumber(-1)
    {
        ...
        _numberRegisters[TR_VRF]
            = numVRFRegs; // TODO vrf gra : needs this but every platform will need to pass numVRFRegs in
    }
    ...
    // GlobalRegisterNumbers consiste of real registers in the order of assignment preference. All register kinds
    // combined
...
protected:
    ...
    TR_GlobalRegisterNumber setFirstGlobalRegisterNumber(TR_RegisterKinds rk, TR_GlobalRegisterNumber grn)
    {
        return (_firstGlobalRegisterNumber[rk] = grn);
    }
    TR_GlobalRegisterNumber setLastGlobalRegisterNumber(TR_RegisterKinds rk, TR_GlobalRegisterNumber grn)
    {
        return (_lastGlobalRegisterNumber[rk] = grn);
    }
    TR_GlobalRegisterNumber setLastRealRegisterGlobalRegisterNumber(TR_GlobalRegisterNumber grn)
    {
