...
public:
    TR_8BitLabelRelativeRelocation()
        : TR_LabelRelocation()
    {
    }
...
class TR_16BitLabelRelativeRelocation : public TR_LabelRelocation {
    ...
    // TR_16BitLabelRelativeRelocation(*p,*l, 4, true)
    //
    // The regular TR_16BitLabelRelativeRelocation(uint8_t *p, TR::LabelSymbol *l) only supports instructions with
    // 16-bit relocations,
...
public:
    TR_24BitLabelRelativeRelocation()
        : TR_LabelRelocation()
    {
    }
...
public:
    ...
    TR_IteratedExternalRelocation(uint8_t* target, uint8_t* target2, TR_ExternalRelocationTargetKind k,
...
public:
    ...
    TR_ExternalRelocation(uint8_t* p, uint8_t* target, TR_ExternalRelocationTargetKind kind, TR::CodeGenerator* codeGen)
        : TR_Relocation(p)
    ...
    TR_IteratedExternalRelocation* getRelocationRecord() { return _relocationRecord; }
...
public:
    TR_32BitExternalOrderedPairRelocation(uint8_t* location1, uint8_t* location2, uint8_t* target,
...
public:
    ...
    TR_BeforeBinaryEncodingExternalRelocation(TR::Instruction* instr, uint8_t* target, uint8_t* target2,
