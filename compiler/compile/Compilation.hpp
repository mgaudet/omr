...
public:
    Compilation(int32_t compThreadId, OMR_VMThread* omrVMThread, TR_FrontEnd* fe, TR_ResolvedMethod* method,
        TR::IlGenRequest& request, TR::Options& options, const TR::Region& dispatchRegion, TR_Memory* memory,
        TR_OptimizationPlan* optimizationPlan)
        : OMR::CompilationConnector(
              compThreadId, omrVMThread, fe, method, request, options, dispatchRegion, memory, optimizationPlan)
    {
    }
