...
enum TR_CompilationOptions {
    ...
    = 0x00008000, // ** NOTE ** Alias for TR_FullSpeedDebug until we're prepared to separate these two concepts
    ...
    // Available                                       = 0x00000080 + 19,  //disable assign unique index for defs on
    // entry
    ...
    // Available                                       = 0x00200000 + 19,  // only propagate const nodes and not
    // conversions of const nodes in VariableInitializerPropagation
