...
template <class Allocator = CS2::allocator> class ABitVector : private Allocator {
private:
    class BitRef;
...
inline void ABitVector<Allocator>::GrowTo(BitIndex newBitSize, bool geometric, bool forceGeometric)
{
    ...
    if (oldBitSize == 0) {
        ...
        fBitWords = (BitWord*)Allocator::reallocate(SizeInBytes(fNumBits), fBitWords, SizeInBytes(oldBitSize));
        memset(((char*)fBitWords) + SizeInBytes(oldBitSize), 0, SizeInBytes(fNumBits) - SizeInBytes(oldBitSize));
    }
}
