...
template <class ADataType, class Allocator = CS2::allocator> class LinkedListOf : private Allocator {
public:
...
template <class ADataType, class Allocator = CS2::allocator> class QueueOf : public LinkedListOf<ADataType, Allocator> {
public:
...
template <class ADataType, class Allocator = CS2::allocator> class StackOf : public QueueOf<ADataType, Allocator> {
public:
