...
template <class Meter, class Allocator = CS2::allocator> class PhaseMeasuringNode : private Allocator {
public:
 ...
 */
template <class Meter, class Allocator = CS2::allocator> class PhaseMeasuringSummary {
...
template <class Meter, class Allocator = CS2::allocator,
    class PhaseMeasuringSummary = CS2::PhaseMeasuringSummary<Meter, Allocator> >
class PhaseProfiler {
private:
    ListIndex fIndex;
...
//
template <class Allocator = CS2::allocator,
    class PhaseTimingSummary = CS2::PhaseMeasuringSummary<RunnableTimer, Allocator> >
