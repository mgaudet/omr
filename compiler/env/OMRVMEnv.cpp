...
uint64_t OMR::VMEnv::getHighResClockResolution(TR::Compilation* comp) { return ::highResClockResolution(); }

uint64_t OMR::VMEnv::getHighResClockResolution(OMR_VMThread* omrVMThread) { return ::highResClockResolution(); }
