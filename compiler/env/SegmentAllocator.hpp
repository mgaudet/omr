...
public:
    ...
    void deallocate(TR::MemorySegment unusedSegment) throw() { _rawAllocator.deallocate(unusedSegment.rawSegment()); }
    ...
    size_t const pageAlign(size_t requestedSize) { return (requestedSize + pageSize() - 1) & ~(pageSize() - 1); }
