...
const char* objectName[] = {
    "Array", "Instruction", "ListElement", "Node", "BitVector", "Register", "MemoryReference", "CFGNode", "Symbol",
    "SymbolReference", "SymRefUnion", "BackingStore", "StorageReference", "PseudoRegister", "Link", "Machine",
    "CFGEdge", "TreeTop", "GCStackMap", "IlGenerator", "RegisterDependencyConditions", "Snippet", "Relocation",
    ...
    "LocalDeadStoreElimination", "LocalOpts", "LocalReordering", "LocalLiveRangeReduction", "LongRegAllocation",
    "LoopAliasRefiner", "LoopTransformer", "MonitorElimination", "NewInitialization", "Optimization", "OSR",
    "PartialRedundancy", "RedundantAsycCheckRemoval", "RegionAnalysis", "RightNumberOfNames", "Structure",
    "SwitchAnalyzer", "UseDefInfo", "ValueNumberInfo", "ValuePropagation", "VirtualGuardTailSplitter",
    "InterProceduralAnalyzer", "InductionVariableAnalysis", "CoarseningInterProceduralAnalyzer", "ShrinkWrapping",
    ...
    "TR_PreviousNodeConversion", "TR_RelocationDebugInfo", "TR::AOTClassInfo", "TR_SharedCache",

    "TR::RegisterPair", "TR::Instruction",

    "TR_ArtifactManager", "TR_CompilationInfo", "TR_CompilationInfoPerThreadBase", "TR_DebuggingCounters", "TR_Pattern",
...
{
    TR_ASSERT(::trPersistentMemory != NULL, "Attempting to use GlobalAllocator too early. It cannot be used until "
                                            "TR_PersistentMemory has been initialized.");
