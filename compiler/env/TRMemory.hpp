...
namespace TR {
typedef CS2::stat_allocator<CS2::heap_allocator<65536, 12, TRCS2MemoryAllocator> > ThreadLocalAllocator;
...
public:
    static void* operator new(size_t size, Allocator a) { return a.allocate(size); }
