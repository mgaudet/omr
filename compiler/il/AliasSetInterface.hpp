...
struct TR_UseDefAliasSetInterface : public TR_AliasSetInterface<TR_SymAliasSetInterface<useDefAliasSet> > {
    TR_UseDefAliasSetInterface(TR::SymbolReference* symRef,
        ...
        bool includeGCSafePoint = false)
        : TR_AliasSetInterface<TR_SymAliasSetInterface<useDefAliasSet> >(symRef, isDirectCall, includeGCSafePoint)
    {
    }
};
...
struct TR_UseOnlyAliasSetInterface : public TR_AliasSetInterface<TR_SymAliasSetInterface<UseOnlyAliasSet> > {
    TR_UseOnlyAliasSetInterface(TR::SymbolReference* symRef,
        bool isDirectCall = false,
        bool includeGCSafePoint = false)
        : TR_AliasSetInterface<TR_SymAliasSetInterface<UseOnlyAliasSet> >(symRef, isDirectCall, includeGCSafePoint)
    {
    }
};

template <uint32_t _aliasSetType>
inline void TR_SymAliasSetInterface<_aliasSetType>::setAlias(TR::SymbolReference* symRef2, bool value, bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    if (symRef2 == NULL)
        return;
...
template <>
inline TR_BitContainer TR_SymAliasSetInterface<useDefAliasSet>::getTRAliases(bool isDirectCall, bool includeGCSafePoint)
{
    return _symbolReference->getUseDefAliasesBV(isDirectCall, includeGCSafePoint);
}

template <>
inline TR_BitContainer TR_SymAliasSetInterface<UseOnlyAliasSet>::getTRAliases(bool isDirectCall, bool includeGCSafePoint)
{
...
template <>
inline TR_BitContainer TR_NodeAliasSetInterface<mayUseAliasSet>::getTRAliases(bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    TR_BitContainer bc;
...
template <>
inline TR_BitContainer TR_NodeAliasSetInterface<mayKillAliasSet>::getTRAliases(bool isDirectCall, bool includeGCSafePoint)
{
    TR::Compilation* comp = TR::comp();
    TR_BitContainer bc;
...
struct TR_NodeUseAliasSetInterface : public TR_AliasSetInterface<TR_NodeAliasSetInterface<mayUseAliasSet> > {
    TR_NodeUseAliasSetInterface(TR::Node* node,
        bool isDirectCall = false,
        bool includeGCSafePoint = false)
        : TR_AliasSetInterface<TR_NodeAliasSetInterface<mayUseAliasSet> >(node, isDirectCall, includeGCSafePoint)
    {
    }
};
...
struct TR_NodeKillAliasSetInterface : public TR_AliasSetInterface<TR_NodeAliasSetInterface<mayKillAliasSet> > {
    TR_NodeKillAliasSetInterface(TR::Node* node,
        bool isDirectCall = false,
        bool includeGCSafePoint = false)
        : TR_AliasSetInterface<TR_NodeAliasSetInterface<mayKillAliasSet> >(node, isDirectCall, includeGCSafePoint)
    {
    }
};
