...
template <class AliasSetInterface> class TR_AliasSetInterface : public AliasSetInterface {
public:
    ...
    TR_BitContainer getTRAliases() { return AliasSetInterface::getTRAliases(_isDirectCall, _includeGCSafePoint); }
...
public:
    ...
    void setAlias(TR::SymbolReference* symRef2, bool value, bool isDirectCall, bool includeGCSafePoint);

    void setAliases(TR::SparseBitVector& aliasesToModify, bool value, bool isDirectCall, bool includeGCSafePoint)
    {
        TR::Compilation* comp = TR::comp();
...
inline void TR_SymAliasSetInterface<_aliasSetType>::setAlias(
