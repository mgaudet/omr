...
template <>
inline const int64_t getMinSigned<TR::Int8>() { return -128; }
template <>
inline const int64_t getMinSigned<TR::Int16>() { return -32768; }
template <>
inline const int64_t getMinSigned<TR::Int32>() { return ((int32_t)0X80000000); }
template <>
inline const int64_t getMinSigned<TR::Int64>() { return (((int64_t)1) << 63) /**< -9223372036854775808 */; }

template <>
inline const uint64_t getMinUnsigned<TR::Int8>() { return 0; }
template <>
inline const uint64_t getMinUnsigned<TR::Int16>() { return 0; }
template <>
inline const uint64_t getMinUnsigned<TR::Int32>() { return ((uint32_t)0); }
template <>
inline const uint64_t getMinUnsigned<TR::Int64>() { return ((uint64_t)0); }

template <>
inline const int64_t getMaxSigned<TR::Int8>() { return 127; }
template <>
inline const int64_t getMaxSigned<TR::Int16>() { return 32767; }
template <>
inline const int64_t getMaxSigned<TR::Int32>() { return ((int32_t)0X7FFFFFFF); }
template <>
inline const int64_t getMaxSigned<TR::Int64>() { return ((int64_t)(((uint64_t)((int64_t)-1)) >> 1)) /**<  9223372036854775807 */; }

template <>
inline const uint64_t getMaxUnsigned<TR::Int8>() { return 255; }
template <>
inline const uint64_t getMaxUnsigned<TR::Int16>() { return 65535; }
template <>
inline const uint64_t getMaxUnsigned<TR::Int32>() { return ((uint32_t)0xFFFFFFFF); }
template <>
inline const uint64_t getMaxUnsigned<TR::Int64>() { return ((uint64_t)-1); }

template <>
inline const int32_t getMaxSignedPrecision<TR::Int8>() { return 3; }
template <>
inline const int32_t getMaxSignedPrecision<TR::Int16>() { return 5; }
template <>
inline const int32_t getMaxSignedPrecision<TR::Int32>() { return 10; }
template <>
inline const int32_t getMaxSignedPrecision<TR::Int64>() { return 19; }

template <>
inline const int32_t getMaxUnsignedPrecision<TR::Int8>() { return 3; }
template <>
inline const int32_t getMaxUnsignedPrecision<TR::Int16>() { return 5; }
template <>
inline const int32_t getMaxUnsignedPrecision<TR::Int32>() { return 10; }
template <>
inline const int32_t getMaxUnsignedPrecision<TR::Int64>() { return 20; }
...
public:
    ...
    bool isVector() { return getDataType() == TR::VectorInt8 || getDataType() == TR::VectorInt16 || getDataType() == TR::VectorInt32 || getDataType() == TR::VectorInt64 || getDataType() == TR::VectorFloat || getDataType() == TR::VectorDouble; }
