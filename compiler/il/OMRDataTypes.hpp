...
// defined choice for the underlying type may be signed
...
public:
    ...
    bool isVector()
    {
        return getDataType() == TR::VectorInt8 || getDataType() == TR::VectorInt16 || getDataType() == TR::VectorInt32
            || getDataType() == TR::VectorInt64 || getDataType() == TR::VectorFloat
