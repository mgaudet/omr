...
public:
    ...
    TR::ILOpCodes getOpCodeForSwapChildren() { return _opCodeProperties[_opCode].swapChildrenOpCode; }
    ...
    static TR::ILOpCodes absOpCode(TR::DataType type)
    {
        ...
        case TR::Double:
            return TR::dabs;
        default:
            TR_ASSERT(false, "no abs opcode for this datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes andOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::land;
        default:
            TR_ASSERT(false, "no and opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes orOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lor;
        default:
            TR_ASSERT(false, "no or opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes xorOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lxor;
        default:
            TR_ASSERT(false, "no xor opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes shiftLeftOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lshl;
        default:
            TR_ASSERT(false, "no shl opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes unsignedShiftLeftOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lushl;
        default:
            TR_ASSERT(false, "no ushl opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes shiftRightOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lshr;
        default:
            TR_ASSERT(false, "no shr opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes unsignedShiftRightOpCode(TR::DataType type)
    {
        ...
        case TR::Int64:
            return TR::lushr;
        default:
            TR_ASSERT(false, "no ushr opcode for datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes ifcmpeqOpCode(TR::DataType type)
    {
        ...
        case TR::Double:
            return TR::ifdcmpeq;
        default:
            TR_ASSERT(0, "no ifcmpeq opcode for this datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes ifcmpneOpCode(TR::DataType type)
    {
        ...
        case TR::Double:
            return TR::ifdcmpne;
        default:
            TR_ASSERT(0, "no ifcmpne opcode for this datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes cmpeqOpCode(TR::DataType type)
    {
        ...
        case TR::Double:
            return TR::dcmpeq;
        default:
            TR_ASSERT(0, "no cmpeq opcode for this datatype %d", type);
        }
        return TR::BadILOp;
    }
    ...
    static TR::ILOpCodes constOpCode(TR::DataType type)
    {
        ...
        case TR::Double:
            return TR::dconst;
        default:
            TR_ASSERT(0, "no const opcode for this datatype %d", type);
        }
        return TR::BadILOp;
    }
