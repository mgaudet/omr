...
template <typename AllocatorType> TR::LabelSymbol* OMR::LabelSymbol::create(AllocatorType t)
{
    return new (t) TR::LabelSymbol();
}

template <typename AllocatorType> TR::LabelSymbol* OMR::LabelSymbol::create(AllocatorType t, TR::CodeGenerator* c)
{
