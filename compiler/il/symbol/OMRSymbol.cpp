...
bool OMR::Symbol::isRegisterSymbol() { return self()->isAuto() && _flags.testAny(RegisterAuto); }
...
bool OMR::Symbol::isAutoMarkerSymbol() { return (self()->isAuto() && _flags.testAny(AutoMarkerSymbol)); }
...
bool OMR::Symbol::isVMThreadLive() { return self()->isLabel() && _flags.testAny(IsVMThreadLive); }
