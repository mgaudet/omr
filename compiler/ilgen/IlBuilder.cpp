...
#define ILB_REPLAY(...) \
    {                   \
        REPLAY({sprintf(_rpLine, ##__VA_ARGS__); (*_rpILCpp) << "\t" << _rpLine << std::endl; })     \
    }
...
void IlBuilder::Switch(const char* selectionVar,
...
void IlBuilder::ForLoop(bool countsUp,
    const char* indVar,
...
void IlBuilder::DoWhileLoop(const char* whileCondition, TR::IlBuilder** body, TR::IlBuilder** breakBuilder, TR::IlBuilder** continueBuilder)
{
    //ILB_REPLAY_BEGIN();
...
void IlBuilder::WhileDoLoop(const char* whileCondition, TR::IlBuilder** body, TR::IlBuilder** breakBuilder, TR::IlBuilder** continueBuilder)
{
    //ILB_REPLAY_BEGIN();
