...
int32_t TR_CompactLocals::perform()
{
    ...
    //
    _localIndexToSymbolMap
        = new (trStackMemory()) TR_Array<TR::AutomaticSymbol*>(trMemory(), numLocals, false, stackAlloc);
    ...
    *_prevLiveVars = *bv;
    ...
    while (bvi.hasMoreElements()) {
        ...
        while (wbvi.hasMoreElements()) {
            ...
            if (sym1 && sym2 && eligibleLocal(sym1) && eligibleLocal(sym2) && !_localsIG->hasInterference(sym1, sym2)) {
                if (trace()) {
