...
static char* analysisNames[] = {
    "ReachingDefinitions", "AvailableExpressions", "GlobalAnticipatability", "Earliestness", "Delayedness",
    "Latestness", "Isolatedness", "Liveness", "BasicDFSetAnalysis", "ForwardDFSetAnalysis", "UnionDFSetAnalysis",
    "IntersectionDFSetAnalysis", "BackwardDFSetAnalysis", "BackwardUnionDFSetAnalysis",
    "BackwardIntersectionDFSetAnalysis", "ExceptionCheckMotion", "RedundantExpressionAdjustment",
    "FlowSensitiveEscapeAnalysis", "LiveOnAllPaths", "ReachingBlocks", "RegisterAnticipatability",
    "RegisterAvailability", "DSALiveness", "GPRLiveness",
};
...
TR_RegisterAnticipatability* TR_DataFlowAnalysis::asRegisterAnticipatability() { return NULL; }
TR_RegisterAvailability* TR_DataFlowAnalysis::asRegisterAvailability() { return NULL; }
