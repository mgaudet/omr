...
public:
    ...
    // using indirect loads/stores with direct loads/stores
    // Ex:
...
private:
    ...
    CS2::ABitVector<TR::Allocator> _epValueNumbers; // this bit vector is to keep track of value numbers that we know
                                                    // are 'safe' to transform.  Allowing us to catch move
                                                    // opportunities.
};
