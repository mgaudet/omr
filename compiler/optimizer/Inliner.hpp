...
private:
    ...
    // TR::Node * createVftCompareGuard(TR::Node * callNode, TR::TreeTop * destination, bool branchOnOverride, void *
    // thisClass);
    // TR::Node * createOverriddenBitCompareGuard(TR::Node * callNode, TR::TreeTop * destination, bool branchOnOverride,
    // TR::ResolvedMethodSymbol * calleeSymbol);
    // TR::Node * createMethodCompareGuard(TR::Node * callNode, TR::TreeTop * destination, bool branchOnOverride,
    // TR::ResolvedMethodSymbol * calleeSymbol);
