...
TR_LoopReducer::perform()
{
    ...
    if (!comp()->cg()->getSupportsArraySet() && !comp()->cg()->getSupportsArrayCopy() && !comp()->cg()->getSupportsPrimitiveArrayCopy() && !comp()->cg()->getSupportsArrayCmp() && !comp()->cg()->getSupportsArrayTranslateTRxx() && !comp()->cg()->getSupportsArrayTranslateAndTest()) {
