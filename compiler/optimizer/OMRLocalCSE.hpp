...
public:
    ...
    void addConvertedNode(TR::Node* convertedNode, TR::SymbolReference* symRef)
    {
        struct previousConversion* pc
            = (struct previousConversion*)_trMemory->allocateHeapMemory(sizeof(struct previousConversion));
        pc->symRef = symRef;
...
protected:
    ...
    bool killExpressionsIfVolatileLoad(TR::Node* node, SharedSparseBitVector& seenAvailableLoadedSymbolReferences,
