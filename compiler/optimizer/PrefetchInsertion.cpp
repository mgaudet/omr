        ...
        if ((secondChild->getOpCode().isAdd() || secondChild->getOpCode().isSub())
            ...
            if ((firstChild->getOpCode().isMul() || firstChild->getOpCode().isLeftShift())
                ...
                if (firstChild->getSecondChild()->getOpCodeValue() == TR::iconst)
                    mulConstBytes
                        = (int64_t)((firstChild->getOpCode().isMul()) ? firstChild->getSecondChild()->getInt() : 2
                                    << firstChild->getSecondChild()->getInt());
                else
                    mulConstBytes = firstChild->getOpCode().isMul() ? firstChild->getSecondChild()->getLongInt() : 2
            ...
            if ((firstChild->getOpCode().isMul() || firstChild->getOpCode().isLeftShift())
                && firstChild->getSecondChild()->getOpCode().isLoadConst()) {
                if (firstChild->getSecondChild()->getOpCodeValue() == TR::iconst)
                    mulConst = (int64_t)((firstChild->getOpCode().isMul()) ? firstChild->getSecondChild()->getInt() : 2
                                << firstChild->getSecondChild()->getInt());
                else
                    mulConst = firstChild->getOpCode().isMul() ? firstChild->getSecondChild()->getLongInt() : 2
                            << firstChild->getSecondChild()->getLongInt();
