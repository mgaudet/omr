...
//
TR_DataFlowAnalysis::Kind TR_RegisterAnticipatability::getKind() { return RegisterAnticipatability; }

TR_RegisterAnticipatability* TR_RegisterAnticipatability::asRegisterAnticipatability() { return this; }

int32_t TR_RegisterAnticipatability::getNumberOfBits() { return TR::RealRegister::NumRegisters; }
...
TR_RegisterAnticipatability::TR_RegisterAnticipatability(TR::Compilation* comp, TR::Optimizer* optimizer,
