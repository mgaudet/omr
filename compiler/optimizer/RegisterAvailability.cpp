...
//
TR_DataFlowAnalysis::Kind TR_RegisterAvailability::getKind() { return RegisterAvailability; }

TR_RegisterAvailability* TR_RegisterAvailability::asRegisterAvailability() { return this; }

int32_t TR_RegisterAvailability::getNumberOfBits() { return TR::RealRegister::NumRegisters; }
...
TR_RegisterAvailability::TR_RegisterAvailability(TR::Compilation* comp, TR::Optimizer* optimizer,
