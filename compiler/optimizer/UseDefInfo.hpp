...
//
    ...
    private:
        ...
        CS2::ArrayOf<TR::SparseBitVector, TR::Allocator>
            _symsKilledByMustKills; // symbol localIndex killed by function call due to mustDef
...
private:
    ...
    const BitVector& getUseDef_ref_body(
        int32_t useIndex, TR_UseDefInfo::BitVector& visitedDefs, TR_UseDefInfo::BitVector* defs = NULL);
...
public:
    ...
    bool getDefsForSymbolIsZero(int32_t symIndex, AuxiliaryData& aux) { return aux._defsForSymbol[symIndex].IsZero(); }
...
private:
    ...
    void buildUseDefs(TR::Node* node, void* vanalysisInfo, TR::BitVector& nodesToBeDereferenced, TR::Node* parent,
        AuxiliaryData& aux);
