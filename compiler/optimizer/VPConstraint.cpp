...
TR::VPConstraint* TR::VPConstraint::create(
    TR::ValuePropagation* vp, const char* sig, int32_t len, TR_ResolvedMethod* method, bool isFixedClass)
{
...
TR::VPShortConstraint* TR::VPShortRange::create(
    TR::ValuePropagation* vp, int16_t low, int16_t high, TR_YesNoMaybe canOverflow)
{
...
TR::VPShortConstraint* TR::VPShortRange::createWithPrecision(
    TR::ValuePropagation* vp, int32_t precision, bool isNonNegative)
{
    int64_t lo, hi;
...
TR::VPIntConstraint* TR::VPIntRange::create(
    TR::ValuePropagation* vp, int32_t low, int32_t high, TR_YesNoMaybe canOverflow)
{
...
TR::VPIntConstraint* TR::VPIntRange::createWithPrecision(
    TR::ValuePropagation* vp, TR::DataType dt, int32_t precision, TR_YesNoMaybe isUnsigned, bool isNonNegative)
{
...
TR::VPLongConstraint* TR::VPLongRange::create(
    TR::ValuePropagation* vp, int64_t low, int64_t high, bool powerOfTwo, TR_YesNoMaybe canOverflow)
{
    ...
    TR::VPPreexistentObject* preexistence, TR::VPArrayInfo* arrayInfo, TR::VPObjectLocation* location)
{
    ...
    if (location != NULL && location->isJavaLangClassObject() == TR_yes && type != NULL && type->asFixedClass() != NULL
        && type->asKnownObject() == NULL && !isSpecialClass((uintptrj_t)type->getClass())) {
...
TR::VPClassType* TR::VPClassType::create(
    TR::ValuePropagation* vp, TR::SymbolReference* symRef, bool isFixedClass, bool isPointerToClass)
{
...
TR::VPClassType* TR::VPClassType::create(TR::ValuePropagation* vp, const char* sig, int32_t len,
...
TR::VPKnownObject* TR::VPKnownObject::create(
    TR::ValuePropagation* vp, TR::KnownObjectTable::Index index, bool isJavaLangClass)
{
...
TR::VPUnresolvedClass* TR::VPUnresolvedClass::create(
    TR::ValuePropagation* vp, const char* sig, int32_t len, TR_ResolvedMethod* method)
{
    // If the constraint does not already exist, create it
    //
...
TR::VPNullObject* TR::VPNullObject::create(TR::ValuePropagation* vp) { return vp->_nullObjectConstraint; }

TR::VPNonNullObject* TR::VPNonNullObject::create(TR::ValuePropagation* vp) { return vp->_nonNullObjectConstraint; }
...
TR::VPArrayInfo* TR::VPArrayInfo::create(
    TR::ValuePropagation* vp, int32_t lowBound, int32_t highBound, int32_t elementSize)
{
    // If the constraint does not already exist, create it
    //
...
TR::VPMergedConstraints* TR::VPMergedConstraints::create(
    TR::ValuePropagation* vp, TR::VPConstraint* first, TR::VPConstraint* second)
{
    // If the constraint does not already exist, create it
    //
...
TR::VPConstraint* TR::VPMergedConstraints::shortMerge(
    TR::VPConstraint* other, ListElement<TR::VPConstraint>* otherNext, TR::ValuePropagation* vp)
{
...
void TR::VPClass::typeIntersect(
    TR::VPClassPresence*& presence, TR::VPClassType*& type, TR::VPConstraint* other, TR::ValuePropagation* vp)
{
...
// *otherNext, TR::ValuePropagation *vp, bool isUnsigned)
//    {
//    TR_ScratchList<TR::VPConstraint>         result(vp->trMemory());
//    ListElement<TR::VPConstraint> *next = _constraints.getListHead();
//    TR::VPIntConstraint           *cur  = next->getData()->asIntConstraint();
...
// TR::VPConstraint *TR::VPIntConstraint::subtract(TR::VPIntConstraint *otherInt, TR::ValuePropagation *vp, bool
// Unsigned)
//    {
...
TR::VPConstraint* TR::VPShortConstraint::getRange(
    int16_t low, int16_t high, bool lowCanOverflow, bool highCanOverflow, TR::ValuePropagation* vp)
{
    // This function returns a VP constraint range, with the appropriate setting of the canOverflow bit, for either an
    // addition or subtraction
    // operation. The function takes the results of the lower- and upper-bound calculations for the operation, both
    // performed in the same precision
    // arithmetic as that of the underlying operation, along with two flags indicated whether or not the operations
    // producing these two bounds
    // overflowed. From these values, a constraint can be created, with the overflow flags being set as conservatively
    // as possible.
    //
...
TR::VPConstraint* TR::VPIntConstraint::getRange(
    int32_t low, int32_t high, bool lowCanOverflow, bool highCanOverflow, TR::ValuePropagation* vp)
{
    // This function returns a VP constraint range, with the appropriate setting of the canOverflow bit, for either an
    // addition or subtraction
    // operation. The function takes the results of the lower- and upper-bound calculations for the operation, both
...
TR::VPConstraint* TR::VPLongConstraint::getRange(
    int64_t low, int64_t high, bool lowCanOverflow, bool highCanOverflow, TR::ValuePropagation* vp)
{
    // This function returns a VP constraint range, with the appropriate setting of the canOverflow bit, for either an
    // addition or subtraction
    // operation. The function takes the results of the lower- and upper-bound calculations for the operation, both
...
bool TR::VPConstraint::mustBeEqual(TR::VPConstraint* other, TR::ValuePropagation* vp) { return false; }
...
bool TR::VPNullObject::mustBeEqual(TR::VPConstraint* other, TR::ValuePropagation* vp) { return other->isNullObject(); }
...
bool TR::VPConstraint::mustBeLessThan(TR::VPConstraint* other, TR::ValuePropagation* vp) { return false; }
...
bool TR::VPConstraint::mustBeLessThanOrEqual(TR::VPConstraint* other, TR::ValuePropagation* vp) { return false; }
...
TR::VPConstraint* TR::VPLessThanOrEqual::propagateRelativeConstraint(
    TR::VPRelation* other, int32_t relative, int32_t otherRelative, TR::ValuePropagation* vp)
{
...
void TR::VPConstraint::print(TR::ValuePropagation* vp) { print(vp->comp(), vp->comp()->getOutFile()); }
...
TR::VPConstraint::Tracer::Tracer(
    TR::ValuePropagation* vpArg, TR::VPConstraint* self, TR::VPConstraint* other, const char* name)
    : _vp(vpArg)
    , _self(self)
    , _other(other)
    , _name(name)
