...
public:
    ...
    static TR::VPShortConstraint* create(
        TR::ValuePropagation* vp, int16_t low, int16_t high, TR_YesNoMaybe canOverflow = TR_no);
    static TR::VPShortConstraint* create(TR::ValuePropagation* vp);
    static TR::VPShortConstraint* createWithPrecision(
        TR::ValuePropagation* vp, int32_t precision, bool isNonNegative = false);
...
public:
    ...
    static TR::VPIntConstraint* create(
        TR::ValuePropagation* vp, int32_t low, int32_t high, TR_YesNoMaybe canOverflow = TR_no);
    static TR::VPIntConstraint* create(TR::ValuePropagation* vp, TR::DataTypes dt,
        TR_YesNoMaybe isUnsigned); // Takes a TR::DataTypes instead of TR::DataType to work around ambiguous overloads
    static TR::VPIntConstraint* createWithPrecision(TR::ValuePropagation* vp, TR::DataType dt, int32_t precision,
...
public:
    ...
    static TR::VPLongConstraint* create(TR::ValuePropagation* vp, int64_t low, int64_t high, bool powerOfTwo = false,
...
public:
    ...
    static TR::VPConstraint* create(TR::ValuePropagation* vp, TR::VPClassType* type, TR::VPClassPresence* presence,
...
public:
    ...
    static TR::VPClassType* create(
        TR::ValuePropagation* vp, TR::SymbolReference* symRef, bool isFixedClass, bool isPointerToClass = false);
    static TR::VPClassType* create(TR::ValuePropagation* vp, const char* sig, int32_t len, TR_ResolvedMethod* method,
...
class VPImplementedInterface : public TR::VPConstraint
   ...
   static  TR::VPImplementedInterface *create(TR::ValuePropagation *vp, char *sig, int32_t len, TR_ResolvedMethod
*method);
...
private:
    TR::VPConstraint* shortMerge(
        TR::VPConstraint* otherCur, ListElement<TR::VPConstraint>* otherNext, TR::ValuePropagation* vp);
    TR::VPConstraint* shortIntersect(
        TR::VPConstraint* otherCur, ListElement<TR::VPConstraint>* otherNext, TR::ValuePropagation* vp);

    // unsigned intMerge
    //   TR::VPConstraint *intMerge(TR::VPIntConstraint *otherCur, ListElement<TR::VPConstraint> *otherNext,
    //   TR::ValuePropagation *vp, bool isUnsigned);
