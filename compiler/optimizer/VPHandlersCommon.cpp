...
static int cacheStringAppend(TR::ValuePropagation* vp, TR::Node* node)
{
    ...
    if (checkMethodSignature(vp, node->getSymbolReference(), sigInit)) {
        ...
        if (strncmp(m->signatureChars(), "(Ljava/lang/String;Ljava/lang/String;)V", m->signatureLength()) == 0) {
            vp->_cachedStringPeepHolesVcalls.add(
                new (vp->comp()->trStackMemory()) TR::ValuePropagation::VPTreeTopPair(tt, tt->getPrevRealTreeTop()));
        }
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    vp->_cachedStringBufferVcalls.add(new (vp->comp()->trStackMemory()) TR::ValuePropagation::VPStringCached(
