...
void TR_ValuePropagation::transformArrayCopyCall(TR::Node* node)
{
    ...
    //
    if ((primitiveTransform || fullTransform) && !comp()->getOption(TR_DisableArrayCopyOpts) && !node->isDontTransformArrayCopyCall() && comp()->fej9()->callTheJitsArrayCopyHelper() && !comp()->getOption(TR_DisableInliningOfNatives) && !(srcObject && srcObject->isNullObject()) && !(dstObject && dstObject->isNullObject()) && srcOffHigh >= 0 && dstOffHigh >= 0 && copyLenHigh >= 0) {
    ...
    if (transformReferenceArray && !comp()->generateArraylets()) {
        ...
        //
        TR_ResolvedMethod* newMethod = findResolvedClassMethod(comp(), "Ljava/lang/System;", "arraycopy", "([Ljava/lang/Object;I[Ljava/lang/Object;II)V");
    }
#else
...
void TR_ValuePropagation::transformObjectCloneCall(TR::TreeTop* callTree, TR_ValuePropagation::ObjCloneInfo* cloneInfo)
{
    ...
    if (!cloneInfo->_isFixed) {
        ...
        TR::TreeTop* compareTree = TR::TreeTop::create(comp(), TR::Node::createif(TR::ifacmpne,
