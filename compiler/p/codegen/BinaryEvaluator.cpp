...
// are not loaded
// into registers when an immediate form of an instruction will do.  This method is used for 'long and' on a 32 bit
// platform.  We will
// call the normal simplifyANDRegImm for a 32 bit value for each of the high and low halves on as long as we don't
// expect both to load
