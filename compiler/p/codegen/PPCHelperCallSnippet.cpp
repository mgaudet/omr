...
void TR_Debug::print(TR::FILE* pOutFile, TR_PPCHelperCallSnippet* snippet)
{
    // *this    swipeable for debugging purposes
...
uint32_t TR_PPCHelperCallSnippet::getHelperCallLength() { return ((_restartLabel == NULL) ? 4 : 8); }
...
uint8_t* TR_Debug::print(TR::FILE* pOutFile, TR_PPCArrayCopyCallSnippet* snippet, uint8_t* cursor)
{
