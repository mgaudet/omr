...
public:
    TR_PPCHelperCallSnippet(TR::CodeGenerator* cg, TR::Node* node, TR::LabelSymbol* snippetlab,
...
public:
    TR_PPCArrayCopyCallSnippet(TR::CodeGenerator* cg, TR::Node* node, TR::LabelSymbol* snippetlab,
