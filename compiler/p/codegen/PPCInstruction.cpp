    ...
    , _memoryReference(mf)
{
    ...
    TR_ASSERT(_hint == PPCOpProp_NoHint || ((op == TR::InstOpCode::lwarx || op == TR::InstOpCode::ldarx)
...
void TR::PPCControlFlowInstruction::assignRegisters(TR_RegisterKinds kindToBeAssigned)
{
    ...
    case TR::InstOpCode::d2i:
        ...
        if (TR::Compiler->target.cpu.id() >= TR_PPCp8)
            cg()->traceRAInstruction(cursor = generateTrg1Src1Instruction(cg(), TR::InstOpCode::mfvsrwz, currentNode,
                                         ...
                                         cursor)); // generateTrg1Src1Instruction(cg(), TR::InstOpCode::mftgpr,
    ...
    case TR::InstOpCode::iternary: {
        // cursor = generateTrg1Src2Instruction   (cg(), TR::InstOpCode::cmp8, currentNode, getTargetRegister(0),
        // getSourceRegister(0), getSourceRegister(0), cursor);
