...
public:
    ...
    {
        return _opCode == PPCOp_fdiv || _opCode == PPCOp_fdivs || _opCode == PPCOp_fsqrt || _opCode == PPCOp_fsqrts;
    }

    bool isFXMult()
    {
        return _opCode == PPCOp_mullw || _opCode == PPCOp_mulli || _opCode == PPCOp_mulhw || _opCode == PPCOp_mulhd
            || _opCode == PPCOp_mulhwu || _opCode == PPCOp_mulhdu;
    }

    bool isAdmin()
    {
        return _opCode == PPCOp_ret || _opCode == PPCOp_fence || _opCode == PPCOp_depend || _opCode == PPCOp_proc
    ...
    const TR_PPCOpCodeBinaryEntry getOpCodeBinaryEncoding() { return getOpCodeBinaryEncoding(_opCode); }
