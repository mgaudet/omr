...
void TR_PPCSystemLinkage::mapParameters(
...
void TR_PPCSystemLinkage::mapSingleAutomatic(
...
void TR_PPCSystemLinkage::createPrologue(
    ...
    List<TR::ParameterSymbol>& parmList)
{
    ...
    if (bodySymbol->isEHAware() || machine->getPPCRealRegister(TR::RealRegister::cr2)->getHasBeenAssignedInMethod() || machine->getPPCRealRegister(TR::RealRegister::cr3)->getHasBeenAssignedInMethod() || machine->getPPCRealRegister(TR::RealRegister::cr4)->getHasBeenAssignedInMethod()) {
