...
bool TR_Debug::methodSigCanBeFound(const char* methodSig, TR_CompilationFilters* filters, TR_FilterBST*& filter, TR_Method::Type methodType)
{
...
bool TR_Debug::methodCanBeFound(TR_Memory* trMemory, TR_ResolvedMethod* method, TR_CompilationFilters* filters, TR_FilterBST*& filter)
{
