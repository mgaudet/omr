...
void TR_Debug::clearFilters(TR_CompilationFilters* filters)
{
...
TR_CompilationFilters* TR_Debug::findOrCreateFilters(TR_CompilationFilters* filters)
{
    if (filters)
        return filters;
    else {
...
TR_CompilationFilters* TR_Debug::findOrCreateFilters(bool loadLimit)
{
    if (loadLimit)
...
TR_FilterBST* TR_Debug::addFilter(char*& filterString, int32_t scanningExclude, int32_t optionSetIndex, int32_t lineNum,
    TR_CompilationFilters* anyFilters)
{
...
bool TR_Debug::scanInlineFilters(FILE* inlineFile, int32_t& lineNumber, TR_CompilationFilters* filters)
{
...
void TR_Debug::printFilters(TR_CompilationFilters* filters)
{
    int32_t i;
    if (filters) {
...
bool TR_Debug::methodSigCanBeFound(
    const char* methodSig, TR_CompilationFilters* filters, TR_FilterBST*& filter, TR_Method::Type methodType)
{
...
bool TR_Debug::methodCanBeFound(
    TR_Memory* trMemory, TR_ResolvedMethod* method, TR_CompilationFilters* filters, TR_FilterBST*& filter)
{
