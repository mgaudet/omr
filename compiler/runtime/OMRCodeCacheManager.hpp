...
public:
    ...
    TR::CodeCache* allocateCodeCacheObject(TR::CodeCacheMemorySegment* codeCacheSegment, size_t codeCacheSizeAllocated,
    ...
    void addFaintCacheBlock(FaintCacheBlock*& blockList, FaintCacheBlock* block, uint8_t bytesToSaveAtStart);
