...
// protected
bool CodeMetaDataManager::removeRange(TR::MethodMetaDataPOD* metaData, uintptr_t startPC, uintptr_t endPC)
{
    bool removeSuccess = false;
    self()->updateCache(metaData->startPC);
    if (_cachedHashTable) {
...
uintptr_t CodeMetaDataManager::removeMetaDataRangeFromHash(
    TR::MetaDataHashTable* table, TR::MethodMetaDataPOD* dataToRemove, uintptr_t startPC, uintptr_t endPC)
{
    TR::MethodMetaDataPOD** index;
    TR::MethodMetaDataPOD** endIndex;
    TR::MethodMetaDataPOD* temp;
