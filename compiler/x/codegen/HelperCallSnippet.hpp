...
public:
    TR_X86HelperCallSnippet(TR::CodeGenerator* cg, TR::Node* node, TR::LabelSymbol* restartLabel,
        TR::LabelSymbol* snippetLabel, TR::SymbolReference* helper, int32_t stackPointerAdjustment = 0);

    TR_X86HelperCallSnippet(TR::CodeGenerator* cg, TR::LabelSymbol* restartLabel, TR::LabelSymbol* snippetLabel,
