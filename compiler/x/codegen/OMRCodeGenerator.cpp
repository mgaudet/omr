...
{
    return TR::CodeGenerator::getX86ProcessorInfo().supportsSSE4_1() && !self()->comp()->getOptions()->getOption(TR_DisableSIMDUTF16LEEncoder);
}

bool OMR::X86::CodeGenerator::getSupportsEncodeUtf16BigWithSurrogateTest()
{
    return TR::CodeGenerator::getX86ProcessorInfo().supportsSSE4_1() && !self()->comp()->getOptions()->getOption(TR_DisableSIMDUTF16BEEncoder);
}

bool OMR::X86::CodeGenerator::supportsMergingOfHCRGuards()
{
    return self()->getSupportsVirtualGuardNOPing() && self()->comp()->performVirtualGuardNOPing() && self()->allowHCRGuardMerging();
}
    ...
    while (instructionCursor && instructionCursor != appendInstruction) {
        ...
        if (comp->cg()->getSupportsVMThreadGRA() && inst->getKind() == TR::Instruction::IsLabel && vmThreadIndex != TR::RealRegister::NoReg) {
            ...
            if (node && node->getOpCodeValue() == TR::BBEnd) {
                ...
                if (block && (!block->getNextBlock() || !block->getNextBlock()->isExtensionOfPreviousBlock())) { // Reset vmThread register state.
...
#ifdef J9_PROJECT_SPECIFIC
    if ((!self()->comp()->getOptions()->getOption(TR_DisableGuardedCountingRecompilations) && TR::Options::getCmdLineOptions()->allowRecompilation()) || (self()->comp()->getOptions()->getEnableGPU(TR_EnableGPU) && self()->comp()->hasIntStreamForEach()))
#else
...
TR_IA32ConstantDataSnippet* OMR::X86::CodeGenerator::findOrCreateConstant(TR::Node* n, void* c, uint8_t size, bool isWarm)
{
    ...
    for (auto iterator = _dataSnippetList.begin(); iterator != _dataSnippetList.end(); ++iterator) {
        if ((*iterator)->getKind() == TR::Snippet::IsConstantData && ((TR_IA32ConstantDataSnippet*)(*iterator))->getConstantSize() == size && (*iterator)->isWarmSnippet() == isWarm) {
            switch (size) {
            case 4:
    ...
    bool traceIt)
{
    ...
    if (x86Instr->getOpCode().isCallOp()) {
        ...
        if (callNode->getOpCode().hasSymbolReference()) //getSymbolReference())
        {
            ...
            if (m && ((m->isHelper() && !m->preservesAllRegisters()) || m->isVMInternalNative() || m->isJITInternalNative() || m->isJNI() || m->isSystemLinkageDispatch() || (m->getLinkageConvention() == TR_System))) {
...
bool OMR::X86::CodeGenerator::suppressInliningOfRecognizedMethod(TR::RecognizedMethod method)
{
    if (self()->isMethodInAtomicLongGroup(method))
        return true;
#ifdef J9_PROJECT_SPECIFIC
    if ((method == TR::java_util_concurrent_atomic_AtomicBoolean_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicInteger_getAndAdd) || (method == TR::java_util_concurrent_atomic_AtomicInteger_getAndIncrement) || (method == TR::java_util_concurrent_atomic_AtomicInteger_getAndDecrement) || (method == TR::java_util_concurrent_atomic_AtomicInteger_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicInteger_addAndGet) || (method == TR::java_util_concurrent_atomic_AtomicInteger_decrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicInteger_incrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicReference_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_getAndAdd) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_getAndIncrement) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_getAndDecrement) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_addAndGet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_decrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerArray_incrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicReferenceArray_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_getAndAdd) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_getAndIncrement) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_getAndDecrement) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_getAndSet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_addAndGet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_decrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicIntegerFieldUpdater_incrementAndGet) || (method == TR::java_util_concurrent_atomic_AtomicReference_getAndSet) || (method == TR::java_lang_Object_clone) || (method == TR::java_lang_Integer_rotateLeft)) {
        return true;
    } else
#endif
    {
