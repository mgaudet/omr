...
namespace X86 {
    ...
    private:
        ...
        enum TR_X86CodeGeneratorFlags {
            ...
            = 0x00000008, ///< support changing FPCW to single precision for individual methods
            ...
            UseGPRsForWin32CTMConversion
            = 0x00001000, ///< use magic number approach for long division for CTM conversion to milliseconds
            UseLongDivideHelperForWin32CTMConversion
            = 0x00002000, ///< use long division helper for CTM conversion to milliseconds
    ...
    public:
        ...
        bool useGPRsForWin32CTMConversion() { return _flags.testAny(UseGPRsForWin32CTMConversion); }
...
public:
    ...
    {
        return _machine->getFPStackLocationPtr(_cursor = TR_X86FPStackRegister::fpFirstStackReg);
    }
    TR::Register* getCurrent() { return _machine->getFPStackLocationPtr(_cursor); }
    TR::Register* getNext()
    {
        return _cursor > TR_X86FPStackRegister::fpLastStackReg ? NULL : _machine->getFPStackLocationPtr(++_cursor);
    }
