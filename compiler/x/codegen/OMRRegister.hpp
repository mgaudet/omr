...
namespace X86 {
    ...
    private:
        enum {
            ...
            NeedsLazyClobbering = 0x0800, // X86 service releases only (well, originally the intent): node refcount = 1
                                          // is not enough to determine that this can be clobbered; must also check
                                          // register node count
