...
public:
    X86RestoreVMThreadInstruction(TR_X86OpCodes op, TR::Node* n, TR::CodeGenerator* cg);
...
public:
    X86MemRegRegInstruction(TR::Register* srreg, TR::Register* slreg, TR::MemoryReference* mr, TR::Node* node,
        TR_X86OpCodes op, TR::CodeGenerator* cg)
    ...
    X86MemRegRegInstruction(TR::Register* srreg, TR::Register* slreg, TR::MemoryReference* mr, TR_X86OpCodes op,
        TR::Instruction* precedingInstruction, TR::CodeGenerator* cg)
    ...
    X86MemRegRegInstruction(TR_X86OpCodes op, TR::Node* node, TR::MemoryReference* mr, TR::Register* slreg,
        TR::Register* srreg, TR::CodeGenerator* cg);

    X86MemRegRegInstruction(TR::Instruction* precedingInstruction, TR_X86OpCodes op, TR::MemoryReference* mr,
        TR::Register* slreg, TR::Register* srreg, TR::CodeGenerator* cg);
...
{
    TR_ASSERT(i->getIA32ImmInstruction() != NULL, "trying to downcast to an IA32ImmInstruction");
...
TR::X86LabelInstruction* generateLabelInstruction(
    TR::Instruction*, TR_X86OpCodes op, TR::LabelSymbol* sym, bool needsVMThreadRegister, TR::CodeGenerator* cg);
inline TR::X86LabelInstruction* generateLabelInstruction(
...
TR::X86LabelInstruction* generateLabelInstruction(TR_X86OpCodes op, TR::Node*, TR::LabelSymbol* sym, TR::Node* glRegDep,
    List<TR::Register>* popRegs, bool needsVMThreadRegister, bool evaluateGlRegDeps, TR::CodeGenerator* cg);

inline TR::X86LabelInstruction* generateLabelInstruction(TR_X86OpCodes op, TR::Node* node, TR::LabelSymbol* sym,
    TR::Node* glRegDep, List<TR::Register>* popRegs, bool needsVMThreadRegister, TR::CodeGenerator* cg)
{
