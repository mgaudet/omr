...
void TR_Debug::print(TR::FILE* pOutFile, TR_X86FPConvertToIntSnippet* snippet)
{
    // *this    swipeable for debugging purposes
...
//
const uint8_t TR_X86FPConvertToLongSnippet::_registerActions[16] = { 0x1e, // 0
    0x14, // 1
    0x0e, // 2
    0x00, // 3
    0x13, // 4
...
void TR_Debug::print(TR::FILE* pOutFile, TR_X86FPConvertToLongSnippet* snippet)
{
    // *this    swipeable for debugging purposes
...
void TR_Debug::print(TR::FILE* pOutFile, TR_X86fbits2iSnippet* snippet)
{
    // *this    swipeable for debugging purposes
    ...
    trfprintf(
        pOutFile, "test\t%s, %sfffffe00%s", getName(snippet->getRegister()), hexPrefixString(), hexSuffixString());
    bufferPos += 6;
