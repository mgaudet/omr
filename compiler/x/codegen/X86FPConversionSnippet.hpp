...
public:
    TR_X86FPConversionSnippet(TR::CodeGenerator* codeGen, TR::Node* node, TR::LabelSymbol* restartlab,
...
public:
    TR_X86FPConvertToIntSnippet(TR::LabelSymbol* restartlab, TR::LabelSymbol* snippetlab,
...
public:
    ...
    TR_X86FPConvertToLongSnippet(TR::LabelSymbol* restartlab, TR::LabelSymbol* snippetlab,
...
public:
    TR_X86fbits2iSnippet(TR::LabelSymbol* restartlab, TR::LabelSymbol* snippetlab, TR::X86RegImmInstruction* instr,
    ...
    TR::RealRegister* getRegister() { return toRealRegister(_instruction->getTargetRegister()); }
...
public:
    ...
    TR_AMD64FPConversionSnippet(
        TR::LabelSymbol*, TR::LabelSymbol*, TR::SymbolReference*, TR::X86RegInstruction*, TR::CodeGenerator*)
    ...
    TR_AMD64FPConversionSnippet(TR::LabelSymbol* restartlab, TR::LabelSymbol* snippetlab,
        TR::SymbolReference* helperSymRef, TR::X86RegInstruction* convertInstr, TR::CodeGenerator* codeGen)
        : TR_X86FPConversionSnippet(codeGen, convertInstr->getNode(), restartlab, snippetlab, helperSymRef)
