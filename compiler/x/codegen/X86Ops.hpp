...
public:
    ...
    {
        return _properties[_opCode] & (IA32OpProp_ModifiesZeroFlag | IA32OpProp_TestsZeroFlag);
    }
    ...
    {
        return _properties[_opCode] & (IA32OpProp_ModifiesSignFlag | IA32OpProp_TestsSignFlag);
    }
    ...
    {
        return _properties[_opCode] & (IA32OpProp_ModifiesCarryFlag | IA32OpProp_TestsCarryFlag);
    }
    ...
    {
        return _properties[_opCode] & (IA32OpProp_ModifiesOverflowFlag | IA32OpProp_TestsOverflowFlag);
    }
    ...
    {
        return _properties[_opCode] & (IA32OpProp_ModifiesParityFlag | IA32OpProp_TestsParityFlag);
    }
    ...
    {
        return (_properties[_opCode] & IA32OpProp_SetsSomeArithmeticFlag) == IA32OpProp_SetsSomeArithmeticFlag;
    }
    ...
    {
        return _properties[op] & (IA32OpProp_ModifiesZeroFlag | IA32OpProp_TestsZeroFlag);
    }
    ...
    {
        return _properties[op] & (IA32OpProp_ModifiesSignFlag | IA32OpProp_TestsSignFlag);
    }
    ...
    {
        return _properties[op] & (IA32OpProp_ModifiesCarryFlag | IA32OpProp_TestsCarryFlag);
    }
    ...
    {
        return _properties[op] & (IA32OpProp_ModifiesOverflowFlag | IA32OpProp_TestsOverflowFlag);
    }
    ...
    {
        return _properties[op] & (IA32OpProp_ModifiesParityFlag | IA32OpProp_TestsParityFlag);
    }
...
#else
        TR_ASSERT(
            !(_properties2[op] & IA32OpProp2_Needs64BitOperandPrefix), "Don't use 64-bit opcodes on 32-bit targets");
        return 0;
#endif
    }
