    ...
    : TR_X86SystemLinkage(cg)
{
    ...
    // for shrinkwrapping, we cannot use pushes for the preserved regs. pushes/pops need to be in sequence and this is
    // not compatible with shrinkwrapping as registers need not be saved/restored in sequenc
...
int32_t TR_IA32SystemLinkage::layoutParm(
...
int32_t TR_IA32SystemLinkage::layoutParm(TR::ParameterSymbol* parmSymbol, int32_t& dataCursor, uint16_t& intReg,
...
int32_t TR_IA32SystemLinkage::buildArgs(TR::Node* callNode, TR::RegisterDependencyConditions* deps)
{
