    ...
    namespace i386 {
        ...
        public:
            Machine(TR::CodeGenerator* cg)
                : OMR::X86::Machine(IA32_NUM_GPR, IA32_NUM_FPR, cg, _registerFileStorage, _registerAssociationsStorage,
                      IA32_MAX_GLOBAL_GPRS, IA32_MAX_8BIT_GLOBAL_GPRS, IA32_MAX_GLOBAL_FPRS, _xmmGlobalRegisterStorage,
