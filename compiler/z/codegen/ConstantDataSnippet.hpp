...
public:
    TR_S390InterfaceCallDataSnippet(TR::CodeGenerator*, TR::Node*, uint8_t, bool useCLFIandBRCL = false);

    TR_S390InterfaceCallDataSnippet(TR::CodeGenerator*, TR::Node*, uint8_t, uint8_t*, bool useCLFIandBRCL = false);
...
public:
    TR_S390JNICallDataSnippet(TR::CodeGenerator*, TR::Node*);
