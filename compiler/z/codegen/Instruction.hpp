...
public:
     ...
     */
    Instruction(TR::Instruction* precedingInstruction, TR::InstOpCode::Mnemonic op,
    ...
    Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::RegisterDependencyConditions* cond, TR::CodeGenerator* cg)
        : OMR::InstructionConnector(cg, op, n)
    {
        self()->initialize(NULL, false, cond, true);
    }

    Instruction(TR::InstOpCode::Mnemonic op, TR::Node* n, TR::RegisterDependencyConditions* cond,
