...
#define S390OpProp_UsesTarget             (uint64_t)0x0000000000000001ull
#define S390OpProp_SingleFP               (uint64_t)0x0000000000000002ull
#define S390OpProp_DoubleFP               (uint64_t)0x0000000000000004ull
#define S390OpProp_SetsZeroFlag           (uint64_t)0x0000000000000008ull
#define S390OpProp_SetsSignFlag           (uint64_t)0x0000000000000010ull
#define S390OpProp_SetsCarryFlag          (uint64_t)0x0000000000000020ull
#define S390OpProp_SetsOverflowFlag       (uint64_t)0x0000000000000040ull
#define S390OpProp_BranchOp               (uint64_t)0x0000000000000080ull
#define S390OpProp_IsLoad                 (uint64_t)0x0000000000000100ull
#define S390OpProp_IsStore                (uint64_t)0x0000000000000200ull
#define S390OpProp_IsSync                 (uint64_t)0x0000000000000400ull
#define S390OpProp_ReadsMultipleRegs      (uint64_t)0x0000000000000800ull
#define S390OpProp_SetsMultipleRegs       (uint64_t)0x0000000000001000ull
#define S390OpProp_Is64Bit                (uint64_t)0x0000000000002000ull
#define S390OpProp_Is32Bit                (uint64_t)0x0000000000004000ull
#define S390OpProp_Is32To64Bit            (uint64_t)0x0000000000008000ull
#define S390OpProp_IsCall                 (uint64_t)0x0000000000010000ull
#define S390OpProp_ReadsCC                (uint64_t)0x0000000000020000ull
#define S390OpProp_SetsCompareFlag        (uint64_t)0x0000000000040000ull
#define S390OpProp_SetsCC                 (uint64_t)0x0000000000080000ull
#define S390OpProp_LongDispSupported      (uint64_t)0x0000000000100000ull
#define S390OpProp_IsExtendedImmediate    (uint64_t)0x0000000000200000ull
#define S390OpProp_UsesRegPairForTarget   (uint64_t)0x0000000000400000ull
#define S390OpProp_UsesRegPairForSource   (uint64_t)0x0000000000800000ull
#define S390OpProp_UsesRegRangeForTarget  (uint64_t)0x0000000001000000ull
#define S390OpProp_IsRegCopy              (uint64_t)0x0000000002000000ull
#define S390OpProp_Trap                   (uint64_t)0x0000000004000000ull
#define S390OpProp_ReadsDFPRoundingMode   (uint64_t)0x0000000008000000ull
#define S390OpProp_SetsDFPRoundingMode    (uint64_t)0x0000000010000000ull
#define S390OpProp_ReadsFPC               (uint64_t)0x0000000020000000ull
#define S390OpProp_SetsFPC                (uint64_t)0x0000000040000000ull
#define S390OpProp_UsesImplicitRegisters  (uint64_t)0x0000000080000000ull
#define S390OpProp_TargetHW               (uint64_t)0x0000000100000000ull
#define S390OpProp_TargetLW               (uint64_t)0x0000000200000000ull
#define S390OpProp_SrcHW                  (uint64_t)0x0000000400000000ull
#define S390OpProp_SrcLW                  (uint64_t)0x0000000800000000ull
#define S390OpProp_Src2HW                 (uint64_t)0x0000001000000000ull
#define S390OpProp_Src2LW                 (uint64_t)0x0000002000000000ull
#define S390OpProp_HasTwoMemoryReferences (uint64_t)0x0000004000000000ull
#define S390OpProp_ImplicitlyUsesGPR0     (uint64_t)0x0000008000000000ull
#define S390OpProp_ImplicitlyUsesGPR1     (uint64_t)0x0000010000000000ull
#define S390OpProp_ImplicitlyUsesGPR2     (uint64_t)0x0000020000000000ull
#define S390OpProp_ImplicitlySetsGPR0     (uint64_t)0x0000040000000000ull
#define S390OpProp_ImplicitlySetsGPR1     (uint64_t)0x0000080000000000ull
#define S390OpProp_ImplicitlySetsGPR2     (uint64_t)0x0000100000000000ull
#define S390OpProp_IsCompare              (uint64_t)0x0000200000000000ull
#define S390OpProp_MayUseRegPairForTarget (uint64_t)0x0000400000000000ull
#define S390OpProp_IsYForm                (uint64_t)0x0000800000000000ull
#define S390OpProp_IsImplicitLoad         (uint64_t)0x0001000000000000ull
#define S390OpProp_IsImplicitStore        (uint64_t)0x0002000000000000ull
#define S390OpProp_MemRefOneIsStore       (uint64_t)0x0004000000000000ull
#define S390OpProp_MemRefOneIsLoad        (uint64_t)0x0008000000000000ull
#define S390OpProp_MemRefTwoIsStore       (uint64_t)0x0010000000000000ull
#define S390OpProp_MemRefTwoIsLoad        (uint64_t)0x0020000000000000ull
#define S390OpProp_SSSchedulingCandidate  (uint64_t)0x0040000000000000ull
#define S390OpProp_IsExecutionHint        (uint64_t)0x0080000000000000ull
#define S390OpProp_SetsOperand1           (uint64_t)0x0100000000000000ull
#define S390OpProp_SetsOperand2           (uint64_t)0x0200000000000000ull
#define S390OpProp_SetsOperand3           (uint64_t)0x0400000000000000ull
#define S390OpProp_SetsOperand4           (uint64_t)0x0800000000000000ull
#define S390OpProp_ImplicitlySetsGPR3     (uint64_t)0x1000000000000000ull
#define S390OpProp_ImplicitlySetsGPR4     (uint64_t)0x2000000000000000ull
#define S390OpProp_ImplicitlySetsGPR5     (uint64_t)0x4000000000000000ull
#define S390OpProp_IsSignedImmediate      (uint64_t)0x8000000000000000ull

/* Instruction Properties 2 (One hot encoding) */
#define S390OpProp2_UsesM3                (uint64_t)0x0000000000000001ull
#define S390OpProp2_UsesM4                (uint64_t)0x0000000000000002ull
#define S390OpProp2_UsesM5                (uint64_t)0x0000000000000004ull
#define S390OpProp2_UsesM6                (uint64_t)0x0000000000000008ull
#define S390OpProp2_HasExtendedMnemonic   (uint64_t)0x0000000000000010ull
#define S390OpProp2_VectorStringOp        (uint64_t)0x0000000000000020ull
#define S390OpProp2_VectorFPOp            (uint64_t)0x0000000000000040ull
