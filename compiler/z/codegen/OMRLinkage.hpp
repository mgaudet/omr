 ...
 */
#define ANYREGINDEX(i) ((i >= TR::RealRegister::FirstAR) ? AREGINDEX(i) : (i >= TR::RealRegister::FirstFPR) ? (i >= TR::RealRegister::FirstAssignableVRF) ? VRFREGINDEX(i) : FPREGINDEX(i) : REGINDEX(i))
/**
