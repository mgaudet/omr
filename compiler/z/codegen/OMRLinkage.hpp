...
#define ANYREGINDEX(i)                                                                                                 \
    ((i >= TR::RealRegister::FirstAR) ? AREGINDEX(i) : (i >= TR::RealRegister::FirstFPR)                               \
 ...
 */
inline TR_S390PrivateLinkage* toS390PrivateLinkage(TR::Linkage* l) { return (TR_S390PrivateLinkage*)l; }

/**
 * 390 Automatic Marker Symbol Types
 */
enum TR_S390AutoMarkers { TR_AutoMarker_EndOfParameterBlock, TR_AutoMarker_NumAutoMarkers };
...
namespace Z {
    ...
    public:
        enum FrameType {
            ...
            noStackLeafFrame,
            StackLeafFrame,
            noStackForwardingFrame, ///< This method may have a single call that forwards on to another method that can
                                    ///be replaced by a jmp
        };
    ...
    public:
        ...
        {
            return ((_properties & SpecialArgumentRegisters) != 0) && (_numSpecialArgumentRegisters > 0);
        }
        ...
        int64_t killAndAssignRegister(int64_t killMask, TR::RegisterDependencyConditions* deps,
            TR::Register** virtualReg, TR::RealRegister* realReg, TR::CodeGenerator* codeGen, bool isAllocate = false,
            bool isDummy = false);
        ...
        virtual bool isEnvironmentSpecialArgumentRegister(int8_t linkageRegisterIndex) { return false; }

        virtual bool isCAASpecialArgumentRegister(int8_t linkageRegisterIndex) { return false; }

        virtual bool isParentDSASpecialArgumentRegister(int8_t linkageRegisterIndex) { return false; }
    ...
    protected:
        ...
        uint8_t getRestoreBump(TR::RealRegister::RegNum, TR::RealRegister::RegNum, int32_t, bool backwards = false);
        int8_t getNumRegsToRestore(TR::RealRegister::RegNum, TR::RealRegister::RegNum, int32_t);
