...
namespace Z {
    ...
    class OMR_EXTENSIBLE Machine : public OMR::Machine {
        ...
        /** Used to keep track of blocked registers (HPR/GPR) that upgrades/spill's etc should not use. Typical stores
         * ~0-3 registers. */
    ...
    public:
        ...
        TR::RealRegister* getS390RealRegister(TR::RealRegister::RegNum regNum) { return _registerFile[regNum]; }

        TR::RealRegister* getS390RealRegister(int32_t regNum) { return _registerFile[regNum]; }
        ...
        TR::Instruction* registerCopy(TR::Instruction* precedingInstruction, TR_RegisterKinds rk,
        ...
        bool isLegalEvenOddRestrictedPair(
            TR::RealRegister* evenReg, TR::RealRegister* oddReg, uint64_t availRegMask = 0x0000ffff);
        ...
        uint64_t filterColouredRegisterConflicts(
            TR::Register* targetRegister, TR::Register* siblingRegister, TR::Instruction* currInstr);
        ...
        TR::RealRegister* freeBestRegister(TR::Instruction* currentInstruction, TR::Register* virtReg,
            TR_RegisterKinds rk, uint64_t availRegMask = 0xffffffff, bool allowNullReturn = false,
        ...
        void spillRegister(
            TR::Instruction* currentInstruction, TR::Register* virtReg, uint32_t availHighWordRegMap = -1);
        ...
        TR_GlobalRegisterNumber getFirstGlobalAccessRegisterNumber() { return _firstGlobalAccessRegisterNumber; }

        TR_GlobalRegisterNumber setFirstGlobalAccessRegisterNumber(TR_GlobalRegisterNumber reg);

        TR_GlobalRegisterNumber getLastGlobalAccessRegisterNumber() { return _lastGlobalAccessRegisterNumber; }
