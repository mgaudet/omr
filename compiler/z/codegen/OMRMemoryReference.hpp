...
namespace Z {
    ...
    private:
         ...
         * _symbolReference
         * is changed to point to a shared symbol with a size with no direct relation to the current instructions use of
         * the symbol.
    ...
    public:
         ...
         * underlying loadaddr symRef. This loadaddr
         * symRef does not reflect the actual size of the symbol being loaded so the fixed _fixedSizeForAlignment must
         * be used instead.
         */
