...
TR::Register* OMR::Z::RegisterIterator::getFirst() { return _machine->getS390RealRegister(_cursor = _firstRegIndex); }

TR::Register* OMR::Z::RegisterIterator::getCurrent() { return _machine->getS390RealRegister(_cursor); }
