...
uint8_t* TR_S390HelperCallSnippet::emitSnippetBody()
{
...
uint32_t TR_S390HelperCallSnippet::getLength(int32_t)
{
    uint32_t length;
    TR::SymbolReference* helperSymRef = getHelperSymRef();
...
void TR_Debug::print(TR::FILE* pOutFile, TR_S390HelperCallSnippet* snippet)
{
