...
public:
    TR_S390SystemLinkage(TR::CodeGenerator* cg, TR_S390LinkageConventions elc = TR_S390LinkageDefault,
    ...
    virtual void generateInstructionsForCall(TR::Node* callNode, TR::RegisterDependencyConditions* dependencies,
        ...
        TR::LabelSymbol* returnFromJNICallLabel, TR_S390JNICallDataSnippet* jniCallDataSnippet,
    ...
    virtual TR::SymbolReference* getAutoMarkerSymbol(TR_S390AutoMarkers markerType)
    {
        return _autoMarkerSymbols ? (*_autoMarkerSymbols)[markerType] : 0;
    }
    virtual void setAutoMarkerSymbolOffset(TR_S390AutoMarkers markerType, int32_t offset)
    {
        getAutoMarkerSymbol(markerType)->getSymbol()->castToAutoSymbol()->setOffset(offset);
    }
    ...
    virtual TR::Instruction* getputARs(
        TR::InstOpCode::Mnemonic opcode, TR::Instruction* cursor, TR::Node* node, TR::RealRegister* spReg = 0);
