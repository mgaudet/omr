...
public:
    ...
    {
        bool result = isSpecialArgumentRegisters() && (linkageRegisterIndex >= TR_FirstSpecialLinkageIndex) && (linkageRegisterIndex - TR_FirstSpecialLinkageIndex) == 0;
        return result;
    }
    ...
    {
        bool result = isSpecialArgumentRegisters() && (linkageRegisterIndex >= TR_FirstSpecialLinkageIndex) && (linkageRegisterIndex - TR_FirstSpecialLinkageIndex) == 1;
        return result;
    }
