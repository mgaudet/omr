 ...
 */
bool MM_ConfigurationLanguageInterfaceImpl::initialize(MM_EnvironmentBase* env)
{
    return true;
}
 ...
 */
bool MM_ConfigurationLanguageInterfaceImpl::initializeEnvironment(MM_EnvironmentBase* env)
{
    return true;
}
...
bool MM_ConfigurationLanguageInterfaceImpl::initializeArrayletLeafSize(MM_EnvironmentBase* env)
{
    return true;
}

void MM_ConfigurationLanguageInterfaceImpl::initializeWriteBarrierType(MM_EnvironmentBase* env, uintptr_t configWriteBarrierType)
{
}

void MM_ConfigurationLanguageInterfaceImpl::initializeAllocationType(MM_EnvironmentBase* env, uintptr_t configGcAllocationType)
{
}
...
void MM_ConfigurationLanguageInterfaceImpl::initializeSaltData(MM_EnvironmentBase* env, uintptr_t index, uint32_t startValue)
{
}
