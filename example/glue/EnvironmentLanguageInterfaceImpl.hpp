...
public:
    ...
    static MM_EnvironmentLanguageInterfaceImpl* getInterface(MM_EnvironmentLanguageInterface* linterface)
    {
     ...
     */
    virtual void assumeExclusiveVMAccess(uintptr_t exclusiveCount) { _omrThread->exclusiveCount = exclusiveCount; }
