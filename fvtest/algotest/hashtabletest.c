...
static uintptr_t dataOffset(uintptr_t startOffset,
                            ...
                            uintptr_t i);
static BOOLEAN checkIntegrity(OMRPortLibrary* portLib,
                              char* id,
                              J9HashTable* table,
                              uintptr_t* data,
                              uintptr_t dataLength,
                              ...
                              uintptr_t i);
static BOOLEAN runTests(OMRPortLibrary* portLib,
                        char* id,
                        J9HashTable* table,
                        uintptr_t* data,
                        uintptr_t dataLength,
                        uintptr_t reverseRemove);
static void testHashtable(OMRPortLibrary* portLib,
                          char* id,
                          uintptr_t* data,
                          uintptr_t dataLength,
                          uintptr_t* passCount,
...
static void testCollisionResilientHashTable(OMRPortLibrary* portLib,
                                            char* id,
                                            uintptr_t* data,
                                            uintptr_t dataLength,
                                            uintptr_t* passCount,
...
static void printRandomData(OMRPortLibrary* portLib,
                            uintptr_t* randData,
                            uintptr_t randSize);
