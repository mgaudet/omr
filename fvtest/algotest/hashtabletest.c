...
static void testHashtable(OMRPortLibrary *portLib, char *id, uintptr_t *data,
  ...
  if ((table = hashTableNew(
           portLib, "testTable", 17, sizeof(uintptr_t), sizeof(char *),
           J9HASH_TABLE_ALLOW_SIZE_OPTIMIZATION, OMRMEM_CATEGORY_VM, hashFn,
           hashEqualFn, NULL, (void *)(uintptr_t)forceCollisions)) == NULL) {
