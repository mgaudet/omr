...
static int32_t testHookInterface(OMRPortLibrary *portLib, uintptr_t *passCount, uintptr_t *failCount,
...
static void testRegisterWithAgent(OMRPortLibrary *portLib, uintptr_t *passCount, uintptr_t *failCount,
								  J9HookInterface **hookInterface, uintptr_t event, uintptr_t agentID,
...
static void testDispatch(OMRPortLibrary *portLib, uintptr_t *passCount, uintptr_t *failCount, uintptr_t event,
					  ...
					  uintptr_t expectedResult)
{
	...
	if (((*hookInterface)
			 ->J9HookRegister(hookInterface, event | J9HOOK_TAG_AGENT_ID, hookOrderedEvent, (void *)userData, agentID)
		 == 0)
		== (expectedResult == 0)) {
		(*passCount)++;
	} else {
...
static uintptr_t
testAllocateAgentID(OMRPortLibrary *portLib, uintptr_t *passCount, uintptr_t *failCount,
					J9HookInterface **hookInterface)
{
...
static void
testDispatch(OMRPortLibrary *portLib, uintptr_t *passCount, uintptr_t *failCount, uintptr_t event,
			 uintptr_t expectedResult)
{
	OMRPORT_ACCESS_FROM_OMRPORT(portLib);
	uintptr_t count = 0;
