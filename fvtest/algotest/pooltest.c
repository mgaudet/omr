...
static intptr_t createNewPools(OMRPortLibrary* portLib,
                               uintptr_t* passCount,
                               uintptr_t* failCount);
static void testNewElement(OMRPortLibrary* portLib,
                           uintptr_t* passCount,
                           uintptr_t* failCount);
static void testWalkFunctions(OMRPortLibrary* portLib,
                              uintptr_t* passCount,
                              uintptr_t* failCount);
static void testRemoveElement(OMRPortLibrary* portLib,
                              uintptr_t* passCount,
                              uintptr_t* failCount);
static void testKill(OMRPortLibrary* portLib,
                     uintptr_t* passCount,
                     uintptr_t* failCount);
static void testClear(OMRPortLibrary* portLib,
                      uintptr_t* passCount,
                      uintptr_t* failCount);
static void testPuddleListSharing(OMRPortLibrary* portLib,
                                  uintptr_t* passCount,
                                  uintptr_t* failCount);

static void* customAlloc(J9PoolUserData* userData,
                         uint32_t size,
                         const char* callSite,
...
int32_t verifyPools(OMRPortLibrary* portLib,
                    uintptr_t* passCount,
                    uintptr_t* failCount) {
  int32_t rc = 0;
