...
TestCompiler::FrontEnd* TestCompiler::CodeCacheManager::pyfe() { return reinterpret_cast<FrontEnd*>(self()->fe()); }
    ...
    size_t segmentSize, size_t& codeCacheSizeToAllocate, void* preferredStartAddress)
{
    ...
    uint8_t* memorySlab = (uint8_t*)mmap(
        NULL, codeCacheSizeToAllocate, PROT_READ | PROT_WRITE | PROT_EXEC, MAP_ANONYMOUS | MAP_PRIVATE, 0, 0);
