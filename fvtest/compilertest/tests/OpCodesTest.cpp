...
uint8_t* OpCodesTest::compileOpCodeMethod(int32_t opCodeArgsNum, TR::ILOpCodes opCode, char* resolvedMethodName,
    TR::DataType* argTypes, TR::DataType returnType, int32_t& returnCode, uint16_t numArgs, ...)
{
...
uint8_t* OpCodesTest::compileDirectCallOpCodeMethod(int32_t opCodeArgsNum, TR::ILOpCodes opCodeCompilee,
    TR::ILOpCodes opCode, char* compileeResolvedMethodName, char* testResolvedMethodName, TR::DataType* argTypes,
    ...
    TR::DataType* argTypes, TR::DataType returnType)
{
    ...
    EXPECT_EQ(COMPILATION_IL_GEN_FAILURE, returnCode) << resolvedMethodName << " is " << returnCode << ", expected is "
...
void OpCodesTest::compileIntegerArithmeticTestMethods()
{
    ...
    _iAdd = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iadd, "iAdd", _argTypesBinaryInt, TR::Int32, rc));
    _iSub = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::isub, "iSub", _argTypesBinaryInt, TR::Int32, rc));
    _iDiv = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::idiv, "iDiv", _argTypesBinaryInt, TR::Int32, rc));
    _iMul = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::imul, "iMul", _argTypesBinaryInt, TR::Int32, rc));
    _iRem = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::irem, "iRem", _argTypesBinaryInt, TR::Int32, rc));
}
...
void OpCodesTest::compileMemoryOperationTestMethods()
{
    ...
    _iLoad = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::iload, "iLoad", _argTypesUnaryInt, TR::Int32, rc));
    _lLoad = (signatureCharJ_J_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::lload, "lLoad", _argTypesUnaryLong, TR::Int64, rc));
    _dLoad = (signatureCharD_D_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::dload, "dLoad", _argTypesUnaryDouble, TR::Double, rc));
    _fLoad = (signatureCharF_F_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::fload, "fLoad", _argTypesUnaryFloat, TR::Float, rc));

    _iStore = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::istore, "iStore", _argTypesUnaryInt, TR::Int32, rc));

    _iLoadi = (signatureCharL_I_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::iloadi, "iLoadi", _argTypesUnaryAddress, TR::Int32, rc));
    _lLoadi = (signatureCharL_J_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::lloadi, "lLoadi", _argTypesUnaryAddress, TR::Int64, rc));
    _dLoadi = (signatureCharL_D_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::dloadi, "dLoadi", _argTypesUnaryAddress, TR::Double, rc));
    _fLoadi = (signatureCharL_F_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::floadi, "fLoadi", _argTypesUnaryAddress, TR::Float, rc));
    _bLoadi = (signatureCharL_B_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::bloadi, "bLoadi", _argTypesUnaryAddress, TR::Int8, rc));
    _sLoadi = (signatureCharL_S_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::sloadi, "sLoadi", _argTypesUnaryAddress, TR::Int16, rc));
    _aLoadi = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::aloadi, "aLoadi", _argTypesUnaryAddress, TR::Address, rc));
}
...
void OpCodesTest::compileUnaryTestMethods()
{
    ...
    _iReturn = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::ireturn, "iReturn", _argTypesUnaryInt, TR::Int32, rc));
...
void OpCodesTest::compileShiftOrRolTestMethods()
{
    ...
    _iShl = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ishl, "iShl", _argTypesBinaryInt, TR::Int32, rc));
    _iShr = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ishr, "iShr", _argTypesBinaryInt, TR::Int32, rc));
    _iuShr = (unsignedSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iushr, "iuShr", _argTypesBinaryInt, TR::Int32, rc));
}
...
void OpCodesTest::compileBitwiseMethods()
{
    ...
    _iAnd = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iand, "iAnd", _argTypesBinaryInt, TR::Int32, rc));
    ...
    _iXor = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ixor, "iXor", _argTypesBinaryInt, TR::Int32, rc));
}
...
void OpCodesTest::compileCompareTestMethods()
{
    ...
    _iCmpeq = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmpeq, "iCmpeq", _argTypesBinaryInt, TR::Int32, rc));
    _iCmpne = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmpne, "iCmpne", _argTypesBinaryInt, TR::Int32, rc));
    _iCmpgt = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmpgt, "iCmpgt", _argTypesBinaryInt, TR::Int32, rc));
    _iCmplt = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmplt, "iCmplt", _argTypesBinaryInt, TR::Int32, rc));
    _iCmpge = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmpge, "iCmpge", _argTypesBinaryInt, TR::Int32, rc));
    _iCmple = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::icmple, "iCmple", _argTypesBinaryInt, TR::Int32, rc));

    _lCmpne = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lcmpne, "lCmpne", _argTypesBinaryLong, TR::Int32, rc));
    _lCmpgt = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lcmpgt, "lCmpgt", _argTypesBinaryLong, TR::Int32, rc));
    _lCmpge = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lcmpge, "lCmpge", _argTypesBinaryLong, TR::Int32, rc));
    _lCmple = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lcmple, "lCmple", _argTypesBinaryLong, TR::Int32, rc));

    _iuCmplt = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iucmplt, "iuCmplt", _argTypesBinaryInt, TR::Int32, rc));
    _iuCmpgt = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iucmpgt, "iuCmpgt", _argTypesBinaryInt, TR::Int32, rc));
    _iuCmple = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iucmple, "iuCmple", _argTypesBinaryInt, TR::Int32, rc));
    _luCmpeq = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmpeq, "luCmpeq", _argTypesBinaryLong, TR::Int32, rc));
    _luCmpne = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmpne, "luCmpne", _argTypesBinaryLong, TR::Int32, rc));
    _luCmplt = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmplt, "luCmplt", _argTypesBinaryLong, TR::Int32, rc));
    _luCmpge = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmpge, "luCmpge", _argTypesBinaryLong, TR::Int32, rc));
    _luCmpgt = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmpgt, "luCmpgt", _argTypesBinaryLong, TR::Int32, rc));
    _luCmple = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::lucmple, "luCmple", _argTypesBinaryLong, TR::Int32, rc));

    // CompareAndBranch
    _ifIcmpeq = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmpeq, "ifIcmpeq", _argTypesBinaryInt, TR::Int32, rc));
    _ifIcmpne = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmpne, "ifIcmpne", _argTypesBinaryInt, TR::Int32, rc));
    _ifIcmpgt = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmpgt, "ifIcmpgt", _argTypesBinaryInt, TR::Int32, rc));
    _ifIcmplt = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmplt, "ifIcmplt", _argTypesBinaryInt, TR::Int32, rc));
    _ifIcmpge = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmpge, "ifIcmpge", _argTypesBinaryInt, TR::Int32, rc));
    _ifIcmple = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ificmple, "ifIcmple", _argTypesBinaryInt, TR::Int32, rc));

    _ifLcmpne = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflcmpne, "ifLcmpne", _argTypesBinaryLong, TR::Int32, rc));
    _ifLcmpge = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflcmpge, "ifLcmpge", _argTypesBinaryLong, TR::Int32, rc));
    _ifLcmple = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflcmple, "ifLcmple", _argTypesBinaryLong, TR::Int32, rc));

    _ifIuCmpeq = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmpeq, "ifIuCmpeq", _argTypesBinaryInt, TR::Int32, rc));
    _ifIuCmpne = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmpne, "ifIuCmpne", _argTypesBinaryInt, TR::Int32, rc));
    _ifIuCmplt = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmplt, "ifIuCmplt", _argTypesBinaryInt, TR::Int32, rc));
    _ifIuCmpge = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmpge, "ifIuCmpge", _argTypesBinaryInt, TR::Int32, rc));
    _ifIuCmpgt = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmpgt, "ifIuCmpgt", _argTypesBinaryInt, TR::Int32, rc));
    _ifIuCmple = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::ifiucmple, "ifIuCmple", _argTypesBinaryInt, TR::Int32, rc));
    _ifLuCmpeq = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmpeq, "ifLuCmpeq", _argTypesBinaryLong, TR::Int32, rc));
    _ifLuCmpne = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmpne, "ifLuCmpne", _argTypesBinaryLong, TR::Int32, rc));
    _ifLuCmplt = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmplt, "ifLuCmplt", _argTypesBinaryLong, TR::Int32, rc));
    _ifLuCmpge = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmpge, "ifLuCmpge", _argTypesBinaryLong, TR::Int32, rc));
    _ifLuCmpgt = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmpgt, "ifLuCmpgt", _argTypesBinaryLong, TR::Int32, rc));
    _ifLuCmple = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::iflucmple, "ifLuCmple", _argTypesBinaryLong, TR::Int32, rc));
}
...
void OpCodesTest::compileTernaryTestMethods()
{
    ...
    _iternary = (signatureCharIII_I_testMethodType*)(compileOpCodeMethod(
        _numberOfTernaryArgs, TR::iternary, "iTernary", _argTypesTernaryInt, TR::Int32, rc));
}
...
void OpCodesTest::compileAddressTestMethods()
{
    ...
    _aload = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::aload, "aload", _argTypesUnaryAddress, TR::Address, rc));
    _astore = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::astore, "astore", _argTypesUnaryAddress, TR::Address, rc));
    _areturn = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::areturn, "areturn", _argTypesUnaryAddress, TR::Address, rc));
    _a2i = (signatureCharL_I_testMethodType*)(compileOpCodeMethod(
        _numberOfUnaryArgs, TR::a2i, "a2i", _argTypesUnaryAddress, TR::Int32, rc));
}
...
void OpCodesTest::compileDisabledOpCodesTests()
{
    ...
    _fRem = (signatureCharFF_F_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::frem, "fRem", _argTypesBinaryFloat, TR::Float, rc));
    _dRem = (signatureCharDD_D_testMethodType*)(compileOpCodeMethod(
        _numberOfBinaryArgs, TR::drem, "dRem", _argTypesBinaryDouble, TR::Double, rc));
}
...
void OpCodesTest::invokeMemoryOperationTests()
{
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iMemCons = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::istore,
...
void OpCodesTest::invokeShiftOrRolTests()
{
    ...
    int32_t ishlDataArr[][2] = { INT_ZERO, INT_ZERO, INT_MINIMUM, INT_ZERO, INT_NEG, INT_ZERO, INT_POS, INT_MAX_STEP };
    int32_t ishrDataArr[][2] = { INT_MAXIMUM, INT_POS, INT_MAXIMUM, INT_MAX_STEP, INT_MINIMUM, INT_MAX_STEP, INT_NEG,
        INT_POS, INT_POS, INT_POS };
    uint32_t iushrDataArr[][2]
        = { UINT_POS, UINT_MAX_STEP, UINT_MINIMUM, UINT_POS, UINT_MAXIMUM, UINT_MINIMUM, UINT_POS, UINT_POS };
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishl,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &ishlDataArr[i][0], 2, &ishlDataArr[i][1]));
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishl,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &ishlDataArr[i][0]));
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishl,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &ishlDataArr[i][1]));
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishr,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &ishrDataArr[i][0], 2, &ishrDataArr[i][1]));
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishr,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &ishrDataArr[i][0]));
        ...
        iShiftOrRolConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ishr,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &ishrDataArr[i][1]));
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        ...
        iuShiftOrRolConst = (unsignedSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iushr, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &iushrDataArr[i][0], 2,
            &iushrDataArr[i][1]));
        ...
        iuShiftOrRolConst = (unsignedSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iushr, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &iushrDataArr[i][0]));
        EXPECT_EQ(
            shr(iushrDataArr[i][0], iushrDataArr[i][1]), iuShiftOrRolConst(INT_PLACEHOLDER_1, iushrDataArr[i][1]));

        sprintf(resolvedMethodName, "iuShrConst3_TestCase%d", i + 1);
        iuShiftOrRolConst = (unsignedSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iushr, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &iushrDataArr[i][1]));
        EXPECT_EQ(
            shr(iushrDataArr[i][0], iushrDataArr[i][1]), iuShiftOrRolConst(iushrDataArr[i][0], INT_PLACEHOLDER_2));
    }
}
...
void OpCodesTest::invokeUnaryTests()
{
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iUnaryCons = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::ireturn,
            resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2, 1, &(intDataArray[i])));
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iUnaryCons = (signatureCharI_I_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::iconst,
            resolvedMethodName, _argTypesUnaryInt, TR::Int32, rc, 2, 1, &(intDataArray[i])));
        EXPECT_EQ(intDataArray[i], iUnaryCons(INT_PLACEHOLDER_1));
    }
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        bUnaryCons = (signatureCharB_B_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::bconst,
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        sUnaryCons = (signatureCharS_S_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::sconst,
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        ...
        i2bConst = (signatureCharI_B_testMethodType*)(compileOpCodeMethod(
            _numberOfUnaryArgs, TR::i2b, resolvedMethodName, _argTypesUnaryInt, TR::Int8, rc, 2, 1, &intDataArray[i]));
        ...
        i2sConst = (signatureCharI_S_testMethodType*)(compileOpCodeMethod(
            _numberOfUnaryArgs, TR::i2s, resolvedMethodName, _argTypesUnaryInt, TR::Int16, rc, 2, 1, &intDataArray[i]));
        ...
        i2lConst = (signatureCharI_J_testMethodType*)(compileOpCodeMethod(
            _numberOfUnaryArgs, TR::i2l, resolvedMethodName, _argTypesUnaryInt, TR::Int64, rc, 2, 1, &intDataArray[i]));
...
void OpCodesTest::invokeBitwiseTests()
{
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iand,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(intAndArr[i][0]), 2, &(intAndArr[i][1])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iand,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(intAndArr[i][0])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iand,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(intAndArr[i][1])));
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ior,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(intOrArr[i][0]), 2, &(intOrArr[i][1])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ior,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(intOrArr[i][0])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ior,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(intOrArr[i][1])));
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ixor,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(intXorArr[i][0]), 2, &(intXorArr[i][1])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ixor,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(intXorArr[i][0])));
        ...
        iBitwiseConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ixor,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(intXorArr[i][1])));
...
void OpCodesTest::invokeCompareTests()
{
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]), _iCmpeq(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpeqConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpeqDataArr[i][0]), 2,
            &(iCmpeqDataArr[i][1])));
        EXPECT_EQ(
            compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpeqConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpeqDataArr[i][0])));
        EXPECT_EQ(
            compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpeqConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpeqDataArr[i][1])));
        EXPECT_EQ(
            compareEQ(iCmpeqDataArr[i][0], iCmpeqDataArr[i][1]), iCompareConst(iCmpeqDataArr[i][0], INT_PLACEHOLDER_2));
    }

    testCaseNum = sizeof(iCmpneDataArr) / sizeof(iCmpneDataArr[0]);
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]), _iCmpne(iCmpneDataArr[i][0], iCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpneConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpneDataArr[i][0]), 2,
            &(iCmpneDataArr[i][1])));
        EXPECT_EQ(
            compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpneConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpneDataArr[i][0])));
        EXPECT_EQ(
            compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpneConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpneDataArr[i][1])));
        EXPECT_EQ(
            compareNE(iCmpneDataArr[i][0], iCmpneDataArr[i][1]), iCompareConst(iCmpneDataArr[i][0], INT_PLACEHOLDER_2));
    }

    testCaseNum = sizeof(iCmpgtDataArr) / sizeof(iCmpgtDataArr[0]);
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]), _iCmpgt(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpgtConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpgtDataArr[i][0]), 2,
            &(iCmpgtDataArr[i][1])));
        EXPECT_EQ(
            compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpgtConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpgtDataArr[i][0])));
        EXPECT_EQ(
            compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpgtConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpgtDataArr[i][1])));
        EXPECT_EQ(
            compareGT(iCmpgtDataArr[i][0], iCmpgtDataArr[i][1]), iCompareConst(iCmpgtDataArr[i][0], INT_PLACEHOLDER_2));
    }

    testCaseNum = sizeof(iCmpltDataArr) / sizeof(iCmpltDataArr[0]);
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]), _iCmplt(iCmpltDataArr[i][0], iCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpltConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpltDataArr[i][0]), 2,
            &(iCmpltDataArr[i][1])));
        EXPECT_EQ(
            compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpltConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpltDataArr[i][0])));
        EXPECT_EQ(
            compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpltConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpltDataArr[i][1])));
        EXPECT_EQ(
            compareLT(iCmpltDataArr[i][0], iCmpltDataArr[i][1]), iCompareConst(iCmpltDataArr[i][0], INT_PLACEHOLDER_2));
    }

    testCaseNum = sizeof(iCmpgeDataArr) / sizeof(iCmpgeDataArr[0]);
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]), _iCmpge(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpgeConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpgeDataArr[i][0]), 2,
            &(iCmpgeDataArr[i][1])));
        EXPECT_EQ(
            compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpgeConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpgeDataArr[i][0])));
        EXPECT_EQ(
            compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpgeConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpgeDataArr[i][1])));
        EXPECT_EQ(
            compareGE(iCmpgeDataArr[i][0], iCmpgeDataArr[i][1]), iCompareConst(iCmpgeDataArr[i][0], INT_PLACEHOLDER_2));
    }

    testCaseNum = sizeof(iCmpleDataArr) / sizeof(iCmpleDataArr[0]);
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]), _iCmple(iCmpleDataArr[i][0], iCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpleConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iCmpleDataArr[i][0]), 2,
            &(iCmpleDataArr[i][1])));
        EXPECT_EQ(
            compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "iCmpleConst2_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iCmpleDataArr[i][0])));
        EXPECT_EQ(
            compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]), iCompareConst(INT_PLACEHOLDER_1, iCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "iCmpleConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::icmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iCmpleDataArr[i][1])));
        EXPECT_EQ(
            compareLE(iCmpleDataArr[i][0], iCmpleDataArr[i][1]), iCompareConst(iCmpleDataArr[i][0], INT_PLACEHOLDER_2));
    }
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]), _lCmpne(lCmpneDataArr[i][0], lCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpneConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(lCmpneDataArr[i][0]), 2,
            &(lCmpneDataArr[i][1])));
        EXPECT_EQ(
            compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]), lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

#ifndef TR_TARGET_POWER
        sprintf(resolvedMethodName, "lCmpneConst2_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(lCmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, lCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpneConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(lCmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(lCmpneDataArr[i][0], lCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]), _lCmpgt(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpgtConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpgt,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(lCmpgtDataArr[i][0]), 2,
            &(lCmpgtDataArr[i][1])));
        EXPECT_EQ(
            compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]), lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

#ifndef TR_TARGET_POWER
        sprintf(resolvedMethodName, "lCmpgtConst2_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpgt,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(lCmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, lCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpgtConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpgt,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(lCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(lCmpgtDataArr[i][0], lCmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]), _lCmpge(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpgeConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(lCmpgeDataArr[i][0]), 2,
            &(lCmpgeDataArr[i][1])));
        EXPECT_EQ(
            compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]), lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "lCmpgeConst2_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(lCmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, lCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpgeConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(lCmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(lCmpgeDataArr[i][0], lCmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(
            compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]), _lCmple(lCmpleDataArr[i][0], lCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpleConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(lCmpleDataArr[i][0]), 2,
            &(lCmpleDataArr[i][1])));
        EXPECT_EQ(
            compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]), lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));

        sprintf(resolvedMethodName, "lCmpleConst2_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(lCmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, lCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "lCmpleConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::lcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(lCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(lCmpleDataArr[i][0], lCmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iuCmpgtDataArr[i][0]), 2,
            &(iuCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iuCmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, iuCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "iuCmpgtConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iuCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(iuCmpgtDataArr[i][0], iuCmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
            _iuCmplt(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "iuCmpltConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iuCmpltDataArr[i][0]), 2,
            &(iuCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iuCmpltDataArr[i][0])));
        EXPECT_EQ(compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, iuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "iuCmpltConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iuCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(iuCmpltDataArr[i][0], iuCmpltDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
            _iuCmple(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "iuCmpleConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(iuCmpleDataArr[i][0]), 2,
            &(iuCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(iuCmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, iuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "iuCmpleConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(iuCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(iuCmpleDataArr[i][0], iuCmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
            _luCmpeq(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpeqConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpeqDataArr[i][0]), 2,
            &(luCmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpeqDataArr[i][0])));
        EXPECT_EQ(compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpeqConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(luCmpeqDataArr[i][0], luCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            _luCmpne(luCmpneDataArr[i][0], luCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpneConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpneDataArr[i][0]), 2,
            &(luCmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpneConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(luCmpneDataArr[i][0], luCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
            _luCmpgt(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpgtConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpgtDataArr[i][0]), 2,
            &(luCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpgtConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(luCmpgtDataArr[i][0], luCmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
            _luCmplt(luCmpltDataArr[i][0], luCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpltConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpltDataArr[i][0]), 2,
            &(luCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpltDataArr[i][0])));
        EXPECT_EQ(compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpltConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(luCmpltDataArr[i][0], luCmpltDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
            _luCmpge(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpgeConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpgeDataArr[i][0]), 2,
            &(luCmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpgeConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(luCmpgeDataArr[i][0], luCmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
            _luCmple(luCmpleDataArr[i][0], luCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpleConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(luCmpleDataArr[i][0]), 2,
            &(luCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(luCmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, luCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "luCmpleConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::lucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(luCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(luCmpleDataArr[i][0], luCmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
            _ifIcmpeq(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpeqConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpeqDataArr[i][0]), 2,
            &(ifIcmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpeqDataArr[i][0])));
        EXPECT_EQ(compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpeqConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpeq,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(ifIcmpeqDataArr[i][0], ifIcmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
            _ifIcmpne(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpneConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpneDataArr[i][0]), 2,
            &(ifIcmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpneConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpne,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifIcmpneDataArr[i][0], ifIcmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
            _ifIcmpgt(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpgtConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpgtDataArr[i][0]), 2,
            &(ifIcmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpgtConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpgt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(ifIcmpgtDataArr[i][0], ifIcmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
            _ifIcmplt(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpltConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpltDataArr[i][0]), 2,
            &(ifIcmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpltDataArr[i][0])));
        EXPECT_EQ(compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpltConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmplt,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(ifIcmpltDataArr[i][0], ifIcmpltDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
            _ifIcmpge(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpgeConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpgeDataArr[i][0]), 2,
            &(ifIcmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpgeConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmpge,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifIcmpgeDataArr[i][0], ifIcmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
            _ifIcmple(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpleConst1_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIcmpleDataArr[i][0]), 2,
            &(ifIcmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, INT_PLACEHOLDER_2));
        ...
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIcmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
            iCompareConst(INT_PLACEHOLDER_1, ifIcmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIcmpleConst3_TestCase%d", i + 1);
        iCompareConst = (signatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::ificmple,
            resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIcmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifIcmpleDataArr[i][0], ifIcmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
            _ifLcmpne(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpneConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLcmpneDataArr[i][0]), 2,
            &(ifLcmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
        ...
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLcmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, ifLcmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpneConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpne,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLcmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifLcmpneDataArr[i][0], ifLcmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
            _ifLcmpge(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpgeConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLcmpgeDataArr[i][0]), 2,
            &(ifLcmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLcmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, ifLcmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpgeConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmpge,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLcmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifLcmpgeDataArr[i][0], ifLcmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
            _ifLcmple(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpleConst1_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLcmpleDataArr[i][0]), 2,
            &(ifLcmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, LONG_PLACEHOLDER_2));
        ...
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLcmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
            lCompareConst(LONG_PLACEHOLDER_1, ifLcmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLcmpleConst3_TestCase%d", i + 1);
        lCompareConst = (signatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs, TR::iflcmple,
            resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLcmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifLcmpleDataArr[i][0], ifLcmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
            _ifIuCmpeq(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpeqConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpeqDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpeqDataArr[i][0])));
        EXPECT_EQ(compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpeqConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpeq, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(ifIuCmpeqDataArr[i][0], ifIuCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
            _ifIuCmpne(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpneConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpneDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpneConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpne, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifIuCmpneDataArr[i][0], ifIuCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
            _ifIuCmpgt(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpgtConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpgtDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpgtConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpgt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(ifIuCmpgtDataArr[i][0], ifIuCmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
            _ifIuCmplt(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpltConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpltDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpltDataArr[i][0])));
        EXPECT_EQ(compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpltConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmplt, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(ifIuCmpltDataArr[i][0], ifIuCmpltDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
            _ifIuCmpge(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpgeConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpge, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpgeDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpge, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpgeConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmpge, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifIuCmpgeDataArr[i][0], ifIuCmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
            _ifIuCmple(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpleConst1_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 4, 1, &(ifIuCmpleDataArr[i][0]), 2,
        ...
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 1, &(ifIuCmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
            iuCompareConst(INT_PLACEHOLDER_1, ifIuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifIuCmpleConst3_TestCase%d", i + 1);
        iuCompareConst = (unsignedCompareSignatureCharII_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::ifiucmple, resolvedMethodName, _argTypesBinaryInt, TR::Int32, rc, 2, 2, &(ifIuCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifIuCmpleDataArr[i][0], ifIuCmpleDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
            _ifLuCmpeq(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpeqConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpeqDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpeqDataArr[i][0])));
        EXPECT_EQ(compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpeqDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpeqConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpeq, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpeqDataArr[i][1])));
        EXPECT_EQ(compareEQ(ifLuCmpeqDataArr[i][0], ifLuCmpeqDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
            _ifLuCmpne(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpneConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpneDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpneDataArr[i][0])));
        EXPECT_EQ(compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpneDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpneConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpne, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpneDataArr[i][1])));
        EXPECT_EQ(compareNE(ifLuCmpneDataArr[i][0], ifLuCmpneDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
            _ifLuCmpgt(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpgtConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpgtDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpgtDataArr[i][0])));
        EXPECT_EQ(compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpgtDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpgtConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpgt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpgtDataArr[i][1])));
        EXPECT_EQ(compareGT(ifLuCmpgtDataArr[i][0], ifLuCmpgtDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
            _ifLuCmplt(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpltConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpltDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpltDataArr[i][0])));
        EXPECT_EQ(compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpltDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpltConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmplt, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpltDataArr[i][1])));
        EXPECT_EQ(compareLT(ifLuCmpltDataArr[i][0], ifLuCmpltDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
            _ifLuCmpge(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpgeConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpgeDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpgeDataArr[i][0])));
        EXPECT_EQ(compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpgeDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpgeConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmpge, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpgeDataArr[i][1])));
        EXPECT_EQ(compareGE(ifLuCmpgeDataArr[i][0], ifLuCmpgeDataArr[i][1]),
    ...
    for (uint32_t i = 0; i < testCaseNum; ++i) {
        EXPECT_EQ(compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
            _ifLuCmple(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpleConst1_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 4, 1, &(ifLuCmpleDataArr[i][0]), 2,
        ...
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 1, &(ifLuCmpleDataArr[i][0])));
        EXPECT_EQ(compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
            luCompareConst(LONG_PLACEHOLDER_1, ifLuCmpleDataArr[i][1]));

        sprintf(resolvedMethodName, "ifLuCmpleConst3_TestCase%d", i + 1);
        luCompareConst = (unsignedCompareSignatureCharJJ_I_testMethodType*)(compileOpCodeMethod(_numberOfBinaryArgs,
            TR::iflucmple, resolvedMethodName, _argTypesBinaryLong, TR::Int32, rc, 2, 2, &(ifLuCmpleDataArr[i][1])));
        EXPECT_EQ(compareLE(ifLuCmpleDataArr[i][0], ifLuCmpleDataArr[i][1]),
...
void OpCodesTest::invokeTernaryTests()
{
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        EXPECT_EQ(ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
        ...
        iTernaryConst = (signatureCharIII_I_testMethodType*)(compileOpCodeMethod(_numberOfTernaryArgs, TR::iternary,
            resolvedMethodName, _argTypesTernaryInt, TR::Int32, rc, 6, 1, &iternaryChild1Arr[i], 2, &intArr[i][0], 3,
            &intArr[i][1]));
        EXPECT_EQ(ternary(iternaryChild1Arr[i], intArr[i][0], intArr[i][1]),
...
void OpCodesTest::invokeAddressTests()
{
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        aUnaryCons = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::aconst,
            resolvedMethodName, _argTypesUnaryAddress, TR::Address, rc, 2, 1, &(aUnaryDataArr[i])));
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        aUnaryCons = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::areturn,
            resolvedMethodName, _argTypesUnaryAddress, TR::Address, rc, 2, 1, &(aUnaryDataArr[i])));
        EXPECT_EQ(aUnaryDataArr[i], aUnaryCons(ADDRESS_PLACEHOLDER_1));
    }
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        aUnaryCons = (signatureCharL_L_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::astore,
            resolvedMethodName, _argTypesUnaryAddress, TR::Address, rc, 2, 1, &(aUnaryDataArr[i])));
        EXPECT_EQ(aUnaryDataArr[i], aUnaryCons(ADDRESS_PLACEHOLDER_1));
    }
    ...
    for (int32_t i = 0; i < testCaseNum; i++) {
        ...
        a2iConst = (signatureCharL_I_testMethodType*)(compileOpCodeMethod(_numberOfUnaryArgs, TR::a2i,
            resolvedMethodName, _argTypesUnaryAddress, TR::Int32, rc, 2, 1, &aUnaryDataArr[i]));
