...
public:
    ...
    uint8_t* compileOpCodeMethod(int32_t opCodeArgsNum, TR::ILOpCodes opCode, char* resolvedMethodName,
        TR::DataType* argTypes, TR::DataType returnType, int32_t& returnCode, uint16_t numArgs = 0, ...);

    uint8_t* compileDirectCallOpCodeMethod(int32_t opCodeArgsNum, TR::ILOpCodes opCodeCompilee, TR::ILOpCodes opCode,
        char* compileeResolvedMethodName, char* testResolvedMethodName, TR::DataType* argTypes, TR::DataType returnType,
        int32_t& returnCode);
