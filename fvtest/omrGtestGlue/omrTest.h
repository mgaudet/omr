 ...
 * automatically replace the function definitions.
 * So we explicitly include <ctype.h> and undefine the macros for gtest, after
 * gtest we then define back the macros.
 */
#include <ctype.h>
#undef toupper
#undef tolower
