...
static const Attribute deviceAttributes[] = {
    ...
    ATTRIBUTE_ENTRY(MAXIMUM_SURFACE1D_WIDTH, 0, 64 * 1024), ATTRIBUTE_ENTRY(MAXIMUM_SURFACE2D_HEIGHT, 0, 32 * 1024),
    ...
    ATTRIBUTE_ENTRY(MAXIMUM_SURFACE2D_WIDTH, 0, 64 * 1024), ATTRIBUTE_ENTRY(MAXIMUM_SURFACE3D_DEPTH, 0, 2 * 1024),
