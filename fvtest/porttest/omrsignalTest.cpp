...
TEST(PortSigTest, sig_test0)
{
    ...
    if (!omrsig_can_protect(OMRPORT_SIG_FLAG_MAY_CONTINUE_EXECUTION)) {
         ...
         */
        omrtty_printf("OMRPORT_SIG_FLAG_MAY_CONTINUE_EXECUTION is not supported if the default settings for "
 ...
 * OMRPORT_SIG_EXCEPTION_CONTINUE_SEARCH
