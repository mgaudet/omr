 ...
 * overriding
 * function has been called.  As a result this function simply replaces the port library function table slot tty_startup
 * with
 * a second overriding function.  The caller then calls @ref omrtty.c::omrtty_startup "omrtty_startup()" to verify they
 * have
