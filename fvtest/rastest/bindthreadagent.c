...
static omr_error_t
startTestChildThread(OMR_TI const* ti, OMR_VM* testVM,
                     OMR_VMThread* curVMThread, omrthread_t* childThread,
                     TestChildThreadData** childData)
{
...
static omr_error_t
waitForTestChildThread(OMR_TI const* ti, OMR_VM* testVM, omrthread_t childThead,
                       TestChildThreadData* childData)
{
