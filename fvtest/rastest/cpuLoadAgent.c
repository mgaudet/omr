 ...
 *invalid 	doNotExist 		OMR_ERROR_RETRY
 *	5 		multiple 	sufficient 		True 			valid 		valid
 *doNotExist 	doNotExist 		OMR_ERROR_RETRY
 *	6 		multiple 	sufficient 		True 			valid 		valid
 *invalid 	invalid 		OMR_ERROR_RETRY
 *	7 		multiple 	sufficient 		True 			valid 		invalid 	valid
 *valid 			OMR_ERROR_NONE
 *	8 		single 		sufficient 		True 			valid 		valid
 *valid 		valid 			OMR_ERROR_NONE
 *	9 		multiple 	insufficient 	True 			valid 		/
 */ 		doNotExist 		OMR_ERROR_NOT_AVAILABLE
 *	10 		multiple 	sufficient 		false 			valid 		/
 */ 		doNotExist 		OMR_ERROR_NOT_AVAILABLE
 *	11		/				/			/				NULL		/
 ...
 *4,
 *	case 4 is covered by call 1 to 2,	case 5 is covered by call 1, 		case 6 is covered by call 5 to
 *7,
