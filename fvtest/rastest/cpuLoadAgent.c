...
static omr_error_t
testProcessCpuLoad(OMR_VMThread* vmThread, OMR_TI const* ti,
                   omr_error_t expectedRc, BOOLEAN dummyPort, BOOLEAN checkRc)
{
  omr_error_t rc = OMR_ERROR_NONE;
...
static omr_error_t
testSystemCpuLoad(OMR_VMThread* vmThread, OMR_TI const* ti,
                  omr_error_t expectedRc, BOOLEAN dummyPort, BOOLEAN checkRc)
{
  omr_error_t rc = OMR_ERROR_NONE;
  omr_error_t testRc = OMR_ERROR_NONE;
