...
TEST_F(RASMethodDictionaryTest, Test0)
{
    ...
    OMRTEST_ASSERT_ERROR(
        OMR_ERROR_RETRY, ti->GetMethodDescriptions(vmthread, methodArray, numMethods,
                             (OMR_SampledMethodDescription*)desc, NULL, 0, &firstRetryMethod, &nameBytesRemaining));
...
TEST_F(RASMethodDictionaryTest, TestNegativeCasesForGetMethodDescriptions)
{
    ...
    OMRTEST_ASSERT_ERROR(
        OMR_ERROR_ILLEGAL_ARGUMENT, ti->GetMethodDescriptions(vmthread, methodArray, numMethods, NULL, nameBuffer,
                                        sizeof(nameBuffer), &firstRetryMethod, &nameBytesRemaining));
