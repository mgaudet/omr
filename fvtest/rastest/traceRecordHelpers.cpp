...
nextTracePoint(PerThreadWrapBuffer* wrapBuffer, const UtTraceRecord* record,
               TracePointIterator* iter)
{
 ...
 */
static TracePointIteratorState
parseTracePoint(const UtTraceRecord* record, uint32_t offset, uint32_t tpLength,
                TracePointIterator* iter)
{
  uint32_t traceId =
...
uint32_t
getU32FromTraceRecord(const UtTraceRecord* record, uint32_t offset,
                      int32_t isBigEndian)
{
  uint32_t ret = 0;
  uint8_t data[4];
...
uint64_t
getU64FromTraceRecord(const UtTraceRecord* record, uint32_t offset,
                      int32_t isBigEndian)
{
  uint64_t ret = 0;
  uint8_t data[8];
