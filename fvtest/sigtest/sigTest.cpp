...
#if defined(WIN32)
static omr_error_t
runTest(bool existingPrimary, bool existingSecondary, sighandler_t act,
        int signum, TestAction testFunc)
#else  /* defined(WIN32) */
static omr_error_t
runTest(bool existingPrimary, bool existingSecondary, struct sigaction* act,
        bool onStack, int signum, TestAction testFunc)
#endif /* defined(WIN32) */
{
  omr_error_t rc = OMR_ERROR_NONE;
 ...
 */
static omr_error_t
setupExistingHandlerConditions(bool existingPrimary, bool existingSecondary,
                               bool onStack, int signum)
{
  omr_error_t rc = OMR_ERROR_NONE;
...
#if !defined(WIN32)
static omr_error_t
runPrimarySigactionTest(int* expectedHandlerCalls, bool existingPrimary,
                        bool existingSecondary, int signum,
                        struct sigaction* act,
                        sighandler_t* expectedPreviousHandler,
                        sighandler_t* previousHandler)
...
static omr_error_t
runPrimarySignalTest(int* expectedHandlerCalls, bool existingPrimary,
                     bool existingSecondary, int signum, sighandler_t action,
                     sighandler_t* expectedPreviousHandler,
                     sighandler_t* previousHandler)
{
#if defined(WIN32)
...
static omr_error_t
runHandlerTest(int* expectedHandlerCalls, bool existingPrimary,
               bool existingSecondary, int signum,
               sighandler_t* expectedPreviousHandler,
               sighandler_t* previousHandler)
{
...
#if !defined(WIN32)
static omr_error_t
runSigactionTest(int* expectedHandlerCalls, bool existingPrimary,
                 bool existingSecondary, int signum, struct sigaction* act,
                 sighandler_t* expectedPreviousHandler,
                 sighandler_t* previousHandler)
{
  omr_error_t rc = OMR_ERROR_NONE;
...
static omr_error_t
runSignalTest(int* expectedHandlerCalls, bool existingPrimary,
              bool existingSecondary, int signum, sighandler_t action,
              sighandler_t* expectedPreviousHandler,
              sighandler_t* previousHandler)
{
...
static bool
checkPreviousHandler(int signum, TestAction testFunc,
                     sighandler_t expectedPreviousHandler,
                     sighandler_t previousHandler)
{
...
static omr_error_t
performTestAndCheck(int expectedHandlerCalls, bool onStackCondition,
                    bool testingSecondaryHandler, int signum)
{
  omr_error_t rc = OMR_ERROR_NONE;
