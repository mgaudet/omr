 ...
 */
void runCPUBurnToTestUserTimes(omrthread_process_time_t* processTimeArray, uintptr_t arrayLength)
{
    uintptr_t i = 0;
 ...
 * @param[out] processTimeArray	Pointer to the array of process times
 */
void runCPUBurnToTestSystemTimes(omrthread_process_time_t* processTimeArray, uintptr_t arrayLength)
{
    uintptr_t i = 0;
    intptr_t retValOfGetProcessTimes = 0;
