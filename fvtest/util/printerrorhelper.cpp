...
omr_error_t
omrTestPrintError(const char* funcCall, const omr_error_t rc,
...
omr_error_t
omrTestPrintUnexpectedIntRC(const char* funcCall, const intptr_t rc,
...
omr_error_t
omrTestPrintUnexpectedRC(const char* funcCall, const omr_error_t rc,
