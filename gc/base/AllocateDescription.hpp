...
protected:
    ...
    MM_MemorySubSpace::AllocationType _allocationType; /**< Describes what type of work the allocation layer needs to
                                                          perform to satisfy this request (TLH versus object allocate,
                                                          for example) */
