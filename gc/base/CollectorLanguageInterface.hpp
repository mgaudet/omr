...
public:
	...
	virtual void parallelGlobalGC_masterThreadGarbageCollect_afterGC(MM_EnvironmentBase *env,
																	 bool compactThisCycle) = 0;
	...
	virtual bool parallelGlobalGC_heapAddRange(MM_EnvironmentBase *env, MM_MemorySubSpace *subspace, uintptr_t size,
											   void *lowAddress, void *highAddress) = 0;
	virtual bool parallelGlobalGC_heapRemoveRange(MM_EnvironmentBase *env, MM_MemorySubSpace *subspace, uintptr_t size,
												  void *lowAddress, void *highAddress, void *lowValidAddress,
												  void *highValidAddress) = 0;
	virtual bool parallelGlobalGC_createHeapWalker(MM_EnvironmentBase *env, MM_GlobalCollector *collector,
	 ...
	 */
	virtual bool scavenger_internalGarbageCollect_shouldPercolateGarbageCollect(MM_EnvironmentBase *env,
	...
	virtual GC_ObjectScanner *scavenger_getObjectScanner(MM_EnvironmentStandard *env, omrobjectptr_t objectPtr,
														 void *allocSpace, uintptr_t flags) = 0;
	 ...
	 */
	virtual void scavenger_fixupDestroyedSlot(MM_EnvironmentBase *env, MM_ForwardedHeader *forwardedObject,
	 ...
	 */
	virtual void
	concurrentGC_processItem(MM_EnvironmentBase *env, omrobjectptr_t objectPtr)
	{
	}
	 ...
	 */
	virtual bool concurrentGC_forceConcurrentKickoff(MM_EnvironmentBase *env, uintptr_t gcCode,
	...
	virtual uintptr_t concurrentGC_collectRoots(MM_EnvironmentStandard *env, uintptr_t concurrentStatus,
												bool *collectedRoots, bool *paidTax) = 0;
	 ...
	 */
	virtual bool concurrentGC_startConcurrentScanning(MM_EnvironmentStandard *env, uintptr_t *bytesTraced,
	 ...
	 */
	virtual void concurrentGC_concurrentScanningStarted(MM_EnvironmentStandard *env,
	 ...
	 */
	void writeBarrierStore(OMR_VMThread *omrThread, omrobjectptr_t parentObject, fomrobject_t *parentSlot,
