...
protected:
     ...
     *
     * OMRTODO move this out of configuration as we should not have to "configure" NUMA.  The only reason this is here
     * is
     * because ConfigurationIncrementalGenerational.hpp will disable physical NUMA if it would create too many ACs and
     * ideal AC calculation
