...
public:
	...
	MM_ConfigurationOptions()
		: MM_BaseNonVirtual(), _gcPolicy(gc_policy_undefined), _forceOptionScavenge(false),
		  _forceOptionConcurrentMark(false), _forceOptionConcurrentSweep(false), _forceOptionLargeObjectArea(false)
	{
...
public:
	virtual void prepareParameters(OMR_VM *omrVM, uintptr_t minimumSpaceSize, uintptr_t minimumNewSpaceSize,
								   ...
								   uintptr_t maximumTenureSpaceSize, uintptr_t memoryMax, uintptr_t tenureFlags,
	...
	MM_Configuration(MM_EnvironmentBase *env, MM_ConfigurationLanguageInterface *configurationLanguageInterface,
					 MM_AlignmentType alignmentType)
		: MM_BaseVirtual(), _configurationLanguageInterface(configurationLanguageInterface),
...
private:
	...
	MMINLINE uintptr_t
	calculatePowerOfTwoShift(MM_EnvironmentBase *env, uintptr_t value)
	{
