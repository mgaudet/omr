...
private:
protected:
	MM_ConfigurationLanguageInterface() : MM_BaseVirtual() { _typeId = __FUNCTION__; }
...
public:
	...
	virtual bool
	initializeSizeClasses(MM_EnvironmentBase *env)
	{
		return true;
	}
	...
	virtual uintptr_t
	getEnvPoolNumElements(void)
	{
		return 0;
	}
	virtual uintptr_t
	getEnvPoolFlags(void)
	{
		return 0;
	}
