...
public:
	 ...
	 */
	virtual void printAllocationContextStats(MM_EnvironmentBase *env, uintptr_t eventNum,
	 ...
	 */
	virtual MM_AllocationContext *
	getAllocationContextByIndex(uintptr_t index)
	{
...
protected:
	...
	MM_GlobalAllocationManager(MM_EnvironmentBase *env)
		: MM_BaseVirtual(), _extensions(env->getExtensions()), _managedAllocationContextCount(0),
		  _nextAllocationContext(0), _managedAllocationContexts(NULL)
	{
