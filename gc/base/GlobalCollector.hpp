...
public:
	...
	virtual bool
	condYield(MM_EnvironmentBase *env, uint64_t timeSlackNanoSec)
	{
		return false;
	}

	virtual bool
	shouldYield(MM_EnvironmentBase *env)
	{
		return false;
	}
	...
	MM_GlobalCollector(MM_EnvironmentBase *env, MM_CollectorLanguageInterface *cli) : MM_Collector(cli)
	{
