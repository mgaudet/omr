...
#define J9MODRON_HEAPMAP_SELECT_BIT_SHIFT(compress) (J9MODRON_HEAPMAP_BIT_SHIFT)
	...
	MM_HeapMap(MM_EnvironmentBase *env, uintptr_t maxHeapSize, bool useCompressedHeapMap = false)
		: MM_BaseVirtual(), _useCompressedHeapMap(useCompressedHeapMap),
		  ...
		  _heapMapBitShift(J9MODRON_HEAPMAP_SELECT_BIT_SHIFT(useCompressedHeapMap)), _extensions(env->getExtensions()),
		  _heapBase(NULL), _heapTop(NULL), _heapMapMemoryHandle(), _heapMapBaseDelta(0), _heapMapBits(NULL),
