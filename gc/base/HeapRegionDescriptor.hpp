...
public:
    enum RegionType {
        ...
        = 10, /**< Represents regions that have a BumpPointer MemoryPool and an accurate mark set in
                 extensions->previousMarkMap */
        LAST_REGION_TYPE /**< This dummy type is sed later as a size of an array for stats of region counts */
    };
    uintptr_t
        _regionsInSpan; /**< most likely a temporary piece of data which, along with _nextInSet, builds a freelist
