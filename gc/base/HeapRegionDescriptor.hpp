...
public:
	 ...
	 */
	MMINLINE void
	setRegionProperty(RegionProperties property)
	{
	 ...
	 */
	MMINLINE void
	clearRegionProperty(RegionProperties property)
	{
		_regionProperties &= ~property;
	}
	 ...
	 */
	MMINLINE bool
	regionPropertyIsSet(RegionProperties property)
	{
	 ...
	 */
	virtual bool
	allocateSupportingResources(MM_EnvironmentBase *env)
	{
		return true;
	}

	virtual bool
	check(MM_EnvironmentBase *env)
	{
		return true;
	}
	...
	static void destructor(MM_EnvironmentBase *env, MM_HeapRegionManager *regionManager,
