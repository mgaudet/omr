...
public:
	static MM_HeapVirtualMemory *newInstance(MM_EnvironmentBase *env, uintptr_t heapAlignment, uintptr_t size,
	...
	MM_HeapVirtualMemory(MM_EnvironmentBase *env, uintptr_t heapAlignment, uintptr_t maximumMemorySize,
						 MM_HeapRegionManager *regionManager)
		: MM_Heap(env, maximumMemorySize, regionManager), _vmemHandle(), _heapAlignment(heapAlignment),
		  _physicalArena(NULL)
	{
