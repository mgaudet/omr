...
public:
    ...
    MMINLINE void scanObject(MM_EnvironmentBase* env, omrobjectptr_t objectPtr,
    ...
    MMINLINE uintptr_t scanObjectWithSize(MM_EnvironmentBase* env, omrobjectptr_t objectPtr,
