...
bool MM_MemoryPoolAddressOrderedList::initialize(MM_EnvironmentBase* env)
{
     ...
     * yet.
     * Tenure SubSpace for Gencon will set _largeObjectCollectorAllocateStats to _largeObjectAllocateStats (we append
     * collector stats to mutator stats)
...
/* TODO 108399 Determine whether this is still necessary (OMR_SCAVENGER_DEBUG is defined in Scqavenger.cpp and is not
 * accessible here) */
