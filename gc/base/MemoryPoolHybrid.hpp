...
private:
	 ...
	 */
	uintptr_t coalesceExpandRangeWithLastFreeEntry(MM_HeapLinkedFreeHeader *lastFreeEntry, J9ModronFreeList *freelist,
	 ...
	 */
	uintptr_t coalesceNewFreeEntryWithLastFreeEntry(MM_HeapLinkedFreeHeader *lastFreeEntry, J9ModronFreeList *freelist,
													MM_HeapLinkedFreeHeader *newFreeEntry);
...
public:
	static MM_MemoryPoolHybrid *newInstance(MM_EnvironmentBase *env, uintptr_t minimumFreeEntrySize,
											uintptr_t maxSplit);
