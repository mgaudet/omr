...
public:
	...
	MM_MemoryPoolLargeObjects(MM_EnvironmentBase *env, MM_MemoryPoolAddressOrderedListBase *largeObjectArea,
							  MM_MemoryPoolAddressOrderedListBase *smallObjectArea)
		: MM_MemoryPool(env, 0), _omrVM(env->getOmrVM()), _currentOldAreaSize(0), _currentLOABase(NULL),
		  _memoryPoolSmallObjects(smallObjectArea), _memoryPoolLargeObjects(largeObjectArea), _loaSize(0), _soaSize(0),
		  _currentLOARatio(_extensions->largeObjectAreaInitialRatio), _soaObjectSizeLWM(UDATA_MAX), _expandedLOA(0),
