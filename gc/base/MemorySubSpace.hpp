...
public:
     ...
     * collection to reclaim resources.  The given "allocationType"
     * variable is consulted to determine which allocation routine is to be called, after the collection, but before
     * giving up exclusive to ensure that the failing allocation
     ...
     * request between GC attempt stages.  It decodes
     ...
     * address of the allocate.  In the case of TLH,
