 ...
 * minimum
 * quotas, etc.
 * The generational receiver determines which direction to push the request so that the opposing sibbling has a chance
 * to
 * expand.
    ...
    uintptr_t contractAlignment)
{
    ...
    assume0(expandSize == MM_Math::roundToFloor(MM_GCExtensions::getExtensions(env)->heapAlignment,
