...
private:
	...
	getInitialSizeNew()
	{
		return _initialSizeNew;
	};
	MMINLINE uintptr_t
	getInitialSizeOld()
	{
		return _initialSizeOld;
	};
	MMINLINE uintptr_t
	getMinimumSizeNew()
	{
		return _minimumSizeNew;
	};
	MMINLINE uintptr_t
	getMinimumSizeOld()
	{
		return _minimumSizeOld;
	};
	MMINLINE uintptr_t
	getMaximumSizeNew()
	{
		return _maximumSizeNew;
	};
	MMINLINE uintptr_t
	getMaximumSizeOld()
	{
		return _maximumSizeOld;
	};

	MMINLINE MM_MemorySubSpace *
	getMemorySubSpaceNew()
	{
		return _memorySubSpaceNew;
	};
	MMINLINE MM_MemorySubSpace *
	getMemorySubSpaceOld()
	{
		return _memorySubSpaceOld;
	};
	MMINLINE void
	setMemorySubSpaceNew(MM_MemorySubSpace *memorySubSpace)
	{
		_memorySubSpaceNew = memorySubSpace;
	};
	MMINLINE void
	setMemorySubSpaceOld(MM_MemorySubSpace *memorySubSpace)
	{
...
public:
	...
	getName()
	{
		return MEMORY_SUBSPACE_NAME_GENERATIONAL;
	}
	virtual const char *
	getDescription()
	{
	...
	MM_MemorySubSpaceGenerational(MM_EnvironmentBase *env, MM_MemorySubSpace *memorySubSpaceNew,
								  ...
								  uintptr_t minimumSizeNew, uintptr_t initialSizeNew, uintptr_t maximumSizeNew,
								  uintptr_t minimumSizeOld, uintptr_t initialSizeOld, uintptr_t maximumSizeOld,
		...
		: MM_MemorySubSpace(env, NULL, NULL, usesGlobalCollector, minimumSize, initialSizeNew + initialSizeOld,
		  ...
		  _initialSizeNew(initialSizeNew), _minimumSizeNew(minimumSizeNew), _maximumSizeNew(maximumSizeNew),
		  _initialSizeOld(initialSizeOld), _minimumSizeOld(minimumSizeOld), _maximumSizeOld(maximumSizeOld),
		  _memorySubSpaceNew(memorySubSpaceNew), _memorySubSpaceOld(memorySubSpaceOld)
	{
