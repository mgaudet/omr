		...
		if (NULL == result) {
			if (shouldCollectOnFailure) {
				if (allocDescription->shouldCollectAndClimb()) {
					result = _parent->allocationRequestFailed(env, allocDescription, ALLOCATION_TYPE_TLH,
 ...
 */
void *
MM_MemorySubSpaceGeneric::collectorAllocate(MM_EnvironmentBase *env, MM_Collector *requestCollector,
 ...
 */
uintptr_t
MM_MemorySubSpaceGeneric::collectorExpand(MM_EnvironmentBase *env, MM_Collector *requestCollector,
										  MM_AllocateDescription *allocDescription)
{
									  ...
									  uintptr_t maximumSize, uintptr_t memoryType, uint32_t objectFlags)
{
	...
	memorySubSpace = (MM_MemorySubSpaceGeneric *)env->getForge()->allocate(
		sizeof(MM_MemorySubSpaceGeneric), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
 ...
 */
bool
MM_MemorySubSpaceGeneric::expanded(MM_EnvironmentBase *env, MM_PhysicalSubArena *subArena,
 ...
 */
void *
MM_MemorySubSpaceGeneric::removeExistingMemory(MM_EnvironmentBase *env, MM_PhysicalSubArena *subArena, uintptr_t size,
