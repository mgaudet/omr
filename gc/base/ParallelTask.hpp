...
public:
	...
	MM_ParallelTask(MM_EnvironmentBase *env, MM_Dispatcher *dispatcher)
		: MM_Task(env, dispatcher), _synchronized(false), _syncPointUniqueId(NULL), _syncPointWorkUnitIndex(0),
		  _totalThreadCount(0), _threadCount(0), _workUnitIndex(0), _synchronizeIndex(0), _synchronizeCount(0),
