...
public:
	...
	virtual bool attachSubArena(MM_EnvironmentBase *env, MM_PhysicalSubArena *subArena, uintptr_t size,
	...
	MM_PhysicalArena(MM_EnvironmentBase *env, MM_Heap *heap)
		: _nextArena(NULL), _previousArena(NULL), _lowAddress(NULL), _highAddress(NULL), _memorySpace(NULL),
		  _heap(heap), _attached(false)
	{
		_typeId = __FUNCTION__;
	}

	MM_PhysicalArena(MM_EnvironmentBase *env, MM_MemorySpace *memorySpace)
		: _nextArena(NULL), _previousArena(NULL), _lowAddress(NULL), _highAddress(NULL), _memorySpace(memorySpace),
		  _heap(NULL), _attached(false)
	{
		_typeId = __FUNCTION__;
	}
	...
	MMINLINE void
	setNextArena(MM_PhysicalArena *arena)
	{
		_nextArena = arena;
	}
	MMINLINE MM_PhysicalArena *
	getPreviousArena()
	{
		return _previousArena;
	}
	MMINLINE void
	setPreviousArena(MM_PhysicalArena *arena)
	{
