...
public:
	...
	MMINLINE void
	setSubSpace(MM_MemorySubSpace *subSpace)
	{
		_subSpace = subSpace;
	}

	MMINLINE void
	setParent(MM_PhysicalArena *parent)
	{
		_parent = parent;
	}
	...
	MM_PhysicalSubArena(MM_Heap *heap) : MM_BaseVirtual(), _parent(NULL), _subSpace(NULL), _heap(heap), _resizable(true)
	{
