...
/* Free list candidate has been found - attach it to the free list */
     ...
     * can occur if a leading
     * free entry is pushed back from a projection from the previous sweep chunk.  A leading free candidate that spans
     * the entire chunk in this
