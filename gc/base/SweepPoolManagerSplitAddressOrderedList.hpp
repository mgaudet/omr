...
private:
	MMINLINE void
	setSplitCandidateInformation(MM_ParallelSweepChunk *chunk, MM_SweepPoolState *sweepState,
...
public:
	 ...
	 */
	MM_SweepPoolManagerSplitAddressOrderedList(MM_EnvironmentBase *env) : MM_SweepPoolManagerAddressOrderedListBase(env)
	{
