...
MM_SweepPoolState *
MM_SweepPoolState::newInstance(MM_EnvironmentBase *env, J9Pool *pool, omrthread_monitor_t mutex,
...
MM_SweepPoolState::MM_SweepPoolState(MM_MemoryPool *memoryPool)
	: _memoryPool(memoryPool), _connectPreviousFreeEntry(NULL), _connectPreviousFreeEntrySize(0),
	  _connectPreviousPreviousFreeEntry(NULL), _connectPreviousChunk(NULL), _sweepFreeBytes(0), _sweepFreeHoles(0),
