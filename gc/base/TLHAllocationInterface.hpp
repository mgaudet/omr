...
public:
	...
	virtual void
	enableCachedAllocations(MM_EnvironmentBase *env)
	{
		_cachedAllocationsEnabled = true;
	}
	virtual void
	disableCachedAllocations(MM_EnvironmentBase *env)
	{
...
private:
	...
	MM_TLHAllocationInterface(MM_EnvironmentBase *env)
		: MM_ObjectAllocationInterface(env), _owningEnv(env), _tlhAllocationSupport(env, true),
#if defined(OMR_GC_NON_ZERO_TLH)
