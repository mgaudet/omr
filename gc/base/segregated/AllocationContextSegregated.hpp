...
private:
    ...
    MM_HeapRegionQueue*
        _perContextArrayletFullRegions; /**< Per-context Arraylet regions that have been allocated into during this GC
                                           cycle. */
    MM_HeapRegionQueue*
        _perContextLargeFullRegions; /**< Per-context Large object regions that have been allocated into during this GC
                                        cycle. */
