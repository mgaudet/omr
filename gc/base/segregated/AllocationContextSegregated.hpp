...
class MM_AllocationContextSegregated : public MM_AllocationContext {
 ...
 private:
  ...
  MM_HeapRegionQueue* _perContextSmallFullRegions[OMR_SIZECLASSES_NUM_SMALL +
                                                  1]; /**< Per-context Regions
                                                         that have been
                                                         allocated into during
                                                         this GC cycle. */
  MM_HeapRegionQueue* _perContextArrayletFullRegions; /**< Per-context Arraylet
 ...
 public:
   ...
   * field to 1.
   * Since another thread may be trying to do this at the same time, it must be
   * done with
   * an atomic operation.
