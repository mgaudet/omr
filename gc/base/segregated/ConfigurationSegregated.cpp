    ...
    MM_EnvironmentBase* env, MM_Heap* heap, MM_InitializationParameters* parameters)
{
    ...
    if (NULL == (memoryPool = MM_MemoryPoolSegregated::newInstance(env, regionPool, MINIMUM_FREE_CHUNK_SIZE,
 ...
 */
MM_ObjectAllocationInterface* MM_ConfigurationSegregated::createObjectAllocationInterface(MM_EnvironmentBase* env)
{
 ...
 */
bool MM_ConfigurationSegregated::aquireAllocationContext(MM_EnvironmentBase* env)
{
 ...
 */
MM_SegregatedAllocationTracker* MM_ConfigurationSegregated::createAllocationTracker(MM_EnvironmentBase* env)
{
...
uintptr_t MM_ConfigurationSegregated::internalGetDefaultRegionSize(MM_EnvironmentBase* env)
{
    return SEGREGATED_REGION_SIZE_BYTES;
}

uintptr_t MM_ConfigurationSegregated::internalGetDefaultArrayletLeafSize(MM_EnvironmentBase* env)
{
    return SEGREGATED_ARRAYLET_LEAF_SIZE_BYTES;
}

uintptr_t MM_ConfigurationSegregated::internalGetWriteBarrierType(MM_EnvironmentBase* env)
{
    return _configurationLanguageInterface->internalGetWriteBarrierType(env);
}

uintptr_t MM_ConfigurationSegregated::internalGetAllocationType(MM_EnvironmentBase* env)
{
