...
class MM_ConfigurationSegregated : public MM_Configuration {
 ...
 public:
  ...
  virtual MM_ObjectAllocationInterface *createObjectAllocationInterface(
      MM_EnvironmentBase *env);
  virtual MM_SegregatedAllocationTracker *createAllocationTracker(
      MM_EnvironmentBase *env);
  ...
  MM_ConfigurationSegregated(
      MM_EnvironmentBase *env,
      MM_ConfigurationLanguageInterface *configurationLanguageInterface)
      : MM_Configuration(env, configurationLanguageInterface,
                         mm_regionAlignment) {
