...
protected:
	...
	MM_GlobalAllocationManagerSegregated(MM_EnvironmentBase *env) : MM_GlobalAllocationManager(env), _regionPool(NULL)
	{
	 ...
	 */
	virtual MM_AllocationContextSegregated *createAllocationContext(MM_EnvironmentBase *env,
...
public:
	static MM_GlobalAllocationManagerSegregated *newInstance(MM_EnvironmentBase *env,
															 MM_RegionPoolSegregated *regionPool);
