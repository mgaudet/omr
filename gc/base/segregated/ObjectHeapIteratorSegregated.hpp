...
public:
	...
	GC_ObjectHeapIteratorSegregated(MM_GCExtensionsBase *extensions, omrobjectptr_t base, omrobjectptr_t top,
									MM_HeapRegionDescriptor::RegionType type, uintptr_t cellSize,
									bool includeDeadObjects, bool skipFirstObject)
		: _scanPtr(base), _scanPtrTop(top), _type(type), _cellSize(cellSize), _includeDeadObjects(includeDeadObjects),
		  _pastFirstObject(skipFirstObject), _smallPtrTop(NULL), _extensions(extensions)
	{
