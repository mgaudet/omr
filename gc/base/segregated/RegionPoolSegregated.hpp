...
class MM_RegionPoolSegregated : public MM_RegionPool {
  ...
  */
   ...
   * (dead) objects.
   */
  MM_HeapRegionQueue* _arrayletSweepRegions; /**< Arraylet regions that are
                                                waiting to be swept during this
                                                GC cycle. */
   ...
   * (dead) objects.
   */
  MM_HeapRegionQueue* _largeSweepRegions; /**< Large object regions that are
                                             waiting to be swept during this GC
                                             cycle. */
