...
public:
	static MM_SegregatedAllocationTracker *newInstance(MM_EnvironmentBase *env, volatile uintptr_t *globalBytesInUse,
	...
	intptr_t
	getUnflushedBytesAllocated(MM_EnvironmentBase *env)
	{
