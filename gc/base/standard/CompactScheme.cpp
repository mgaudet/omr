                              ...
                              MM_MarkingScheme* markingScheme)
{
  ...
  compactScheme = (MM_CompactScheme*)env->getForge()->allocate(
    sizeof(MM_CompactScheme), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
  if (compactScheme) {
...
void
MM_CompactScheme::compact(MM_EnvironmentBase* envBase, bool rebuildMarkBits,
                          bool aggressive)
{
...
MM_CompactScheme::addFreeEntry(MM_EnvironmentStandard* env,
                               ...
                               MM_CompactMemoryPoolState* poolState,
                               void* currentFreeBase, uintptr_t currentFreeSize)
{
  void* highAddr;
...
MM_CompactScheme::doCompact(MM_EnvironmentStandard* env,
                            ...
                            omrobjectptr_t& deadObject, uintptr_t& nobjects,
                            uintptr_t& nbytes, bool evacuate)
{
...
MM_CompactScheme::changeSubAreaAction(MM_EnvironmentBase* env,
                                      SubAreaEntry* entry, uintptr_t newAction)
{
