 ...
 */
void
MM_ConcurrentCardTable::tlhRefreshed(J9HookInterface** hook, uintptr_t eventNum,
 ...
 */
void
MM_ConcurrentCardTable::tlhCleared(J9HookInterface** hook, uintptr_t eventNum,
                                   void* eventData, void* userData)
{
 ...
 */
bool
MM_ConcurrentCardTable::heapAddRange(MM_EnvironmentStandard* env,
                                     MM_MemorySubSpace* subspace,
                                     uintptr_t size, void* lowAddress,
                                     void* highAddress, bool clearNewCards)
{
 ...
 */
bool
MM_ConcurrentCardTable::heapRemoveRange(MM_EnvironmentStandard* env,
                                        MM_MemorySubSpace* subspace,
                                        uintptr_t size, void* lowAddress,
                                        void* highAddress,
  ...
  if (NULL != _heapAlloc) {
    ...
    if (result) {
      if (subspace->isConcurrentCollectable()) {
         ...
         * actions required */
        result =
          freeTLHMarkMapEntriesForHeapRange(env, size, lowAddress, highAddress,
 ...
 */
void
MM_ConcurrentCardTable::dirtyCardsInRange(MM_EnvironmentStandard* env,
                                          void* heapBase, void* heapTop)
{
 ...
 */
MMINLINE void
MM_ConcurrentCardTable::releaseExclusiveCardTableAccess(
  MM_EnvironmentStandard* env)
{
 ...
 */
bool
MM_ConcurrentCardTable::cleanCards(MM_EnvironmentStandard* env, bool isMutator,
 ...
 */
bool
MM_ConcurrentCardTable::cleanSingleCard(MM_EnvironmentStandard* env, Card* card,
 ...
 */
bool
MM_ConcurrentCardTable::finalCleanCards(MM_EnvironmentStandard* env,
 ...
 */
void
MM_ConcurrentCardTable::processTLHMarkBits(MM_EnvironmentStandard* env,
                                           MM_MemorySubSpace* subspace,
 ...
 */
bool
MM_ConcurrentCardTable::isObjectInActiveTLH(MM_EnvironmentStandard* env,
 ...
 */
bool
MM_ConcurrentCardTable::isCardInActiveTLH(MM_EnvironmentStandard* env,
                                          Card* card)
{
  uintptr_t markIndex, markBit;
  bool active;
 ...
 */
bool
MM_ConcurrentCardTable::isObjectInDirtyCardNoCheck(MM_EnvironmentStandard* env,
                                                   omrobjectptr_t object)
{
  bool dirty;
 ...
 */
bool
MM_ConcurrentCardTable::isObjectInUncleanedDirtyCard(
 ...
 */
bool
MM_ConcurrentCardTable::isObjectInDirtyCard(MM_EnvironmentStandard* env,
                                            omrobjectptr_t object)
{
  bool dirty = false;
 ...
 */
Card*
MM_ConcurrentCardTable::getNextDirtyCard(MM_EnvironmentStandard* env,
                                         Card cardMask,
 ...
 */
MMINLINE void
MM_ConcurrentCardTable::setTLHMarkBits(MM_EnvironmentStandard* env,
                                       uintptr_t slotIndex, uintptr_t slotBits)
{
 ...
 */
MMINLINE void
MM_ConcurrentCardTable::clearTLHMarkBits(MM_EnvironmentStandard* env,
                                         uintptr_t slotIndex,
                                         uintptr_t slotBits)
{
  volatile uintptr_t* tlhMarkMapSlot = (uintptr_t*)&(_tlhMarkBits[slotIndex]);
 ...
 */
bool
MM_ConcurrentCardTable::cardHasMarkedObjects(MM_EnvironmentStandard* env,
                                             Card* card)
{
  bool hasMarked;
