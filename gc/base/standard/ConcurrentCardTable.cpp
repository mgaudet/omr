 ...
 */
uintptr_t MM_ConcurrentCardTable::calculateTLHMarkMapSize(MM_EnvironmentStandard* env, uintptr_t cardTableSize)
{
    uintptr_t size;
 ...
 */
bool MM_ConcurrentCardTable::allocateCardTableEntriesForHeapRange(MM_EnvironmentStandard* env,
    MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress, bool clearNewCards)
{
 ...
 */
bool MM_ConcurrentCardTable::freeCardTableEntriesForHeapRange(MM_EnvironmentStandard* env, uintptr_t size,
...
bool MM_ConcurrentCardTable::allocateTLHMarkMapEntriesForHeapRange(
    MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress)
{
    bool commited = true;
    ...
    if (_extensions->isFvtestForceConcurrentTLHMarkMapCommitFailure()) {
        ...
        if (NULL != _tlhMarkBits) {
             ...
             * another range).
             * as we dont want to commit a slot we have previously commited andn more importantly we dont want to clear
             * and existing
             * slot. */
 ...
 * @param highAddress The top address (non-inclusive) of the memory added to the heap
 */
bool MM_ConcurrentCardTable::freeTLHMarkMapEntriesForHeapRange(MM_EnvironmentStandard* env, uintptr_t size,
    void* lowAddress, void* highAddress, void* lowValidAddress, void* highValidAddress)
{
 ...
 */
bool MM_ConcurrentCardTable::heapAddRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size,
 ...
 *
 */
bool MM_ConcurrentCardTable::heapRemoveRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size,
    void* lowAddress, void* highAddress, void* lowValidAddress, void* highValidAddress)
{
    bool result = true;
    /*
    ...
    MM_EnvironmentBase* env, MM_Heap* heap, MM_MarkingScheme* markingScheme, MM_ConcurrentGC* collector)
{
    MM_ConcurrentCardTable* cardTable = (MM_ConcurrentCardTable*)env->getForge()->allocate(
        sizeof(MM_ConcurrentCardTable), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (NULL != cardTable) {
 ...
 */
bool MM_ConcurrentCardTable::initialize(MM_EnvironmentBase* envModron, MM_Heap* heap)
{
 ...
 */
...
#endif /* OMR_GC_MODRON_SCAVENGER */
        {
            ...
            (*mmPrivateHooks)
                ->J9HookRegister(mmPrivateHooks, J9HOOK_MM_PRIVATE_CACHE_REFRESHED, tlhRefreshed, (void*)this);
        }
 ...
 */
uintptr_t MM_ConcurrentCardTable::cardBytesForHeapRange(MM_EnvironmentStandard* env, void* heapBase, void* heapTop)
{
 ...
 *
 */
void MM_ConcurrentCardTable::clearNonConcurrentCards(MM_EnvironmentStandard* env)
{
 ...
 */
void MM_ConcurrentCardTable::dirtyCardsInRange(MM_EnvironmentStandard* env, void* heapBase, void* heapTop)
{
 ...
 *
 */
void MM_ConcurrentCardTable::initializeCardCleaning(MM_EnvironmentStandard* env)
{
 ...
 *
 */
void MM_ConcurrentCardTable::prepareCardsForCleaning(MM_EnvironmentStandard* env)
{
    void* firstFree;
 ...
 */
void MM_ConcurrentCardTable::reportCardCleanPass2Start(MM_EnvironmentStandard* env)
{
...
MMINLINE bool MM_ConcurrentCardTable::getExclusiveCardTableAccess(
    MM_EnvironmentStandard* env, CardCleanPhase currentPhase, bool threadAtSafePoint)
{
 ...
 */
MMINLINE void MM_ConcurrentCardTable::releaseExclusiveCardTableAccess(MM_EnvironmentStandard* env)
{
...
bool MM_ConcurrentCardTable::cleanSingleCard(
    MM_EnvironmentStandard* env, Card* card, uintptr_t bytesToClean, uintptr_t* totalBytesCleaned)
{
    ...
    while (NULL != (objectPtr = markedObjectIterator.nextObject())) {
        ...
        */
        ...
        sizeDone += _markingScheme->scanObjectWithSize(
            env, objectPtr, MM_CollectorLanguageInterface::SCAN_REASON_DIRTY_CARD, (sizeToDo - sizeDone));
    }
 ...
 */
void MM_ConcurrentCardTable::initializeFinalCardCleaning(MM_EnvironmentStandard* env)
{
    if (_cardTableReconfigured) {
        determineCleaningRanges(env);
    } else {
 ...
 *
 */
bool MM_ConcurrentCardTable::finalCleanCards(MM_EnvironmentStandard* env, uintptr_t* bytesTraced)
{
    ...
    for (; (nextDirtyCard = getNextDirtyCard(env, _finalCardCleanMask, false)) != NULL;) {
        ...
        while (NULL != (objectPtr = markedObjectIterator.nextObject())) {
            ...
            traceCount += _markingScheme->scanObjectWithSize(
                env, objectPtr, MM_CollectorLanguageInterface::SCAN_REASON_DIRTY_CARD, SCAN_MAX);
        }
...
void MM_ConcurrentCardTable::processTLHMarkBits(
    MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, void* tlhBase, void* tlhTop, BitMapAction action)
{
    ...
    if (base < top) {
         ...
         */
        if ((CLEAR == action)
            && !(_extensions->collectorLanguageInterface->concurrentGC_getConcurrentStats()
 ...
 */
bool MM_ConcurrentCardTable::isObjectInActiveTLH(MM_EnvironmentStandard* env, omrobjectptr_t object)
{
 ...
 */
bool MM_ConcurrentCardTable::isCardInActiveTLH(MM_EnvironmentStandard* env, Card* card)
{
    uintptr_t markIndex, markBit;
    bool active;
 ...
 */
bool MM_ConcurrentCardTable::isObjectInDirtyCardNoCheck(MM_EnvironmentStandard* env, omrobjectptr_t object)
{
    bool dirty;
 ...
 */
bool MM_ConcurrentCardTable::isObjectInUncleanedDirtyCard(MM_EnvironmentStandard* env, omrobjectptr_t object)
{
 ...
 * @return TRUE if reference is to an object within a dirty card; FALSE otherwise
 */
bool MM_ConcurrentCardTable::isObjectInDirtyCard(MM_EnvironmentStandard* env, omrobjectptr_t object)
{
    bool dirty = false;
 ...
 *
 */
void MM_ConcurrentCardTable::determineCleaningRanges(MM_EnvironmentStandard* env)
{
    bool initDone = false;
 ...
 */
Card* MM_ConcurrentCardTable::getNextDirtyCard(MM_EnvironmentStandard* env, Card cardMask, bool concurrentCardClean)
{
 ...
 *
 */
bool MM_ConcurrentCardTable::cardHasMarkedObjects(MM_EnvironmentStandard* env, Card* card)
{
    bool hasMarked;
