 ...
 */
bool MM_ConcurrentCardTable::allocateCardTableEntriesForHeapRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress, bool clearNewCards)
{
 ...
 * @param highAddress The top address (non-inclusive) of the memory added to the heap
 */
bool MM_ConcurrentCardTable::allocateTLHMarkMapEntriesForHeapRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress)
{
    bool commited = true;
 ...
 */
bool MM_ConcurrentCardTable::heapAddRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress, bool clearNewCards)
{
 ...
 *
 */
bool MM_ConcurrentCardTable::heapRemoveRange(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, uintptr_t size, void* lowAddress, void* highAddress, void* lowValidAddress, void* highValidAddress)
{
    bool result = true;
    /*
 ...
 */
bool MM_ConcurrentCardTable::cleanCards(MM_EnvironmentStandard* env, bool isMutator, uintptr_t sizeToDo, uintptr_t* sizeDone, bool threadAtSafePoint)
{
    Card* nextDirtyCard;
 ...
 */
bool MM_ConcurrentCardTable::cleanSingleCard(MM_EnvironmentStandard* env, Card* card, uintptr_t bytesToClean, uintptr_t* totalBytesCleaned)
{
 ...
 *
 */
void MM_ConcurrentCardTable::processTLHMarkBits(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, void* tlhBase, void* tlhTop, BitMapAction action)
{
