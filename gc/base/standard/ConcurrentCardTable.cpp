...
uintptr_t MM_ConcurrentCardTable::calculateTLHMarkMapSize(
    MM_EnvironmentStandard *env, uintptr_t cardTableSize) {
  uintptr_t size;
 ...
 */
uintptr_t MM_ConcurrentCardTable::cardBytesForHeapRange(
    MM_EnvironmentStandard *env, void *heapBase, void *heapTop) {
