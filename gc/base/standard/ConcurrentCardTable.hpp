...
class MM_ConcurrentCardTable : public MM_CardTable {
 ...
 private:
  ...
  void setTLHMarkBits(MM_EnvironmentStandard* env,
                      uintptr_t slotIndex,
                      uintptr_t slotBits);
  void clearTLHMarkBits(MM_EnvironmentStandard* env,
                        uintptr_t slotIndex,
                        uintptr_t slotBits);
 ...
 protected:
  ...
  bool cleanSingleCard(MM_EnvironmentStandard* env,
                       Card* card,
                       uintptr_t bytesToClean,
                       uintptr_t* totalBytesCleaned);
  Card* getNextDirtyCard(MM_EnvironmentStandard* env,
                         Card cardMask,
 ...
 public:
   ...
   */
  bool heapAddRange(MM_EnvironmentStandard* env,
                    MM_MemorySubSpace* subspace,
                    uintptr_t size,
                    void* lowAddress,
                    void* highAddress,
   ...
   */
  bool heapRemoveRange(MM_EnvironmentStandard* env,
                       MM_MemorySubSpace* subspace,
                       uintptr_t size,
                       void* lowAddress,
                       void* highAddress,
   ...
   */
  uintptr_t cardBytesForHeapRange(MM_EnvironmentStandard* env,
                                  void* heapBase,
                                  void* heapTop);
  /**
   ...
   */
  void dirtyCardsInRange(MM_EnvironmentStandard* env,
                         void* heapBase,
                         void* heapTop);
  /**
   ...
   */
  bool cleanCards(MM_EnvironmentStandard* env,
                  bool isMutator,
                  uintptr_t sizeToDo,
                  uintptr_t* sizeDone,
                  bool threadAtSafePoint);
