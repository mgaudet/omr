 ...
 */
void
MM_ConcurrentCardTableForWC::prepareCardsForCleaning(
  MM_EnvironmentStandard* env)
{
 ...
 */
uintptr_t
MM_ConcurrentCardTableForWC::countCardsInRange(MM_EnvironmentStandard* env,
                                               Card* chunkStart, Card* chunkEnd)
{
 ...
 */
void
MM_ConcurrentCardTableForWC::prepareCardTableChunk(MM_EnvironmentStandard* env,
                                                   Card* chunkStart,
                                                   Card* chunkEnd,
                                                   CardAction action)
{
