 ...
 *
 */
void MM_ConcurrentCardTableForWC::prepareCardTable(MM_EnvironmentStandard* env)
{
 ...
 */
void MM_ConcurrentCardTableForWC::prepareCardsForCleaning(MM_EnvironmentStandard* env)
{
    ...
    MM_EnvironmentStandard* env, CardCleanPhase currentPhase, bool threadAtSafePoint)
{
    ...
    while (!acquired) {
         ...
         * collection cycle or the _cardCleanPhase is not as it was when we requested exclusive access then nothing to
         * do
 ...
 */
MMINLINE void MM_ConcurrentCardTableForWC::releaseExclusiveCardTableAccess(MM_EnvironmentStandard* env)
{
 ...
 */
uintptr_t MM_ConcurrentCardTableForWC::countCardsInRange(MM_EnvironmentStandard* env, Card* chunkStart, Card* chunkEnd)
{
...
void MM_ConcurrentCardTableForWC::prepareCardTableChunk(
    MM_EnvironmentStandard* env, Card* chunkStart, Card* chunkEnd, CardAction action)
{
 ...
 */
void MM_ConcurrentCardTableForWC::initializeFinalCardCleaning(MM_EnvironmentStandard* env)
{
