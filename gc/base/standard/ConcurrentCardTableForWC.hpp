...
class MM_ConcurrentCardTableForWC : public MM_ConcurrentCardTable {
  ...
  uintptr_t countCardsInRange(MM_EnvironmentStandard* env,
                              Card* rangeStart,
                              Card* rangeEnd);
 ...
 public:
  ...
  void prepareCardTableChunk(MM_EnvironmentStandard* env,
                             Card* chunkStart,
                             Card* chunkEnd,
                             CardAction action);
   ...
   */
  MMINLINE virtual bool isObjectInUncleanedDirtyCard(
