...
public:
	...
	isObjectInUncleanedDirtyCard(MM_EnvironmentStandard *env, omrobjectptr_t object)
	{
		return false;
	}
	...
	MM_ConcurrentCardTableForWC(MM_EnvironmentBase *env, MM_MarkingScheme *markingScheme, MM_ConcurrentGC *collector)
		: MM_ConcurrentCardTable(env, markingScheme, collector), _cardTablePreparedForCleaning(false), _callback(NULL)
	{
