 ...
 */
MM_ConcurrentGC* MM_ConcurrentGC::newInstance(
 ...
 */
bool MM_ConcurrentGC::getInitRange(MM_EnvironmentStandard* env,
                                   void** from,
                                   void** to,
                                   InitType* type,
 ...
 */
uintptr_t MM_ConcurrentGC::doConcurrentInitialization(
    MM_EnvironmentStandard* env,
    uintptr_t initToDo) {
