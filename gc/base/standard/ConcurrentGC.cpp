 ...
 */
void MM_ConcurrentGC::hookObjectRemovedFromRememberedSet(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
 ...
 */
void MM_ConcurrentGC::hookCardCleanPass2Start(J9HookInterface** hook, uintptr_t eventNum, void* eventData, void* userData)
{
 ...
 */
bool MM_ConcurrentGC::getInitRange(MM_EnvironmentStandard* env, void** from, void** to, InitType* type, bool* concurrentCollectable)
{
    uint32_t i;
 ...
 * @note This is a potential GC point.
 */
void MM_ConcurrentGC::concurrentMark(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, MM_AllocateDescription* allocDescription)
{
 ...
 */
void MM_ConcurrentGC::concurrentSweep(MM_EnvironmentStandard* env, MM_MemorySubSpace* subspace, MM_AllocateDescription* allocDescription)
{
...
/* Determine how much "taxable" free space remains to be allocated. */
    ...
    if (!isGcOccurred) {
        ...
        if (((MM_ConcurrentCardTable*)_cardTable)->isCardCleaningComplete() && _markingScheme->getWorkPackets()->tracingExhausted() && _cli->concurrentGC_isConcurrentScanningComplete(env)) {
