...
class MM_ConcurrentGC : public MM_ParallelGlobalGC {
 ...
 private:
  ...
  bool getInitRange(MM_EnvironmentStandard* env,
                    void** from,
                    void** to,
                    InitType* type,
...
#if defined(OMR_GC_CONCURRENT_SWEEP)
  void concurrentSweep(MM_EnvironmentStandard* env,
                       MM_MemorySubSpace* subspace,
                       MM_AllocateDescription* allocDescription);
 ...
 protected:
  ...
  void concurrentMark(MM_EnvironmentStandard* env,
                      MM_MemorySubSpace* subspace,
                      MM_AllocateDescription* allocDescription);
 ...
 public:
  ...
  static void signalThreadsToDirtyCardsAsyncEventHandler(
