...
void MM_ConcurrentSafepointCallback::requestCallback(MM_EnvironmentStandard* env)
{
...
void MM_ConcurrentSafepointCallback::cancelCallback(MM_EnvironmentStandard* env)
{
