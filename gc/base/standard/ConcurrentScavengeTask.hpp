...
public:
    ...
    virtual void setup(MM_EnvironmentBase* env) { MM_ParallelScavengeTask::setup(env); }
    virtual void run(MM_EnvironmentBase* env);
    virtual void cleanup(MM_EnvironmentBase* env) { MM_ParallelScavengeTask::cleanup(env); }
    ...
    MM_ConcurrentScavengeTask(MM_EnvironmentBase* env, MM_Dispatcher* dispatcher, MM_Scavenger* scavenger,
        ConcurrentAction action, uintptr_t bytesToScan, volatile bool* forceExit, MM_CycleState* cycleState)
