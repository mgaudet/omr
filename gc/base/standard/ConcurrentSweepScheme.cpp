...
private:
  ...
  MM_ParallelSweepChunk*
    _currentSweepChunk; /**< Next chunk to concurrent sweep in the given memory
                           pool */
  MM_ParallelSweepChunk*
  ...
  MM_EnvironmentBase* env)
{
  ...
  TRIGGER_J9HOOK_MM_PRIVATE_CONCURRENTLY_COMPLETED_SWEEP_PHASE(
    ...
    omrtime_hires_clock(), J9HOOK_MM_PRIVATE_CONCURRENTLY_COMPLETED_SWEEP_PHASE,
...
MM_ConcurrentSweepScheme::sweepPool(MM_EnvironmentBase* envModron,
                                    MM_MemoryPool* memoryPool, UDATA chunkTax)
{
  UDATA taxPaid = 0;
  MM_ConcurrentSweepPoolState* sweepState =
    (MM_ConcurrentSweepPoolState*)getPoolState(memoryPool);
