								  ...
								  MM_ConfigurationLanguageInterface *configurationLanguageInterface)
{
	...
	configuration = (MM_ConfigurationFlat *)env->getForge()->allocate(sizeof(MM_ConfigurationFlat),
...
MM_MemorySpace *
MM_ConfigurationFlat::createDefaultMemorySpace(MM_EnvironmentBase *env, MM_Heap *heap,
