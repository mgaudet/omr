...
J9Pool* MM_ConfigurationStandard::createEnvironmentPool(MM_EnvironmentBase* env)
{
    ...
    return pool_new(sizeof(MM_EnvironmentStandard), numberElements, sizeof(uint64_t), poolFlags, OMR_GET_CALLSITE(),
...
uintptr_t MM_ConfigurationStandard::internalGetDefaultRegionSize(MM_EnvironmentBase* env)
{
    return STANDARD_REGION_SIZE_BYTES;
}

uintptr_t MM_ConfigurationStandard::internalGetDefaultArrayletLeafSize(MM_EnvironmentBase* env)
{
    return STANDARD_ARRAYLET_LEAF_SIZE_BYTES;
}

uintptr_t MM_ConfigurationStandard::internalGetWriteBarrierType(MM_EnvironmentBase* env)
{
    return _configurationLanguageInterface->internalGetWriteBarrierType(env);
}

uintptr_t MM_ConfigurationStandard::internalGetAllocationType(MM_EnvironmentBase* env)
{
