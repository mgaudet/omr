...
protected:
public:
  GC_ObjectScannerState _objectScannerState; /**< Space reserved for
  ...
  omrobjectptr_t* _arraySplitRememberedSlot; /**< A pointer to the remembered
                                                set slot a split array came from
                                                if applicable. */
