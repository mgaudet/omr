...
MM_HeapRegionDescriptorStandard::MM_HeapRegionDescriptorStandard(MM_EnvironmentStandard *env, void *lowAddress,
																 void *highAddress)
...
MM_HeapRegionDescriptorStandard::initialize(MM_EnvironmentBase *envBase, MM_HeapRegionManager *regionManager)
{
	...
	MM_CollectorLanguageInterface *cli =
		MM_GCExtensionsBase::getExtensions(env->getOmrVM())->collectorLanguageInterface;
...
void
MM_HeapRegionDescriptorStandard::destructor(MM_EnvironmentBase *env, MM_HeapRegionManager *regionManager,
