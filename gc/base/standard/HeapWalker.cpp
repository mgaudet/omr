 ...
 */
static void
heapWalkerObjectFieldSlotDo(OMR_VM* omrVM, omrobjectptr_t object,
 ...
 */
static void
heapWalkerObjectSlotDo(OMR_VM* omrVM, omrobjectptr_t object,
                       ...
                       void* userData)
{
  ...
  omrobjectptr_t clazzObject =
    MM_GCExtensionsBase::getExtensions(omrVM)
      ->collectorLanguageInterface->heapWalker_heapWalkerObjectSlotDo(object);
