...
protected:
    ...
    GC_IndexableObjectScanner(
        MM_EnvironmentStandard* env, GC_IndexableObjectScanner* objectScanner, uintptr_t splitAmount)
...
public:
     ...
     */
    virtual GC_IndexableObjectScanner* splitTo(MM_EnvironmentStandard* env, void* allocSpace, uintptr_t splitAmount)
        = 0;
};
