...
protected:
	 ...
	 */
	GC_IndexableObjectScanner(MM_EnvironmentStandard *env, omrobjectptr_t arrayPtr, fomrobject_t *basePtr,
	 ...
	 */
	GC_IndexableObjectScanner(MM_EnvironmentStandard *env, GC_IndexableObjectScanner *objectScanner,
		...
		: GC_ObjectScanner(env, objectScanner->_parentObjectPtr, objectScanner->_endPtr,
		  ...
		  _endPtr(objectScanner->_endPtr + splitAmount), _basePtr(objectScanner->_basePtr),
...
public:
	 ...
	 */
	virtual GC_IndexableObjectScanner *splitTo(MM_EnvironmentStandard *env, void *allocSpace,
