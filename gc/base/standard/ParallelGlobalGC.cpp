...
static void
globalGCHookSysStart(J9HookInterface** hook, uintptr_t eventNum,
                     void* eventData, void* userData)
{
...
static void
globalGCHookSysEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData,
                   void* userData)
{
...
static void
globalGCHookAFCycleStart(J9HookInterface** hook, uintptr_t eventNum,
                         void* eventData, void* userData)
{
...
static void
globalGCHookAFCycleEnd(J9HookInterface** hook, uintptr_t eventNum,
                       void* eventData, void* userData)
{
...
static void
globalGCHookCCStart(J9HookInterface** hook, uintptr_t eventNum, void* eventData,
                    void* userData)
{
...
static void
globalGCHookCCEnd(J9HookInterface** hook, uintptr_t eventNum, void* eventData,
                  void* userData)
{
...
MM_ParallelGlobalGC::reportGCEnd(MM_EnvironmentBase* env)
{
  ...
  TRIGGER_J9HOOK_MM_OMR_GLOBAL_GC_END(
    ...
    (_extensions->largeObjectArea ? 1 : 0), approximateLoaActiveFreeMemorySize,
    loaActiveMemorySize,
