...
MM_ParallelSweepScheme::newInstance(MM_EnvironmentBase *env)
{
	...
	sweepScheme = (MM_ParallelSweepScheme *)env->getForge()->allocate(sizeof(MM_ParallelSweepScheme),
 ...
 */
bool
MM_ParallelSweepScheme::heapAddRange(MM_EnvironmentBase *env, MM_MemorySubSpace *subspace, uintptr_t size,
...
MMINLINE void
MM_ParallelSweepScheme::sweepMarkMapTail(uintptr_t *markMapCurrent, uintptr_t *markMapChunkTop,
...
uintptr_t
MM_ParallelSweepScheme::performSamplingCalculations(MM_ParallelSweepChunk *sweepChunk, uintptr_t *markMapCurrent,
													uintptr_t *heapSlotFreeCurrent)
{
	...
	uintptr_t *startSearchAt = (uintptr_t *)MM_Math::roundToFloor(J9MODRON_HEAP_SLOTS_PER_MARK_SLOT * sizeof(uintptr_t),
																  (uintptr_t)endOfPrevObject);
	uintptr_t *endSearchAt = (uintptr_t *)MM_Math::roundToCeiling(J9MODRON_HEAP_SLOTS_PER_MARK_SLOT * sizeof(uintptr_t),
 ...
 */
bool
MM_ParallelSweepScheme::sweepForMinimumSize(MM_EnvironmentBase *env, MM_MemorySubSpace *baseMemorySubSpace,
