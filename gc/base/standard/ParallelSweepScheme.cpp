...
MM_ParallelSweepScheme* MM_ParallelSweepScheme::newInstance(MM_EnvironmentBase* env)
{
    ...
    sweepScheme = (MM_ParallelSweepScheme*)env->getForge()->allocate(
        sizeof(MM_ParallelSweepScheme), MM_AllocationCategory::FIXED, OMR_GET_CALLSITE());
    if (sweepScheme) {
...
bool MM_ParallelSweepScheme::sweepChunk(MM_EnvironmentBase* env, MM_ParallelSweepChunk* sweepChunk)
{
    ...
    markMapChunkBase
        = (uintptr_t*)(_currentSweepBits + (MM_Math::roundToFloor(J9MODRON_HEAP_SLOTS_PER_MARK_SLOT * sizeof(uintptr_t),
