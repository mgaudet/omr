...
public:
	 ...
	 */
	uintptr_t performSamplingCalculations(MM_ParallelSweepChunk *sweepChunk, uintptr_t *markMapCurrent,
	...
	MM_ParallelSweepScheme(MM_EnvironmentBase *env)
		: MM_BaseVirtual(), _chunksPrepared(0), _extensions(env->getExtensions()), _dispatcher(_extensions->dispatcher),
		  _currentMarkMap(NULL), _currentSweepBits(NULL), _heapBase(NULL), _sweepHeapSectioning(NULL),
