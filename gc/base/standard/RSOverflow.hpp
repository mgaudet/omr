...
private:
	...
	bool
		_searchMode; /**< mode switch: initialized in Modify mode, after first nextObject call is switched to Search mode */
...
public:
	 ...
	 */
	MMINLINE void
	addObject(omrobjectptr_t objectPtr)
	{
		if (!_searchMode) {
	 ...
	 */
	MMINLINE
	MM_RSOverflow(MM_EnvironmentBase *env)
