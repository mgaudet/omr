 ...
 ********************************************************************/
bool MM_Scavenger::walkObjectSlotsForRSO(MM_EnvironmentStandard *env,
                                         omrobjectptr_t objectPtr) {
 ...
 */
MMINLINE bool MM_Scavenger::isWorkAvailableInCache(
...
bool MM_Scavenger::percolateGarbageCollect(
    MM_EnvironmentBase *envModron, MM_MemorySubSpace *subSpace,
...
void MM_Scavenger::mutatorFinalReleaseCopyCaches(
