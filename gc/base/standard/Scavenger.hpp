...
private:
  ...
  bool
    _isRememberedSetInOverflowAtTheBeginning; /**< Cached RS Overflow flag at
                                                 the beginning of the scavenge
                                                 */
  ...
  volatile uintptr_t
    _doneIndex; /**< sequence ID of completeScan loop, which we may have a few
                   during one GC cycle */
...
private:
  ...
  MMINLINE bool scavengeObjectSlots(MM_EnvironmentStandard* env,
                                    ...
                                    omrobjectptr_t* rememberedSetSlot);
  MMINLINE void incrementalScavengeObjectSlots(
   ...
   */
  bool walkObjectSlotsForRSO(MM_EnvironmentStandard* env,
                             omrobjectptr_t objectPtr);
  ...
  MMINLINE MM_CopyScanCacheStandard* getNextScanCacheFromList(
    MM_EnvironmentStandard* env);
  MMINLINE MM_CopyScanCacheStandard* getSurvivorCopyCache(
    MM_EnvironmentStandard* env);
  MMINLINE MM_CopyScanCacheStandard* getDeferredCopyCache(
    MM_EnvironmentStandard* env);
  ...
  MMINLINE MM_ScavengerHotFieldStats* getHotFieldStats(
    MM_EnvironmentStandard* env)
  {
