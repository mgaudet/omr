...
#define Assert_GC_true_with_message(__env__, __condition, __message,           \
  ...
  do {                                                                         \
    if (!(__condition)) {                                                      \
      ...
      __env__->getPortLibrary()->str_printf(                                   \
          __env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE,  \
          __message, __parameter);                                             \
      Trc_MM_AssertionWithMessage_outputMessage(                               \
          __env__->getLanguageVMThread(), __buffer);                           \
      __env__->getPortLibrary()->tty_printf(__env__->getPortLibrary(), "%s",   \
                                            __buffer);                         \
...
#define Assert_GC_true_with_message2(__env__, __condition, __message,          \
  ...
  do {                                                                         \
    if (!(__condition)) {                                                      \
      ...
      __env__->getPortLibrary()->str_printf(                                   \
          __env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE,  \
          __message, __parameter1, __parameter2);                              \
      Trc_MM_AssertionWithMessage_outputMessage(                               \
          __env__->getLanguageVMThread(), __buffer);                           \
      __env__->getPortLibrary()->tty_printf(__env__->getPortLibrary(), "%s",   \
                                            __buffer);                         \
...
#define Assert_GC_true_with_message3(__env__, __condition, __message,          \
  ...
  do {                                                                         \
    if (!(__condition)) {                                                      \
      ...
      __env__->getPortLibrary()->str_printf(                                   \
          __env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE,  \
          __message, __parameter1, __parameter2, __parameter3);                \
      Trc_MM_AssertionWithMessage_outputMessage(                               \
          __env__->getLanguageVMThread(), __buffer);                           \
      __env__->getPortLibrary()->tty_printf(__env__->getPortLibrary(), "%s",   \
                                            __buffer);                         \
...
#define Assert_GC_true_with_message4(__env__, __condition, __message,          \
  ...
  do {                                                                         \
    if (!(__condition)) {                                                      \
      ...
      __env__->getPortLibrary()->str_printf(                                   \
          __env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE,  \
          __message, __parameter1, __parameter2, __parameter3, __parameter4);  \
      Trc_MM_AssertionWithMessage_outputMessage(                               \
          __env__->getLanguageVMThread(), __buffer);                           \
      __env__->getPortLibrary()->tty_printf(__env__->getPortLibrary(), "%s",   \
                                            __buffer);                         \
