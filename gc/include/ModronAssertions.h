    ...
    do {                                                                                                               \
        if (!(__condition)) {                                                                                          \
            ...
            __env__->getPortLibrary()->str_printf(                                                                     \
                __env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE, __message, __parameter);           \
...
#define Assert_GC_true_with_message2(__env__, __condition, __message, __parameter1, __parameter2)                      \
    do {                                                                                                               \
        if (!(__condition)) {                                                                                          \
            char __buffer[ASSERTION_MESSAGE_BUFFER_SIZE];                                                              \
            __env__->getPortLibrary()->str_printf(__env__->getPortLibrary(), __buffer, ASSERTION_MESSAGE_BUFFER_SIZE,  \
