...
enum {
  CARD_SIZE_SHIFT =
      9, /* base2 log of CARD_SIZE, used to change division into shift */
  CARD_SIZE = 512 /* size of a "card" of the heap - in a sense:  the granule of
                     deferred mark map update */
};
...
#define J9VMSTATE_GC_CONCURRENT_SWEEP_FIND_MINIMUM_SIZE_FREE \
  (J9VMSTATE_GC | 0x000C)
