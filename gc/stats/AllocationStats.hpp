...
public:
	...
	uintptr_t
	nontlhBytesAllocated()
	{
		return _allocationBytes;
	}
#endif
	...
	MM_AllocationStats()
		:
		  ...
		  _tlhRefreshCountReused(0), _tlhAllocatedFresh(0), _tlhAllocatedReused(0), _tlhRequestedBytes(0),
		  _tlhDiscardedBytes(0), _tlhMaxAbandonedListSize(0),
#endif /* defined (OMR_GC_THREAD_LOCAL_HEAP) */
#if defined(OMR_GC_ARRAYLETS)
		  _arrayletLeafAllocationCount(0), _arrayletLeafAllocationBytes(0),
#endif
		  _allocationCount(0), _allocationBytes(0), _ownableSynchronizerObjectCount(0), _discardedBytes(0),
