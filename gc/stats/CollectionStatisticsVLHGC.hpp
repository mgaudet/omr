...
public:
	...
	MM_CollectionStatisticsVLHGC()
		: MM_CollectionStatistics(), _incrementDescription(0), _incrementCount(0), _edenFreeHeapSize(0),
		  _edenHeapSize(0), _arrayletReferenceObjects(0), _arrayletReferenceLeaves(0), _largestReferenceArraylet(0),
		  _arrayletPrimitiveObjects(0), _arrayletPrimitiveLeaves(0), _largestPrimitiveArraylet(0),
		  _arrayletUnknownObjects(0), _arrayletUnknownLeaves(0), _rememberedSetCount(0), _rememberedSetBytesFree(0),
		  _rememberedSetBytesTotal(0), _rememberedSetOverflowedRegionCount(0), _rememberedSetStableRegionCount(0),
		  _rememberedSetBeingRebuiltRegionCount(0), _numaNodes(0), _commonNumaNodeBytes(0), _localNumaNodeBytes(0),
