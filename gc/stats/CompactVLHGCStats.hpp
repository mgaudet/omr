...
public:
    ...
    uint64_t
        _regionCompactDataInitStartTime; /**< hires start time to initialize compact data in the region table (one
                                            thread only) */
    ...
    uint64_t
        _rememberedSetClearingStartTime; /**< hires start time to clear all RSCL from-references for the regions in the
                                            compact set */
    uint64_t
        _rememberedSetClearingEndTime; /**< hires end time to clear all RSCL from-references for the regions in the
                                          compact set */
    ...
    uint64_t
        _reportMoveEventsEndTime; /**< hires end time to report all object move events (master thread only and only if
                                     OBJECT_RENAME is hooked) */
    uint64_t
        _fixupExternalPacketsStartTime; /**< hires start time to fixup work packets for an active GMP (only done if GMP
                                           is active) */
    uint64_t
        _fixupExternalPacketsEndTime; /**< hires end time to fixup work packets for an active GMP (only done if GMP is
                                         active) */
    uint64_t
    ...
    uint64_t
        _rebuildNextMarkMapStartTime; /**< hires start time to rebuild the next mark map from the next work packets
