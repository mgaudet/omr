...
public:
	 ...
	 */
	MMINLINE void
	switchMode(uintptr_t oldMode, uintptr_t newMode)
	{
	...
	MM_ConcurrentSweepStats()
		: MM_Base(), _mode(concurrentsweep_mode_off), _totalChunkCount(0), _totalChunkSweptCount(0),
		  _minimumFreeEntryBytesSwept(0), _minimumFreeEntryBytesConnected(0), _concurrentCompleteSweepTimeStart(0),
		  _concurrentCompleteSweepTimeEnd(0), _concurrentCompleteSweepBytesSwept(0), _completeSweepPhaseTimeStart(0),
		  _completeSweepPhaseTimeEnd(0), _completeSweepPhaseBytesSwept(0), _completeConnectPhaseTimeStart(0),
		  _completeConnectPhaseTimeEnd(0), _completeConnectPhaseBytesConnected(0)
	{
	}
};
