...
public:
    ...
    uint64_t
        _completeStallTime; /**< The time, in hi-res ticks, the thread spent stalled waiting for all other threads to
                               complete working */
    ...
    uintptr_t
        _objectsScannedFromOverflowedRegion; /**< In depth-first copy-forward, the number of objects scanned by this
                                                thread which it found in an overflowed region (while handling work
                                                packet overflow) */
    ...
    uintptr_t
        _objectsScannedFromDepthStack; /**< In depth-first copy-forward, the number of objects scanned by this thread
                                          which it found on its depth stack (that is, one it resumed as it was going
                                          "up" the tree) */
