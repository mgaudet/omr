...
public:
	...
	MMINLINE void
	addToAbortStallTime(uint64_t startTime, uint64_t endTime)
	{
		_abortStallCount += 1;
	...
	MMINLINE void
	addToMarkStallTime(uint64_t startTime, uint64_t endTime)
	{
		_markStallCount += 1;
	...
	MMINLINE void
	addToInterRegionRememberedSetStallTime(uint64_t startTime, uint64_t endTime)
	{
		_irrsStallCount += 1;
	 ...
	 */
	void
	merge(MM_CopyForwardStatsCore *stats)
	{
	...
	MM_CopyForwardStatsCore()
		: _gcCount(UDATA_MAX), _startTime(0), _endTime(0), _freeMemoryBefore(0), _totalMemoryBefore(0),
		  _freeMemoryAfter(0), _totalMemoryAfter(0), _copyObjectsTotal(0), _copyBytesTotal(0),
		  _copyDiscardBytesTotal(0), _scanObjectsTotal(0), _scanBytesTotal(0), _copyObjectsEden(0), _copyBytesEden(0),
		  _copyDiscardBytesEden(0), _scanObjectsEden(0), _scanBytesEden(0), _copyObjectsNonEden(0),
		  _copyBytesNonEden(0), _copyDiscardBytesNonEden(0), _scanObjectsNonEden(0), _scanBytesNonEden(0),
		  _objectsCardClean(0), _bytesCardClean(0), _scanCacheOverflow(false), _aborted(false),
		  _edenEvacuateRegionCount(0), _nonEdenEvacuateRegionCount(0), _edenSurvivorRegionCount(0),
		  _nonEdenSurvivorRegionCount(0)
#if defined(J9MODRON_TGC_PARALLEL_STATISTICS)
		  ,
		  _releaseScanListCount(0), _acquireFreeListCount(0), _releaseFreeListCount(0), _acquireScanListCount(0),
		  _syncStallCount(0), _abortStallCount(0), _markStallCount(0), _irrsStallCount(0), _workStallCount(0),
		  _completeStallCount(0), _syncStallTime(0), _abortStallTime(0), _markStallTime(0), _irrsStallTime(0),
		  _workStallTime(0), _completeStallTime(0), _copiedArraysSplit(0), _markedArraysSplit(0)
#endif /* J9MODRON_TGC_PARALLEL_STATISTICS */
		  ,
		  _heapExpandedBytes(0), _heapExpandedCount(0), _heapExpandedTime(0), _externalCompactBytes(0),
		  _objectsScannedFromWorkPackets(0), _objectsScannedFromOverflowedRegion(0), _objectsScannedFromNextInChain(0),
		  _objectsScannedFromDepthStack(0), _objectsScannedFromRoot(0)
	{
	}
};
