...
public:
	...
	MM_ExcessiveGCStats()
		: MM_Base(), gcCount(0), startGCTimeStamp(0), endGCTimeStamp(0), freeMemorySizeBefore(0),
		  freeMemorySizeAfter(0), newGCToUserTimeRatio(0.0), avgGCToUserTimeRatio(0.0), totalGCTime(0),
