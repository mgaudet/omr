...
MM_LargeObjectAllocateStats::newInstance(
  ...
  uintptr_t tlhMinimumSize, uintptr_t factorVeryLargeEntryPool)
{
  ...
  if (NULL != largeObjectAllocateStats) {
    ...
    if (!largeObjectAllocateStats->initialize(
          env, maxAllocateSizes, largeObjectThreshold, veryLargeObjectThreshold,
...
bool
MM_LargeObjectAllocateStats::initialize(
  MM_EnvironmentBase* env, uint16_t maxAllocateSizes,
  uintptr_t largeObjectThreshold, uintptr_t veryLargeObjectThreshold,
  float sizeClassRatio, uintptr_t maxHeapSize, uintptr_t tlhMaximumSize,
  uintptr_t tlhMinimumSize, uintptr_t factorVeryLargeEntryPool)
...
MM_LargeObjectAllocateStats::estimateFragmentation(MM_EnvironmentBase* env)
{
    ...
    for (uintptr_t i = 0;
      ...
      if (objectPercent >= ignoreObjectPercentThreshold) {
        ...
        Trc_MM_LargeObjectAllocateStats_estimateFragmentation_stride(
          ...
          currentFreeMemory >> 20, objectSize, objectAllocBytesPerObjectStride,
  ...
  Trc_MM_LargeObjectAllocateStats_estimateFragmentation_exit(
    env->getLanguageVMThread(), remainingFreeMemory, remainingFreeMemory >> 20,
    unsatisfiedAlloc, unsatisfiedAlloc >> 20);
