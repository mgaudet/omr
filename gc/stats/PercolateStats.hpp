...
public:
	MMINLINE void
	setLastPercolateReason(PercolateReason reason)
	{
		_lastPercolateReason = reason;
	}
	MMINLINE PercolateReason
	getLastPercolateReason()
	{
		return _lastPercolateReason;
	}
	MMINLINE void
	resetLastPercolateReason()
	{
		_lastPercolateReason = NONE_SET;
	}

	void
	incrementScavengesSincePercolate()
	{
		_scavengesSincePercolate++;
	}
	void
	clearScavengesSincePercolate()
	{
		_scavengesSincePercolate = 0;
	}
	uintptr_t
	getScavengesSincePercolate()
	{
		return _scavengesSincePercolate;
	}
