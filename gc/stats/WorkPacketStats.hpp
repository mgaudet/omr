...
public:
	...
	void
	merge(MM_WorkPacketStats *statsToMerge)
	{
	...
	MMINLINE void
	setSTWWorkStackOverflowOccured(bool overflow)
	{
	...
	MMINLINE void
	setSTWWorkpacketCountAtOverflow(uintptr_t workpacketCount)
	{
	...
	MM_WorkPacketStats()
		: _gcCount(UDATA_MAX), workPacketsAcquired(0), workPacketsReleased(0), workPacketsExchanged(0),
		  _workStallCount(0), _completeStallCount(0), _workStallTime(0), _completeStallTime(0),
		  _stwWorkStackOverflowCount(0), _stwWorkStackOverflowOccured(false), _stwWorkpacketCountAtOverflow(0)
	{
	}
