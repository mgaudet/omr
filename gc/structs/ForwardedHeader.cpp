 ...
 */
omrobjectptr_t MM_ForwardedHeader::setForwardedObject(omrobjectptr_t destinationObjectPtr)
{
...
/* Forwarded tag should be in low bits of the pointer and at the same time be in forwarding slot */
    ...
    uintptr_t newValue = (((uintptr_t)destinationObjectPtr | _forwardedTag) << 32)
