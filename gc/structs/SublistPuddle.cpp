 ...
 */
bool
MM_SublistPuddle::initialize(MM_EnvironmentBase* env, uintptr_t size,
 ...
 * updating the fragment with
 * the details of the new range.  The allocate is a simple bump pointer allocate
 * that is contended.
 ...
 * that the sourcePuddle will not have all of its elements copied.  The routine
 * guarantees that both
 * puddles will be in the correct state (with internal list pointers correctly
