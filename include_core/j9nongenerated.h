...
typedef struct J9AVLTree {
	intptr_t (*insertionComparator)(struct J9AVLTree *tree, struct J9AVLTreeNode *insertNode,
	...
	uintptr_t (*performNodeAction)(struct J9AVLTree *tree, struct J9AVLTreeNode *node, uintptr_t action,
								   void *userData);
	uintptr_t flags;
