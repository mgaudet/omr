...
#define J9HASH_TABLE_AVL_TREE_TAG_BIT                                                                                  \
	((uintptr_t)0x00000001) /*!< Bit to indicate that hastable slot contains a pointer to an AVL tree */
...
typedef uintptr_t (*J9HashTableEqualFn)(void *leftEntry, void *rightEntry,
...
typedef void (*J9HashTablePrintFn)(OMRPortLibrary *portLibrary, void *entry,
								   void *userData);				   /* Forward struct declaration */
