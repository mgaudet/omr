...
#define EsOpenForMapping                                                                                               \
	0x100						  /* Required for WinCE for file memory mapping, ignored on other platforms. WINCE is not supported so this flag is obsolete now. */
...
typedef struct J9MemoryNodeDetail {
	...
	J9MemoryState
		memoryPolicy; /**< Whether the memory on this node is preferred, allowed, or denied use by this process under the current NUMA policy */
	uintptr_t
		computationalResourcesAvailable; /**< The number of computational resources on this node which are currently available for use under the current NUMA policy */
} J9MemoryNodeDetail;
...
typedef uintptr_t (*omrsig_handler_fn)(struct OMRPortLibrary *portLib, uint32_t gpType, void *gpInfo,
									   void *handler_arg);
...
typedef struct OMRPortLibrary {
	...
	int32_t (*error_set_last_error_with_message)(struct OMRPortLibrary *portLibrary, int32_t portableCode,
	...
	uint64_t (*time_hires_delta)(struct OMRPortLibrary *portLibrary, uint64_t startTime, uint64_t endTime,
	...
	intptr_t (*sysinfo_get_env)(struct OMRPortLibrary *portLibrary, const char *envVar, char *infoString,
								uintptr_t bufSize);
	...
	intptr_t (*sysinfo_get_load_average)(struct OMRPortLibrary *portLibrary,
	...
	int32_t (*sysinfo_env_iterator_next)(struct OMRPortLibrary *portLibrary, struct J9SysinfoEnvIteratorState *state,
	...
	int32_t (*file_stat_filesystem)(struct OMRPortLibrary *portLibrary, const char *path, uint32_t flags,
									struct J9FileStatFilesystem *buf);
	/** see @ref omrfile_blockingasync.c::omrfile_blockingasync_open "omrfile_blockingasync_open"*/
	intptr_t (*file_blockingasync_open)(struct OMRPortLibrary *portLibrary, const char *path, int32_t flags,
										int32_t mode);
	...
	intptr_t (*file_blockingasync_write)(struct OMRPortLibrary *portLibrary, intptr_t fd, const void *buf,
										 intptr_t nbytes);
	...
	OMRFileStream *(*filestream_open)(struct OMRPortLibrary *portLibrary, const char *path, int32_t flags,
									  int32_t mode);
	...
	intptr_t (*filestream_write)(struct OMRPortLibrary *portLibrary, OMRFileStream *fileStream, const void *buf,
								 intptr_t nbytes);
	...
	void (*filestream_vprintf)(struct OMRPortLibrary *portLibrary, OMRFileStream *fileStream, const char *format,
							   va_list args);
	...
	uintptr_t (*sl_open_shared_library)(struct OMRPortLibrary *portLibrary, char *name, uintptr_t *descriptor,
										uintptr_t flags);
	...
	void *(*heap_reallocate)(struct OMRPortLibrary *portLibrary, struct J9Heap *heap, void *address,
							 uintptr_t byteAmount);
	...
	void *(*mem_allocate_memory)(struct OMRPortLibrary *portLibrary, uintptr_t byteAmount, const char *callSite,
								 uint32_t category);
	...
	void *(*mem_allocate_memory32)(struct OMRPortLibrary *portLibrary, uintptr_t byteAmount, const char *callSite,
								   uint32_t category);
	...
	void (*vmem_default_large_page_size_ex)(struct OMRPortLibrary *portLibrary, uintptr_t mode, uintptr_t *pageSize,
											uintptr_t *pageFlags);
	...
	intptr_t (*vmem_numa_get_node_details)(struct OMRPortLibrary *portLibrary, struct J9MemoryNodeDetail *numaNodes,
										   uintptr_t *nodeCount);
	...
	int32_t (*vmem_get_process_memory_size)(struct OMRPortLibrary *portLibrary, J9VMemMemoryQuery queryType,
											uint64_t *memorySize);
	...
	uintptr_t (*str_vprintf)(struct OMRPortLibrary *portLibrary, char *buf, uintptr_t bufLen, const char *format,
							 va_list args);
	...
	intptr_t (*str_set_time_tokens)(struct OMRPortLibrary *portLibrary, struct J9StringTokens *tokens,
									int64_t timeMillis);
	...
	void (*nls_set_locale)(struct OMRPortLibrary *portLibrary, const char *lang, const char *region,
						   const char *variant);
	...
	void (*nls_vprintf)(struct OMRPortLibrary *portLibrary, uintptr_t flags, uint32_t module_name, uint32_t message_num,
						va_list args);
	...
	uint32_t (*sig_set_async_signal_handler)(struct OMRPortLibrary *portLibrary, omrsig_handler_fn handler,
	...
	int32_t (*file_lock_bytes)(struct OMRPortLibrary *portLibrary, intptr_t fd, int32_t lockFlags, uint64_t offset,
							   uint64_t length);
	...
	int32_t (*file_blockingasync_unlock_bytes)(struct OMRPortLibrary *portLibrary, intptr_t fd, uint64_t offset,
											   uint64_t length);
	/** see @ref omrfile_blockingasync.c::omrfile_blockingasync_lock_bytes "omrfile_blockingasync_lock_bytes"*/
	int32_t (*file_blockingasync_lock_bytes)(struct OMRPortLibrary *portLibrary, intptr_t fd, int32_t lockFlags,
	...
	intptr_t (*sysinfo_get_tmp)(struct OMRPortLibrary *portLibrary, char *buf, uintptr_t bufLen,
	...
	struct J9PlatformThread *(*introspect_threads_startDo)(struct OMRPortLibrary *portLibrary, J9Heap *heap,
	...
	struct J9PlatformThread *(*introspect_threads_startDo_with_signal)(struct OMRPortLibrary *portLibrary, J9Heap *heap,
	...
	uintptr_t (*introspect_backtrace_thread)(struct OMRPortLibrary *portLibrary, J9PlatformThread *thread, J9Heap *heap,
											 void *signalInfo);
	/** see @ref omrintrospect.c::omrintrospect_backtrace_symbols "omrintrospect_backtrace_symbols"*/
	uintptr_t (*introspect_backtrace_symbols)(struct OMRPortLibrary *portLibrary, J9PlatformThread *thread,
											  J9Heap *heap);
	...
	int32_t (*cuda_deviceAlloc)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, uintptr_t size,
								void **deviceAddressOut);
	/** see @ref omrcuda.cpp::omrcuda_deviceCanAccessPeer "omrcuda_deviceCanAccessPeer" */
	int32_t (*cuda_deviceCanAccessPeer)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, uint32_t peerDeviceId,
										BOOLEAN *canAccessPeerOut);
	/** see @ref omrcuda.cpp::omrcuda_deviceDisablePeerAccess "omrcuda_deviceDisablePeerAccess" */
	int32_t (*cuda_deviceDisablePeerAccess)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
											uint32_t peerDeviceId);
	/** see @ref omrcuda.cpp::omrcuda_deviceEnablePeerAccess "omrcuda_deviceEnablePeerAccess" */
	int32_t (*cuda_deviceEnablePeerAccess)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
										   uint32_t peerDeviceId);
	...
	int32_t (*cuda_deviceGetCacheConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_deviceGetLimit)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaDeviceLimit limit,
								   uintptr_t *valueOut);
	/** see @ref omrcuda.cpp::omrcuda_deviceGetMemInfo "omrcuda_deviceGetMemInfo" */
	int32_t (*cuda_deviceGetMemInfo)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, uintptr_t *freeOut,
									 uintptr_t *totalOut);
	/** see @ref omrcuda.cpp::omrcuda_deviceGetName "omrcuda_deviceGetName" */
	int32_t (*cuda_deviceGetName)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, uint32_t nameSize,
								  char *nameOut);
	/** see @ref omrcuda.cpp::omrcuda_deviceGetSharedMemConfig "omrcuda_deviceGetSharedMemConfig" */
	int32_t (*cuda_deviceGetSharedMemConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_deviceSetCacheConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
										 J9CudaCacheConfig config);
	/** see @ref omrcuda.cpp::omrcuda_deviceSetLimit "omrcuda_deviceSetLimit" */
	int32_t (*cuda_deviceSetLimit)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaDeviceLimit limit,
								   uintptr_t value);
	/** see @ref omrcuda.cpp::omrcuda_deviceSetSharedMemConfig "omrcuda_deviceSetSharedMemConfig" */
	int32_t (*cuda_deviceSetSharedMemConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId,
	...
	int32_t (*cuda_eventCreate)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, uint32_t flags,
	...
	int32_t (*cuda_eventElapsedTime)(struct OMRPortLibrary *portLibrary, J9CudaEvent start, J9CudaEvent end,
	...
	int32_t (*cuda_eventRecord)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaEvent event,
								J9CudaStream stream);
	...
	int32_t (*cuda_funcSetCacheConfig)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaFunction function,
									   J9CudaCacheConfig config);
	...
	int32_t (*cuda_hostAlloc)(struct OMRPortLibrary *portLibrary, uintptr_t size, uint32_t flags,
							  void **hostAddressOut);
	...
	int32_t (*cuda_launchKernel)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaFunction function,
								 ...
								 uint32_t blockDimY, uint32_t blockDimZ, uint32_t sharedMemBytes, J9CudaStream stream,
								 void **kernelParms);
	...
	int32_t (*cuda_streamGetFlags)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaStream stream,
								   uint32_t *flagsOut);
	/** see @ref omrcuda.cpp::omrcuda_streamGetPriority "omrcuda_streamGetPriority" */
	int32_t (*cuda_streamGetPriority)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaStream stream,
									  int32_t *priorityOut);
	...
	int32_t (*cuda_streamWaitEvent)(struct OMRPortLibrary *portLibrary, uint32_t deviceId, J9CudaStream stream,
									J9CudaEvent event);
#endif /* OMR_OPT_CUDA */
} OMRPortLibrary;
...
#define omrsysinfo_set_number_entitled_CPUs(param1)                                                                    \
	privateOmrPortLibrary->sysinfo_set_number_entitled_CPUs(privateOmrPortLibrary, (param1))
...
#define omrmem_reallocate_memory(param1, param2, category)                                                             \
	privateOmrPortLibrary->mem_reallocate_memory(privateOmrPortLibrary, (param1), (param2), OMR_GET_CALLSITE(),        \
												 (category))
...
#define omrvmem_reserve_memory(param1, param2, param3, param4, param5, param6)                                         \
	privateOmrPortLibrary->vmem_reserve_memory(privateOmrPortLibrary, (param1), (param2), (param3), (param4),          \
											   (param5), (param6))
...
#define omrstr_convert(param1, param2, param3, param4, param5, param6)                                                 \
	privateOmrPortLibrary->str_convert(privateOmrPortLibrary, (param1), (param2), (param3), (param4), (param5),        \
									   (param6))
...
#define omrnls_lookup_message(param1, param2, param3)                                                                  \
	privateOmrPortLibrary->nls_lookup_message(privateOmrPortLibrary, (param1), param2, (param3))
...
#define omrsig_protect(param1, param2, param3, param4, param5, param6)                                                 \
	privateOmrPortLibrary->sig_protect(privateOmrPortLibrary, (param1), (param2), (param3), (param4), (param5),        \
									   (param6))
...
#define omrmmap_map_file(param1, param2, param3, param4, param5, param6)                                               \
	privateOmrPortLibrary->mmap_map_file(privateOmrPortLibrary, (param1), (param2), (param3), (param4), (param5),      \
										 (param6))
...
#define omrcuda_deviceCanAccessPeer(deviceId, peerDeviceId, canAccessPeerOut)                                          \
	privateOmrPortLibrary->cuda_deviceCanAccessPeer(privateOmrPortLibrary, (deviceId), (peerDeviceId),                 \
													(canAccessPeerOut))
...
#define omrcuda_deviceGetStreamPriorityRange(deviceId, leastPriorityOut, greatestPriorityOut)                          \
	privateOmrPortLibrary->cuda_deviceGetStreamPriorityRange(privateOmrPortLibrary, (deviceId), (leastPriorityOut),    \
															 (greatestPriorityOut))
...
#define omrcuda_funcMaxActiveBlocksPerMultiprocessor(deviceId, function, blockSize, dynamicSharedMemorySize, flags,    \
													 valueOut)                                                         \
...
#define omrcuda_funcMaxPotentialBlockSize(deviceId, function, dynamicSharedMemoryFunction, userData, blockSizeLimit,   \
	...
	privateOmrPortLibrary->cuda_funcMaxPotentialBlockSize(privateOmrPortLibrary, (deviceId), (function),               \
														  (dynamicSharedMemoryFunction), (userData), (blockSizeLimit), \
														  (flags), (minGridSizeOut), (maxBlockSizeOut))
...
#define omrcuda_linkerAddData(deviceId, linker, type, data, size, name, options)                                       \
	privateOmrPortLibrary->cuda_linkerAddData(privateOmrPortLibrary, (deviceId), (linker), (type), (data), (size),     \
											  (name), options)
...
#define omrcuda_memcpy2DDeviceToDevice(deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width,        \
									   height)                                                                         \
	privateOmrPortLibrary->cuda_memcpy2DDeviceToDevice(privateOmrPortLibrary, (deviceId), (targetAddress),             \
													   (targetPitch), (sourceAddress), (sourcePitch), (width),         \
													   (height))
#define omrcuda_memcpy2DDeviceToDeviceAsync(deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width,   \
											height, stream)                                                            \
...
#define omrcuda_memcpy2DDeviceToHostAsync(deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width,     \
										  height, stream)                                                              \
...
#define omrcuda_memcpy2DHostToDevice(deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width, height)  \
	privateOmrPortLibrary->cuda_memcpy2DHostToDevice(privateOmrPortLibrary, (deviceId), (targetAddress),               \
													 (targetPitch), (sourceAddress), (sourcePitch), (width), (height))
#define omrcuda_memcpy2DHostToDeviceAsync(deviceId, targetAddress, targetPitch, sourceAddress, sourcePitch, width,     \
										  height, stream)                                                              \
...
#define omrcuda_memcpyDeviceToDevice(deviceId, targetAddress, sourceAddress, byteCount)                                \
	privateOmrPortLibrary->cuda_memcpyDeviceToDevice(privateOmrPortLibrary, (deviceId), (targetAddress),               \
													 (sourceAddress), (byteCount))
#define omrcuda_memcpyDeviceToDeviceAsync(deviceId, targetAddress, sourceAddress, byteCount, stream)                   \
	privateOmrPortLibrary->cuda_memcpyDeviceToDeviceAsync(privateOmrPortLibrary, (deviceId), (targetAddress),          \
														  (sourceAddress), (byteCount), (stream))
#define omrcuda_memcpyDeviceToHost(deviceId, targetAddress, sourceAddress, byteCount)                                  \
	privateOmrPortLibrary->cuda_memcpyDeviceToHost(privateOmrPortLibrary, (deviceId), (targetAddress),                 \
												   (sourceAddress), (byteCount))
#define omrcuda_memcpyDeviceToHostAsync(deviceId, targetAddress, sourceAddress, byteCount, stream)                     \
	privateOmrPortLibrary->cuda_memcpyDeviceToHostAsync(privateOmrPortLibrary, (deviceId), (targetAddress),            \
														(sourceAddress), (byteCount), (stream))
#define omrcuda_memcpyHostToDevice(deviceId, targetAddress, sourceAddress, byteCount)                                  \
	privateOmrPortLibrary->cuda_memcpyHostToDevice(privateOmrPortLibrary, (deviceId), (targetAddress),                 \
												   (sourceAddress), (byteCount))
#define omrcuda_memcpyHostToDeviceAsync(deviceId, targetAddress, sourceAddress, byteCount, stream)                     \
	privateOmrPortLibrary->cuda_memcpyHostToDeviceAsync(privateOmrPortLibrary, (deviceId), (targetAddress),            \
														(sourceAddress), (byteCount), (stream))
#define omrcuda_memcpyPeer(targetDeviceId, targetAddress, sourceDeviceId, sourceAddress, byteCount)                    \
	privateOmrPortLibrary->cuda_memcpyPeer(privateOmrPortLibrary, (targetDeviceId), (targetAddress), (sourceDeviceId), \
										   (sourceAddress), (byteCount))
...
#define omrcuda_memset8Async(deviceId, deviceAddress, value, count, stream)                                            \
	privateOmrPortLibrary->cuda_memset8Async(privateOmrPortLibrary, (deviceId), (deviceAddress), (value), (count),     \
											 (stream))
...
#define omrcuda_memset16Async(deviceId, deviceAddress, value, count, stream)                                           \
	privateOmrPortLibrary->cuda_memset16Async(privateOmrPortLibrary, (deviceId), (deviceAddress), (value), (count),    \
											  (stream))
...
#define omrcuda_memset32Async(deviceId, deviceAddress, value, count, stream)                                           \
	privateOmrPortLibrary->cuda_memset32Async(privateOmrPortLibrary, (deviceId), (deviceAddress), (value), (count),    \
											  (stream))
...
#define omrcuda_moduleGetGlobal(deviceId, module, name, addressOut, sizeOut)                                           \
	privateOmrPortLibrary->cuda_moduleGetGlobal(privateOmrPortLibrary, (deviceId), (module), (name), (addressOut),     \
												(sizeOut))
...
#define omrcuda_streamCreateWithPriority(deviceId, priority, flags, streamOut)                                         \
	privateOmrPortLibrary->cuda_streamCreateWithPriority(privateOmrPortLibrary, (deviceId), (priority), (flags),       \
														 (streamOut))
