...
static bool initializeJitBuilder(TR_RuntimeHelper* helperIDs, void** helperAddresses, int32_t numHelpers, char* options)
{
...
extern "C" bool initializeJitWithOptions(char* options) { return initializeJitBuilder(0, 0, 0, options); }

extern "C" bool initializeJit() { return initializeJitBuilder(0, 0, 0, (char*)"-Xjit"); }
