...
static const OptimizationStrategy tacticalGlobalRegisterAllocatorOpts[] = {
    ...
    // { isolatedStoreGroup,                         OMR::IfEnabled                    }, // if global register
    // allocator created stores from registers
...
static const OptimizationStrategy JBwarmStrategyOpts[] = {
    { OMR::trivialDeadTreeRemoval, OMR::IfEnabled }, { OMR::treeSimplification },
    { OMR::lastLoopVersionerGroup, OMR::IfLoops }, { OMR::globalDeadStoreElimination, OMR::IfEnabledAndLoops },
    { OMR::deadTreesElimination }, { OMR::basicBlockOrdering, OMR::IfLoops }, { OMR::treeSimplification },
    { OMR::blockSplitter }, { OMR::treeSimplification },
    //   { OMR::inductionVariableAnalysis,                 OMR::IfLoops                  },
    ...
    { OMR::treeSimplification, OMR::IfEnabled }, { OMR::localDeadStoreElimination }, // after latest copy propagation
    ...
    : OMR::Optimizer(comp, methodSymbol, isIlGen, strategy, VNType)
{
    ...
    //      new (comp->allocator()) TR::OptimizationManager(self(), TR_InductionVariableAnalysis::create,
    //      OMR::inductionVariableAnalysis, "O^O INDUCTION VARIABLE ANALYSIS: ");
    ...
    _opts[OMR::isolatedStoreElimination] = new (comp->allocator()) TR::OptimizationManager(
        self(), TR_IsolatedStoreElimination::create, OMR::isolatedStoreElimination, "O^O ISOLATED STORE ELIMINATION: ");
    ...
    _opts[OMR::trivialStoreSinking] = new (comp->allocator()) TR::OptimizationManager(
        self(), TR_TrivialSinkStores::create, OMR::trivialStoreSinking, "O^O TRIVIAL SINK STORES: ");
    ...
    _opts[OMR::trivialDeadBlockRemover] = new (comp->allocator()) TR::OptimizationManager(
        self(), TR_TrivialDeadBlockRemover::create, OMR::trivialDeadBlockRemover, "O^O TRIVIAL DEAD BLOCK REMOVAL ");
...
const OptimizationStrategy* Optimizer::optimizationStrategy(TR::Compilation* c)
{
    // force warm strategy for now
