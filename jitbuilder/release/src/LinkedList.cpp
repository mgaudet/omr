    ...
    : MethodBuilder(d)
{
    ...
    DefineFunction(
        (char*)"printAddress", (char*)__FILE__, (char*)PRINTADDRESS_LINE, (void*)&printAddress, NoType, 1, Int64);
}
...
bool LinkedListMethod::buildIL()
{
    ...
    loop->Call("printInt32", 1, loop->LoadIndirect("Element", "key", loop->Load("ptr")));
