...
uint32_t TR_S390RestoreGPR7Snippet::getLength(int32_t estimatedSnippetStart)
{
    NOT_IMPLEMENTED;
    return 0;
}

uint8_t* TR_S390RestoreGPR7Snippet::emitSnippetBody()
{
    NOT_IMPLEMENTED;
    return NULL;
}

void TR_Debug::print(TR::FILE* pOutFile, TR_S390RestoreGPR7Snippet* snippet) { NOT_IMPLEMENTED; }
