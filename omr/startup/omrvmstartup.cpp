...
omr_error_t
OMR_Thread_Init(OMR_VM* omrVM, void* language_vm_thread,
...
omr_error_t
OMR_Thread_FirstInit(OMR_VM* omrVM, omrthread_t self, void* language_vm_thread,
                     OMR_VMThread** threadSlot, const char* threadName)
{
  omr_error_t rc = OMR_ERROR_NONE;
...
omr_error_t
OMR_Initialize_VM(OMR_VM** omrVMSlot, OMR_VMThread** omrVMThreadSlot,
                  void* languageVM, void* languageVMThread)
{
  omr_error_t rc = OMR_ERROR_NONE;
  omrthread_t j9self = NULL;
  OMR_Runtime* omrRuntime = NULL;
