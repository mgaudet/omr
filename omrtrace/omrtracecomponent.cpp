...
omr_error_t
initialiseComponentData(UtComponentData** componentDataPtr,
                        UtModuleInfo* moduleInfo, const char* componentName)
{
...
getComponentDataNext(const char* componentName, UtComponentList* componentList,
...
static void
updateActiveArray(UtComponentData* compData, int32_t first, int32_t last,
...
static omr_error_t
addDeferredConfigToList(const char* componentName, int32_t all, int32_t first,
                        int32_t last, unsigned char value, int level,
                        ...
                        UtDeferredConfigInfo** configList, int32_t setActive)
{
  ...
  if (dconfiginfo == NULL) {
    UT_DBGOUT(
      1, ("<UT> Unable to set tracepoints in %s - can't allocate config info\n",
          componentName));
    return OMR_ERROR_OUT_OF_NATIVE_MEMORY;
  }
 ...
 */
static omr_error_t
parseAndSetTracePointsInRange(const char* componentName, unsigned char value,
                              int32_t setActive, BOOLEAN suppressMessages)
{
  int length = 0;
  const char* p;
...
omr_error_t
setTracePointsTo(const char* componentName, UtComponentList* componentList,
                 int32_t all, int32_t first, int32_t last, unsigned char value,
                 int level, const char* groupName, BOOLEAN suppressMessages,
                 int32_t setActive)
{
 ...
 ******************************************************************************/
static intptr_t
openFileFromDirectorySearchList(char* searchPath, char* fileName, int32_t flags,
                                int32_t mode)
{
...
omr_error_t
setTracePointGroupTo(const char* groupName, UtComponentData* componentData,
...
omr_error_t
setTracePointsByLevelTo(UtComponentData* componentData, int level,
                        unsigned char value, int32_t setActive)
{
  omr_error_t rc = OMR_ERROR_NONE;
...
uint64_t
incrementTraceCounter(UtModuleInfo* moduleInfo, UtComponentList* componentList,
                      int32_t tracepoint)
{
  UtComponentData* compData;
