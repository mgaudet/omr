 ...
 */
omr_error_t
threadStart(OMR_TraceThread** thr, const void* threadId, const char* threadName,
            const void* threadSynonym1, const void* threadSynonym2)
{
  omr_error_t rc = OMR_ERROR_NONE;
  OMRPORT_ACCESS_FROM_OMRPORT(OMR_TRACEGLOBAL(portLibrary));
...
omr_error_t
initializeTrace(OMR_VM* vm, const char* datDir,
...
omr_error_t
fillInUTInterfaces(UtInterface** utIntf, OMR_TraceInterface* omrTraceIntf,
 ...
 */
omr_error_t
destroyRecordSubscriber(OMR_TraceThread* thr, UtSubscription* subscription,
                        BOOLEAN callAlarm)
{
  omr_error_t result = OMR_ERROR_NONE;
