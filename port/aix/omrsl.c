 ...
 */
static uintptr_t
getDirectoryOfLibrary(struct OMRPortLibrary* portLib, char* buf,
                      uintptr_t bufLen)
{
...
static void
convertWithIConv(struct OMRPortLibrary* portLibrary, const char* error,
                 char* errBuf, uintptr_t bufLen)
{
  iconv_t converter;
...
static void
convertWithMBTOWC(struct OMRPortLibrary* portLibrary, char* error, char* errBuf,
                  uintptr_t bufLen)
{
  char *out, *end, *walk;
  wchar_t ch;
