 ...
 */
int32_t
initializeTable(OMRPortLibrary* portLibrary, uintptr_t dllHandle,
                uint32_t libraryVersion, const J9CudaEntryDescriptor* entries,
 ...
 */
int32_t
getDeviceData(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
cudaError_t
getDeviceName(J9CudaFunctionTable* functions, uint32_t deviceId,
 ...
 */
cudaError_t
initDeviceData(J9CudaFunctionTable* functions, uint32_t deviceId,
               J9CudaDeviceDescriptor* deviceData)
{
 ...
 */
uint32_t
openRuntimeAndGetVersion(OMRPortLibrary* portLibrary, uint32_t bestVersion,
                         const char* library)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceAlloc(OMRPortLibrary* portLibrary, uint32_t deviceId,
                    uintptr_t size, void** deviceAddressOut)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceCanAccessPeer(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceDisablePeerAccess(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceEnablePeerAccess(OMRPortLibrary* portLibrary, uint32_t deviceId,
                               uint32_t peerDeviceId)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceFree(OMRPortLibrary* portLibrary, uint32_t deviceId,
                   void* deviceAddress)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceGetAttribute(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetCacheConfig(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetLimit(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceGetMemInfo(OMRPortLibrary* portLibrary, uint32_t deviceId,
                         uintptr_t* freeOut, uintptr_t* totalOut)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceGetName(OMRPortLibrary* portLibrary, uint32_t deviceId,
                      uint32_t nameSize, char* nameOut)
{
 ...
 */
extern "C" int32_t
omrcuda_deviceSetCacheConfig(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_deviceSetLimit(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_eventCreate(OMRPortLibrary* portLibrary, uint32_t deviceId,
                    uint32_t flags, J9CudaEvent* eventOut)
{
 ...
 */
extern "C" int32_t
omrcuda_eventDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId,
                     J9CudaEvent event)
{
 ...
 */
extern "C" int32_t
omrcuda_eventElapsedTime(OMRPortLibrary* portLibrary, J9CudaEvent startEvent,
                         J9CudaEvent endEvent, float* elapsedMillisOut)
{
 ...
 */
extern "C" int32_t
omrcuda_eventRecord(OMRPortLibrary* portLibrary, uint32_t deviceId,
                    J9CudaEvent event, J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_funcGetAttribute(OMRPortLibrary* portLibrary, uint32_t deviceId,
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions)
  {
    return translate(
      functions->OccupancyMaxActiveBlocksPerMultiprocessorWithFlags(
        &numBlocks, function, (int)blockSize, (size_t)dynamicSharedMemorySize,
        (int)flags));
  }
};
 ...
 */
extern "C" int32_t
omrcuda_funcSetCacheConfig(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_hostAlloc(OMRPortLibrary* portLibrary, uintptr_t size, uint32_t flags,
                  void** hostAddressOut)
{
 ...
 */
extern "C" int32_t
omrcuda_launchKernel(OMRPortLibrary* portLibrary, uint32_t deviceId,
                     J9CudaFunction function, uint32_t gridDimX,
  ...
  VMINLINE cudaError_t execute(J9CudaFunctionTable* functions) const
  {
    ...
    if (cudaSuccess == result) {
      ...
      result = translate(functions->LinkAddData(
        linker->state, inputType, image, imageSize, name, addOptions.getCount(),
 ...
 */
extern "C" int32_t
omrcuda_linkerAddData(OMRPortLibrary* portLibrary, uint32_t deviceId,
                      J9CudaLinker linker, J9CudaJitInputType type, void* data,
 ...
 */
extern "C" int32_t
omrcuda_linkerComplete(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_linkerCreate(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_linkerDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId,
                      J9CudaLinker linker)
{
...
omrcuda_memcpy2DDeviceToHostAsync(OMRPortLibrary* portLibrary,
                                  uint32_t deviceId, void* targetAddress,
                                  size_t targetPitch, const void* sourceAddress,
                                  size_t sourcePitch, uintptr_t width,
                                  uintptr_t height, J9CudaStream stream)
{
  Trc_PRT_cuda_memcpy2DAsync_entry(deviceId, targetAddress, targetPitch,
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToDevice(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_memcpyDeviceToHost(OMRPortLibrary* portLibrary, uint32_t deviceId,
                           void* targetAddress, const void* sourceAddress,
                           uintptr_t byteCount)
{
  Trc_PRT_cuda_memcpy_entry(deviceId, targetAddress, sourceAddress, byteCount,
 ...
 */
extern "C" int32_t
omrcuda_memcpyHostToDevice(OMRPortLibrary* portLibrary, uint32_t deviceId,
                           void* targetAddress, const void* sourceAddress,
                           uintptr_t byteCount)
{
  Trc_PRT_cuda_memcpy_entry(deviceId, targetAddress, sourceAddress, byteCount,
 ...
 */
extern "C" int32_t
omrcuda_memset8Async(OMRPortLibrary* portLibrary, uint32_t deviceId,
                     void* deviceAddress, uint8_t value, uintptr_t count,
                     J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_memset16Async(OMRPortLibrary* portLibrary, uint32_t deviceId,
                      void* deviceAddress, uint16_t value, uintptr_t count,
                      J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_memset32Async(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetFunction(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetSurfaceRef(OMRPortLibrary* portLibrary, uint32_t deviceId,
                            J9CudaModule module, const char* name,
 ...
 */
extern "C" int32_t
omrcuda_moduleGetTextureRef(OMRPortLibrary* portLibrary, uint32_t deviceId,
                            J9CudaModule module, const char* name,
                            uintptr_t* texRefOut)
{
 ...
 */
extern "C" int32_t
omrcuda_moduleLoad(OMRPortLibrary* portLibrary, uint32_t deviceId,
                   const void* image, J9CudaJitOptions* options,
 ...
 */
extern "C" int32_t
omrcuda_moduleUnload(OMRPortLibrary* portLibrary, uint32_t deviceId,
                     J9CudaModule module)
{
 ...
 */
extern "C" int32_t
omrcuda_streamAddCallback(OMRPortLibrary* portLibrary, uint32_t deviceId,
                          J9CudaStream stream,
                          J9CudaStreamCallback clientFunction,
                          uintptr_t clientData)
{
 ...
 */
extern "C" int32_t
omrcuda_streamCreate(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_streamCreateWithPriority(OMRPortLibrary* portLibrary, uint32_t deviceId,
 ...
 */
extern "C" int32_t
omrcuda_streamDestroy(OMRPortLibrary* portLibrary, uint32_t deviceId,
                      J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamGetFlags(OMRPortLibrary* portLibrary, uint32_t deviceId,
                       J9CudaStream stream, uint32_t* flagsOut)
{
 ...
 */
extern "C" int32_t
omrcuda_streamGetPriority(OMRPortLibrary* portLibrary, uint32_t deviceId,
                          J9CudaStream stream, int32_t* priorityOut)
{
 ...
 */
extern "C" int32_t
omrcuda_streamQuery(OMRPortLibrary* portLibrary, uint32_t deviceId,
                    J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamSynchronize(OMRPortLibrary* portLibrary, uint32_t deviceId,
                          J9CudaStream stream)
{
 ...
 */
extern "C" int32_t
omrcuda_streamWaitEvent(OMRPortLibrary* portLibrary, uint32_t deviceId,
