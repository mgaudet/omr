...
*/
void*
omrheap_allocate(struct OMRPortLibrary* portLibrary, struct J9Heap* heap,
...
*/
void
omrheap_free(struct OMRPortLibrary* portLibrary, struct J9Heap* heap,
             void* address)
{
...
*/
void*
omrheap_reallocate(struct OMRPortLibrary* portLibrary, struct J9Heap* heap,
...
*/
uintptr_t
omrheap_query_size(struct OMRPortLibrary* portLibrary, struct J9Heap* heap,
                   void* address)
{
