 ...
 */
static long
do_mbind(void* start, unsigned long len, int policy,
 ...
 */
static long
do_get_mempolicy(int* policy, unsigned long* nmask, unsigned long maxnode,
...
getMemoryInRangeForLargePages(struct OMRPortLibrary* portLibrary,
                              ...
                              uintptr_t vmemOptions, uintptr_t pageSize,
                              uintptr_t mode)
{
  intptr_t direction = 1;
  void* currentAddress = startAddress;
 ...
 */
static BOOLEAN
isStrictAndOutOfRange(void* memoryPointer, void* startAddress, void* endAddress,
