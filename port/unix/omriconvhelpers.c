 ...
 */
static BOOLEAN
openIconvDescriptor(iconv_t* globalConverter, MUTEX* globalConverterMutex,
                    uint32_t index, const char* toCode, const char* fromCode,
 ...
 */
iconv_t
iconv_get(struct OMRPortLibrary* portLibrary, J9IconvName converterName,
...
void
iconv_free(struct OMRPortLibrary* portLibrary, J9IconvName converterName,
           iconv_t converter)
{
#if defined(J9ZOS390)
