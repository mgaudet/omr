 ...
 *                                                         characters being converted to '_') of the file mapping object
 * on Windows
 *                                                         so that it can be shared between processes.  If a named
 * object is not required, this parameter can be
 *                                                         specified as NULL
