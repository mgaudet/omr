 ...
 */
static wchar_t*
file_get_unicode_path(OMRPortLibrary* portLibrary, const char* utf8Path,
...
intptr_t
omrfile_read(struct OMRPortLibrary* portLibrary, intptr_t fd, void* buf,
             intptr_t nbytes)
{
  DWORD bytesRead;
  HANDLE handle;
...
int64_t
omrfile_seek(struct OMRPortLibrary* portLibrary, intptr_t fd, int64_t offset,
             int32_t whence)
{
...
intptr_t
omrfile_write(struct OMRPortLibrary* portLibrary, intptr_t fd, void* buf,
              intptr_t nbytes)
{
  DWORD nCharsWritten;
...
int32_t
omrfile_set_length(struct OMRPortLibrary* portLibrary, intptr_t fd,
                   int64_t newLength)
{
  int32_t lastError = 0;
