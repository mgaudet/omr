 ...
 */
wchar_t*
port_convertFromUTF8(OMRPortLibrary* portLibrary, const char* string,
 ...
 */
int32_t
port_convertToUTF8(OMRPortLibrary* portLibrary, const wchar_t* unicodeString,
                   char* utf8Buffer, uintptr_t size)
{
