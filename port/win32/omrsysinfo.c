...
void omrsysinfo_set_number_entitled_CPUs(struct OMRPortLibrary* portLibrary, uintptr_t number)
{
    ...
    if (mutf8Size >= 0) {
        ...
        if (bufLen < (uintptr_t)mutf8Size) {
            ...
            mutf8Size = portLibrary->str_convert(portLibrary, J9STR_CODE_WIDE, J9STR_CODE_MUTF8,
                (uint8_t*)unicodeBuffer, (uintptr_t)pathLengthInWChars * sizeof(wchar_t), buf, bufLen);
            if (mutf8Size < 0) {
