 ...
 */
static void
convertToUpper(struct OMRPortLibrary* portLibrary, char* toConvert,
               uintptr_t len)
{
 ...
 */
static void
appendCoreName(struct OMRPortLibrary* portLibrary, char* corepath,
               intptr_t pathBufferLimit, intptr_t pid)
{
 ...
 */
static intptr_t
tdump(struct OMRPortLibrary* portLibrary, char* asciiLabel, char* ebcdicLabel,
      uint32_t* returnCode, uint32_t* reasonCode)
{
  struct ioparms_t
  {
    uint64_t plist[256];
