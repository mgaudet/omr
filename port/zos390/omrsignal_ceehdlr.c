...
*/
void
j9vm_le_condition_handler(_FEEDBACK* fc, _INT4* token, _INT4* leResult,
                          _FEEDBACK* newfc)
{
  ...
  if ((0 != (thisRecord->flags & portlibSignalNo)) ||
    ...
    switch (handlerResult) {
      case OMRPORT_SIG_EXCEPTION_CONTINUE_SEARCH:
         ...
         * try the previously registered handler
...
uint32_t
omrsig_info_ceehdlr(struct OMRPortLibrary* portLibrary, void* info,
