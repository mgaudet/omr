 ...
 */
void
fillInLEJumpInfo(struct OMRPortLibrary* portLibrary, j9_31bit_mch* regs,
                 void* jumpInfo)
{
  int i = 0;
...
uint32_t
infoForFPR_ceehdlr(struct OMRPortLibrary* portLibrary, J9LEConditionInfo* info,
 ...
 * port/zos390/omrsignal_context.c */
uint32_t
infoForGPR_ceehdlr(struct OMRPortLibrary* portLibrary, J9LEConditionInfo* info,
                   int32_t index, const char** name, void** value)
{
 ...
 * port/zos390/omrsignal_context.c */
uint32_t
infoForVR_ceehdlr(struct OMRPortLibrary* portLibrary, J9LEConditionInfo* info,
                  int32_t index, const char** name, void** value)
{
...
infoForModule_ceehdlr(struct OMRPortLibrary* portLibrary,
                      J9LEConditionInfo* info, int32_t index, const char** name,
                      void** value)
{
