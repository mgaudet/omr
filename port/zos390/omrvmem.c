    ...
    struct OMRPortLibrary* portLibrary, struct J9PortVmemIdentifier* identifier, struct J9PortVmemParams* callerParams)
{
     ...
     * implemented, adjusts the parameters
     * to ensure that the requested alignment can be honoured within the allocated block.  Note that we still want to
 ...
 * On 64-bit system, default page size when mode is OMRPORT_VMEM_MEMORY_MODE_EXECUTE is 1M pageable pages (provided it
 * is supported),
