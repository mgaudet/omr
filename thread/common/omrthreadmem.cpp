...
const OMRMemCategory threadCategoryTemplate = {"Threads", OMRMEM_CATEGORY_THREADS, 0, 0, 0, 0,
											   4,		  threadCategoryChildren};
 ...
 */
void *
omrthread_mallocWrapper(void *user, uint32_t size, const char *callSite, uint32_t memoryCategory, uint32_t type,
						uint32_t *doInit)
{
