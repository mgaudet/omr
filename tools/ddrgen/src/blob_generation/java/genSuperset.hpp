...
class JavaSupersetGenerator : public SupersetGenerator {
 private:
  ...
  set<string> _baseTypedefIgnore; /* Set of types to not rename when found as a
                                     typedef */
  intptr_t _file;
 ...
 public:
  ...
  DDR_RC dispatchPrintToSuperset(EnumUDT* type,
                                 bool addFieldsOnly,
                                 string prefix);
  DDR_RC dispatchPrintToSuperset(NamespaceUDT* type,
                                 bool addFieldsOnly,
                                 string prefix);
  DDR_RC dispatchPrintToSuperset(TypedefUDT* type,
                                 bool addFieldsOnly,
                                 string prefix);
  DDR_RC dispatchPrintToSuperset(ClassUDT* type,
                                 bool addFieldsOnly,
                                 string prefix);
  DDR_RC dispatchPrintToSuperset(UnionUDT* type,
                                 bool addFieldsOnly,
                                 string prefix);
};
