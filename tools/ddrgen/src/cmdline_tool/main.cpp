...
DDR_RC getOptions(OMRPortLibrary* portLibrary, int argc, char* argv[], const char** macroFile,
    const char** supersetFile, const char** blobFile, const char** overrideFile, vector<string>* debugFiles);
    ...
    const char** blobFile, const char** overrideFile, vector<string>* debugFiles)
{
    ...
    if (showHelp) {
        printf("USAGE\n"
               ...
               "		Specify input list of macros. See macro tool for format. Default is macroList in "
               "current directory.\n"
               ...
               "		Optional. File containing a list of files which contain type and field overrides for "
               "specific fields.\n"
