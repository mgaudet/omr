...
bool EnumUDT::isAnonymousType() { return (NULL != _outerUDT) && (_name.empty()); }
...
void EnumUDT::replaceType(Type* typeToReplace, Type* replaceWith) { UDT::replaceType(typeToReplace, replaceWith); }

DDR_RC
EnumUDT::scanChildInfo(Scanner* scanner, void* data) { return scanner->dispatchScanChildInfo(this, data); }

string EnumUDT::getSymbolTypeName() { return "enum"; }
