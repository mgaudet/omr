...
static const char* _errmsgs[] = {
    "No error (0)", "DW_DLE_ATTR_FORM_BAD (1)", "DW_DLE_BADOFF (2) Invalid offset", "DW_DLE_DIE_NULL (3)",
    "DW_DLE_FNO (4) file not open", "DW_DLE_IA (5) invalid argument", "DW_DLE_IOF (6) I/O failure",
    "DW_DLE_MAF (7) memory allocation failure", "DW_DLE_NOB (8) not an object file or dSYM bundle not found",
...
static pair<const char*, Dwarf_Half> tagStrings[] = {
    make_pair("array_type", DW_TAG_array_type), make_pair("base_type", DW_TAG_base_type),
    make_pair("class_type", DW_TAG_class_type), make_pair("compile_unit", DW_TAG_compile_unit),
    make_pair("const_type", DW_TAG_const_type), make_pair("enumeration_type", DW_TAG_enumeration_type),
    make_pair("enumerator", DW_TAG_enumerator), make_pair("inheritance", DW_TAG_inheritance),
    make_pair("member", DW_TAG_member), make_pair("namespace", DW_TAG_namespace),
    make_pair("pointer_type", DW_TAG_pointer_type), make_pair("restrict_type", DW_TAG_restrict_type),
    make_pair("shared_type", DW_TAG_shared_type), make_pair("structure_type", DW_TAG_structure_type),
    make_pair("subprogram", DW_TAG_subprogram), make_pair("subrange_type", DW_TAG_subrange_type),
    make_pair("subroutine_type", DW_TAG_subroutine_type), make_pair("typedef", DW_TAG_typedef),
    make_pair("union_type", DW_TAG_union_type), make_pair("volatile_type", DW_TAG_volatile_type),
};
...
static tuple<const char*, Dwarf_Half, Dwarf_Half> attrStrings[] = {
    make_tuple("byte_size", DW_AT_byte_size, DW_FORM_udata), make_tuple("bit_size", DW_AT_bit_size, DW_FORM_udata),
    make_tuple("comp_dir", DW_AT_comp_dir, DW_FORM_string), make_tuple("const_value", DW_AT_const_value, DW_FORM_sdata),
    make_tuple("decl_file", DW_AT_decl_file, DW_FORM_udata), make_tuple("decl_line", DW_AT_decl_line, DW_FORM_udata),
    make_tuple("linkage_name", DW_AT_linkage_name, DW_FORM_string), make_tuple("name", DW_AT_name, DW_FORM_string),
    make_tuple("specification", DW_AT_specification, DW_FORM_ref1), make_tuple("type", DW_AT_type, DW_FORM_ref1),
