...
class DwarfScanner : public Scanner {
 public:
  ...
  DDR_RC startScan(OMRPortLibrary* portLibrary,
                   Symbol_IR* const ir,
 ...
 private:
  ...
  DDR_RC addType(Dwarf_Die die,
                 Dwarf_Half tag,
                 bool ignoreFilter,
                 bool isSubUDT,
                 Type** type);
  DDR_RC getType(Dwarf_Die die,
                 Dwarf_Half tag,
                 Type** const newUDT,
                 bool isSubUDT,
                 int* typeNum);
  DDR_RC createType(Dwarf_Die die,
                    Dwarf_Half tag,
                    string dieName,
  ...
  DDR_RC createTypeKey(Dwarf_Die die,
                       string typeName,
                       TypeKey* key,
                       unsigned int* lineNumber,
                       string* fileName);
