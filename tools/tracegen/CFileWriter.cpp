...
RCType CFileWriter::writeRegistrationFunctionsOnStream(FILE* fd, J9TDFFile* tdf, bool directRegistration)
{
...
RCType CFileWriter::writeComponentDataForNonTraceEnabledBuildsOnStream(FILE* fd, J9TDFFile* tdf)
{
    ...
    fprintf(fd, "UtModuleInfo %s_UtModuleInfo = {(char*) \"%s\", %u, 0, 0, NULL, NULL, NULL, &%s_UtTraceVersionInfo, "
...
{
    RCType rc = RC_FAILED;
    fprintf(fd, "UtModuleInfo %s_UtModuleInfo = {(char*) \"%s\", %u, %u, 0, %s_UtActive , NULL, NULL, "
