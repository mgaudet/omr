...
RCType
CFileWriter::writeOutputFiles(J9TDFOptions* options, J9TDFFile* tdf,
                              J9TDFGroup* groups, unsigned int groupsCount)
{
  RCType rc = RC_FAILED;
  FILE* fd = NULL;
...
RCType
CFileWriter::writeComponentDataOnStream(FILE* fd, J9TDFFile* tdf,
...
RCType
CFileWriter::writeModuleInfo(FILE* fd, J9TDFFile* tdf,
                             unsigned int ntracepoints)
{
  RCType rc = RC_FAILED;
...
RCType
CFileWriter::writeGroups(FILE* fd, J9TDFFile* tdf, J9TDFGroup* groups,
...
RCType
CFileWriter::writeLevels(FILE* fd, J9TDFFile* tdf, unsigned int ntracepoints,
                         unsigned int levels[])
{
  J9TDFTracepoint* tp = tdf->tracepoints;
  unsigned int id = 0;
...
RCType
CFileWriter::writeActiveArray(FILE* fd, J9TDFFile* tdf,
                              unsigned int ntracepoints,
                              unsigned int earlyAssertDefaults[])
{
  J9TDFTracepoint* tp = tdf->tracepoints;
