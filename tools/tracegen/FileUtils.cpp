...
const char*
FileUtils::getTargetFileName(J9TDFOptions* options, const char* tdfFileName,
                             const char* filePrefix, const char* fileName,
...
RCType
FileUtils::visitDirectory(J9TDFOptions* options, const char* dirName,
