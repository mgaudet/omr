 ...
 */
RCType
TraceHeaderWriter::tpTemplate(FILE* fd, unsigned int overhead,
                              unsigned int test, const char* name,
                              const char* module, unsigned int id,
                              unsigned int envParam, const char* parameters,
                              unsigned int parmCount, unsigned int auxiliary)
{
  RCType rc = RC_FAILED;
...
RCType
TraceHeaderWriter::tpAssert(FILE* fd, unsigned int overhead, unsigned int test,
                            const char* name, const char* module,
                            unsigned int id, unsigned int envParam,
                            const char* conditionStr, unsigned int parmCount)
{
  /* 5 characters allows "P999, " or nearly 1000 parameters. */
  RCType rc = RC_FAILED;
  char* parmString = NULL;
...
RCType
TraceHeaderWriter::headerTemplate(J9TDFOptions* options, FILE* fd,
