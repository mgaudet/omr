 ...
 */
static J9AVLTreeNode*
rotate(J9AVLTree* tree, J9AVLTreeNode* walk, intptr_t direction,
       intptr_t* heightChange)
{
  J9WSRP* heavyNodePtr;
  J9WSRP* graftNodePtr;
 ...
 */
static J9AVLTreeNode*
doubleRotate(J9AVLTree* tree, J9AVLTreeNode* walk, intptr_t direction,
             intptr_t* heightChange)
{
  J9WSRP* heavyNodePtr;
 ...
 */
static void
rebalance(J9AVLTree* tree, J9AVLTreeNode** walkPtr, J9WSRP* walkSRPPtr,
          intptr_t direction, intptr_t* heightChange)
{
  J9AVLTreeNode* walk = NULL;
 ...
 */
static J9AVLTreeNode*
insertNode(J9AVLTree* tree, J9AVLTreeNode** walkPtr, J9WSRP* walkSRPPtr,
           J9AVLTreeNode* node, intptr_t* heightChange)
{
 ...
 */
static J9AVLTreeNode*
deleteNode(J9AVLTree* tree, J9AVLTreeNode** walkPtr, J9WSRP* walkSRPPtr,
           J9AVLTreeNode* node, intptr_t* heightChange)
{
  J9AVLTreeNode* find;
  J9AVLTreeNode* walk;
