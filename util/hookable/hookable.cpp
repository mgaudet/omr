 ...
 */
intptr_t
J9HookInitializeInterface(struct J9HookInterface** hookInterface,
                          OMRPortLibrary* portLib, size_t interfaceSize)
{
 ...
 */
static void
J9HookDispatch(struct J9HookInterface** hookInterface, uintptr_t taggedEventNum,
               void* eventData)
{
 ...
 */
static intptr_t
J9HookRegister(struct J9HookInterface** hookInterface, uintptr_t taggedEventNum,
               J9HookFunction function, void* userData, ...)
{
  J9CommonHookInterface* commonInterface =
    (J9CommonHookInterface*)hookInterface;
 ...
 */
static void
J9HookUnregister(struct J9HookInterface** hookInterface,
                 uintptr_t taggedEventNum, J9HookFunction function,
                 void* userData)
{
  J9CommonHookInterface* commonInterface =
 ...
 */
static intptr_t
J9HookIsEnabled(struct J9HookInterface** hookInterface,
                uintptr_t taggedEventNum)
{
  J9CommonHookInterface* commonInterface =
    (J9CommonHookInterface*)hookInterface;
 ...
 */
static void
J9HookDeallocateAgentID(struct J9HookInterface** hookInterface,
                        uintptr_t agentID)
{
  return;
}
